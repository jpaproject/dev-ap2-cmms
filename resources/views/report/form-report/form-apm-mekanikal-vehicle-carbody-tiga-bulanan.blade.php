    ...
    <div class="content">
        <div class="body">
            <div class="table">
                <table class="my-table">
                    ...
                    <tr>
                        ...
                        <td style="width: 30%; font-size: 7px;text-align:left">
                            {{ $formApmMekanikalVehicleCarbodyTigaBulanans[0]['created_at']->format('d-m-Y') }}
                ...
                <table class="my-table">
                    <tr>
                        <th colspan="2" rowspan="2" style="width: 55%">PEMERIKSAAN CARBODY</th>
                    ...
                    @foreach ($formApmMekanikalVehicleCarbodyTigaBulanans as $key => $formApmMekanikalVehicleCarbodyTigaBulanan)
                        @if (
                            $key == 0 ||
                                $formApmMekanikalVehicleCarbodyTigaBulanan->pemeriksaan_carbody_group !=
                                    $formApmMekanikalVehicleCarbodyTigaBulanans[$key - 1]->pemeriksaan_carbody_group)
                            @php
                                $number = 1;
                            @endphp
                        ...
                        <tr>
                            ...
                            <th style="text-align: left">
                                <h2>{{ $formApmMekanikalVehicleCarbodyTigaBulanan->pemeriksaan_carbody }}
                                </h2>

                            </th>

                            <td style=" font-size: 7px;text-align:center"><span
                                    style="font-family: DejaVu Sans, sans-serif; font-size: 12px;widith:50%;">{{ $formApmMekanikalVehicleCarbodyTigaBulanan->hasil_mc1 == 'ok' ? '✔' : '' }}</span>
                            </td>
                            <td style=" font-size: 7px;text-align:center"><span
                                    style="font-family: DejaVu Sans, sans-serif; font-size: 12px;widith:50%">{{ $formApmMekanikalVehicleCarbodyTigaBulanan->hasil_mc1 == 'nok' ? '✔' : '' }}</span>
                            </td>
                            <td style=" font-size: 7px;text-align:center"><span
                                    style="font-family: DejaVu Sans, sans-serif; font-size: 12px;widith:50%;">{{ $formApmMekanikalVehicleCarbodyTigaBulanan->hasil_mc2 == 'ok' ? '✔' : '' }}</span>
                            </td>
                            <td style=" font-size: 7px;text-align:center"><span
                                    style="font-family: DejaVu Sans, sans-serif; font-size: 12px;widith:50%">{{ $formApmMekanikalVehicleCarbodyTigaBulanan->hasil_mc2 == 'nok' ? '✔' : '' }}</span>
                            </td>
                            <td style="width: 21%">
                                <h3 style="font-size: 12px;  text-align:left; vertical-align:middle;">
                                    {{ $formApmMekanikalVehicleCarbodyTigaBulanan->referensi }}</h3>
                            </td>
                        </tr>
                        @php
                            $number++;
                    ...
                    <tr>
                        <td colspan="7" style="text-align: left">Catatan : {!! $formApmMekanikalVehicleCarbodyTigaBulanans[20]->catatan !!}</td>
                    </tr>
