                ...
                <table style="padding:20px 20px 0px 20px;" class="title-table">
                    <tr style="background-color: white;">
                        ...
                        <td style=" width: 60%; text-align:center;">
                            GENSET STANDBY GARDU TEKNIK 6 BULANAN
                        </td>
                    </tr>
                </table>
                {{-- <img style="width: 120px; text-align:left; display:inline; margin-right:60px"
                    src="{{ public_path('img/AP2.png') }}" alt="">
                <h1 style="font-size: 18px; display:inline; margin-right:150px; ">GENSET STANDBY GARDU TEKNIK 3 BULANAN
                </h1> --}}
            </div>
        </div>
        <div class="body">
                ...
                <table style="table-layout: fixed;">
                    ...
                    @foreach ($gensetStandbyGarduTeknikEnamBulanans as $gensetStandbyGarduTeknikEnamBulanan)
                        <tr>
                            ...
                            <td>{{ $gensetStandbyGarduTeknikEnamBulanan->data_teknis ?? '' }}</td>
                            <td>{{ $gensetStandbyGarduTeknikEnamBulanan->satuan ?? '' }}</td>
                            <td>{{ $gensetStandbyGarduTeknikEnamBulanan->keterangan ?? '' }}</td>
                        </tr>
                    @endforeach
                </table>
            </div>
            <div class="catatan" width="100">
                ...
                {!! nl2br($gensetStandbyGarduTeknikEnamBulanans[0]->catatan) !!}
            </div>
            {{-- <div class="ttd-left">
