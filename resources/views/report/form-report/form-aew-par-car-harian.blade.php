            ...
            <div class="table">
                <table class="my-table">
                    ...
                    <tr class="row-title">
                        ...
                        <td style="text-align:center; width: 6%;" colspan="3">Battery</td>
                        <td style="text-align:center; width: 6%;" colspan="2">Steering</td>
                        <td style="text-align:center; width: 6%;" colspan="2">Tires</td>
                        <td style="text-align:center; width: 6%;" rowspan="2">Connecting Cables</td>
                    ...
                    <tr>
                        ...
                        <td style="text-align:center; width: 6%;">Battery Liquid Level</td>
                        <td style="text-align:center; width: 6%;">Battery Visual Check</td>
                        <td style="text-align:center; width: 6%;">Any Noises?</td>
                        <td style="text-align:center; width: 6%;">Bolts and Nuts Check</td>
                        <td style="text-align:center; width: 6%;">Groove</td>
                        <td style="text-align:center; width: 6%;">Presuure</td>
                    </tr>
                    @foreach ($formAewParCarHarians as $key1 => $item)
                        <tr class="row-white">
