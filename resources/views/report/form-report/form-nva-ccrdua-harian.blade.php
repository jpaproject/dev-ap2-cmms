...
<body>
    ...
    <table class="table-borderless" style="margin-top:50px; text-align:center">
        ...
        @if ($formNvaConstantCurrentRegulationDua->substation == 'Substation T11')
            <tr>
            <td>{{ $loop->iteration + 41 }}</td>
            <th>{{ $formNvaConstantCurrentRegulationDua->peralatan }}</th>
            <td>{{ $formNvaConstantCurrentRegulationDua->merk }}</td>
            <td>{{ $formNvaConstantCurrentRegulationDua->tipe }}</td>
            <td>{{ $formNvaConstantCurrentRegulationDua->kapasitas }}</td>
            <td>{{ $formNvaConstantCurrentRegulationDua->tahun_pemasangan }}</td>
            <td>{{ $formNvaConstantCurrentRegulationDua->supply_voltage }}</td>
            <td>{{ $formNvaConstantCurrentRegulationDua->system_remote }}</td>
            <td>{{ $formNvaConstantCurrentRegulationDua->running_hours }}</td>
            <td>{{ $formNvaConstantCurrentRegulationDua->ampere }}</td>
            <td>{{ $formNvaConstantCurrentRegulationDua->step1 }}</td>
            <td>{{ $formNvaConstantCurrentRegulationDua->step2 }}</td>
            <td>{{ $formNvaConstantCurrentRegulationDua->step3 }}</td>
            <td>{{ $formNvaConstantCurrentRegulationDua->step4 }}</td>
            <td>{{ $formNvaConstantCurrentRegulationDua->step5 }}</td>
            <td>{{ $formNvaConstantCurrentRegulationDua->cg }}</td>
            <td>{{ $formNvaConstantCurrentRegulationDua->cc }}</td>
        </tr>
        @endif
        @endforeach
    </table>
    
    <table class="table-borderless" style="margin-top:10px; text-align:center">
    ...
    <table border="0px" class="table-borderless" style="padding-left: 20px">
<tr>
        <td>
            {{ "Tanggal : " }}
        </td>
