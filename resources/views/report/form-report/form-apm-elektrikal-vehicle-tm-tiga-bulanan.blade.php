        ...
        <div class="body">
            <div class="table">
                <table class="my-table">
                    <tr>
                        ...
                        <td rowspan="4" style="width: 25%;text-align:center">
                            <h3>Lembar Pemeriksaan 3 Bulanan Traction Motor</h3>
                        </td>
                    ...
                    <tr>
                        ...
                        <td style="width: 30%; font-size: 7px;text-align:left">
                            {{ $formApmElektrikalVehicleExteriorTMTigaBulanans[0]['created_at']->format('d-m-Y') }}
                ...
                <table class="my-table">
                    ...
                    <tr>
                        <th style="width: 30px" colspan="2">TM 1</th>
                        <th style="width: 30px" colspan="2">TM 2</th>
                    </tr>
                    <tr>
                ...
                @php
                    $numberalpa = 0;
                @endphp
                @foreach ($formApmElektrikalVehicleExteriorTMTigaBulanans as
                            $key=> $formApmElektrikalVehicleExteriorTMTigaBulanan)
                            @if ($key == 0)
                                @php
                                    $number = 1;
                                @endphp
                    <tr style="background-color:#999696;">
                        ...
                        <td colspan="6" style="text-align: left;width: 55%">
                            {{ $formApmElektrikalVehicleExteriorTMTigaBulanan->pemeriksaan_tm_group }}
                        </td>
                    </tr>
                    @php
                        $numberalpa++;
                ...
                @php
                    ...
                    <tr>
                        <th rowspan="2"></th>
                        <th style="width: 30px" colspan="2">TM 3</th>
                        <th style="width: 30px" colspan="2">TM 4</th>
                        <th rowspan="2"></th>
                    </tr>
                    <tr>
                        <th style="width: 15px">OK</th>
                    ...
                    <tr>
                        ...
                        <th style="text-align: left; widith:55%">
                            <h2>{{ $formApmElektrikalVehicleExteriorTMTigaBulanan->pemeriksaan_tm }}
                            </h2>
                            @if ($formApmElektrikalVehicleExteriorTMTigaBulanan->pemeriksaan_tm == 'Cek kondisi grease pada bearing Traction Motor')
                                            <h5 style="color: red">{{ '*Ganti Grease setiap 8 Bulan sekali' }}</h5>
                                        @endif

                        </th>

                        <td style=" font-size: 7px;text-align:center"><span
                                style="font-family: DejaVu Sans, sans-serif; font-size: 12px;">{{ $formApmElektrikalVehicleExteriorTMTigaBulanan->hasil_mc1 == 'ok' ? '✔' : '' }}</span>
                        </td>
                        <td style=" font-size: 7px;text-align:center"><span
                                style="font-family: DejaVu Sans, sans-serif; font-size: 12px;">{{ $formApmElektrikalVehicleExteriorTMTigaBulanan->hasil_mc1 == 'nok' ? '✔' : '' }}</span>
                        </td>
                        <td style=" font-size: 7px;text-align:center"><span
                                style="font-family: DejaVu Sans, sans-serif; font-size: 12px;">{{ $formApmElektrikalVehicleExteriorTMTigaBulanan->hasil_mc2 == 'ok' ? '✔' : '' }}</span>
                        </td>
                        <td style=" font-size: 7px;text-align:center"><span
                                style="font-family: DejaVu Sans, sans-serif; font-size: 12px;">{{ $formApmElektrikalVehicleExteriorTMTigaBulanan->hasil_mc2 == 'nok' ? '✔' : '' }}</span>
                        </td>
                        <td style="width: 21%">
                            <h3 style="font-size: 12px;  text-align:left; vertical-align:middle;">
                                {{ $formApmElektrikalVehicleExteriorTMTigaBulanan->referensi }}</h3>
                        </td>
                    </tr>
                    @php
                        $number++;
                    ...
                    <tr>
                        <td colspan="7" style="text-align: left">Catatan : {!! $formApmElektrikalVehicleExteriorTMTigaBulanans[0]->catatan !!}</td>
                    </tr>
