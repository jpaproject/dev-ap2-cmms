                ...
                <table class="my-table">
                            ...
                            <table class="my-table">
                                ...
                                @foreach ($formSntChecklistPerawatanIncinerator456Mingguans as $key => $formSntChecklistPerawatanIncinerator456Mingguan)
                                    @if ($formSntChecklistPerawatanIncinerator456Mingguan->incinerator == 'INCINERATOR NOMER 4')
                                        @if ($prevGroup != $formSntChecklistPerawatanIncinerator456Mingguan->group)
                                            <tr class="my-table" style="background-color: rgb(206, 247, 255)2)">
                                                <td>
                                                    {{ $roman[$number] }}
                                                </td>
                                                <td style="text-align: left" colspan="3">
                                                    {{ $formSntChecklistPerawatanIncinerator456Mingguan->group }}</td>
                                            </tr>
                                            @php
                                                $prevGroup = $formSntChecklistPerawatanIncinerator456Mingguan->group;
                                                $number++;
                                                $number2 = 1;
                                            @endphp
                                        @endif
                                        @if ($key == 8 || $key == 9 || $key == 10 || $key == 11)
                                            <tr>
                                                <td></td>
                                                <td>{{ $formSntChecklistPerawatanIncinerator456Mingguan->nama_peralatan }}
                                                </td>
                                                <td style="text-align:center; padding: 5px;"><span
                                                        style="font-family: DejaVu Sans, sans-serif; font-size: 10px">{{ $formSntChecklistPerawatanIncinerator456Mingguan->kondisi == 'BAIK' ? '✔' : '' }}</span>
                                                </td>
                                                <td style="text-align:center; padding: 5px;"><span
                                                        style="font-family: DejaVu Sans, sans-serif; font-size: 10px">{{ $formSntChecklistPerawatanIncinerator456Mingguan->kondisi == 'TROUBLE' ? '✔' : '' }}</span>
                                                </td>
                                            </tr>
                                        @else
                                            <tr>
                    ...
                    <tr>
                        <td colspan="3" height="40" style="vertical-align: baseline;text-align:left">
                            {!! $formSntChecklistPerawatanIncinerator456Mingguan->catatan !!}</td>
                    </tr>
                </table>
