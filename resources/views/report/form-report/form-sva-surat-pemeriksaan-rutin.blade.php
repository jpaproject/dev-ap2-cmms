                ...
                <table style="text-align:center" class="table-data">
                            ...
                            <table class="waktu">
                                <tr>
                                    <td class="border" style="text-align: left">
                                        {{ $formSvaSuratPemeriksaanRutin->nama_petugas_atc }}
                                    </td>
                                </tr>
                            </table>
                        </td>
                    ...
                    <tr>
                        ...
                        <td class="data">
                            <table class="waktu">
                                <tr>
                                    <td class="border">{{ $formSvaSuratPemeriksaanRutin->jam_masuk[0] }}</td>
                                    <td class="border">{{ $formSvaSuratPemeriksaanRutin->jam_masuk[1] }}</td>
                                    <td class="hide" style="text-align: center">-</td>
                                    <td class="border">{{ $formSvaSuratPemeriksaanRutin->jam_masuk[3] }}</td>
                                    <td class="border">{{ $formSvaSuratPemeriksaanRutin->jam_masuk[4] }}</td>
                                </tr>
                            </table>
                        </td>
                        <td></td>
                    ...
                    <tr>
                        ...
                        <td class="data">
                            <table class="waktu">
                                <tr>
                                    <td class="border">{{ $formSvaSuratPemeriksaanRutin->jam_keluar[0] }}</td>
                                    <td class="border">{{ $formSvaSuratPemeriksaanRutin->jam_keluar[1] }}</td>
                                    <td class="hide" style="text-align: center">-</td>
                                    <td class="border">{{ $formSvaSuratPemeriksaanRutin->jam_keluar[3] }}</td>
                                    <td class="border">{{ $formSvaSuratPemeriksaanRutin->jam_keluar[4] }}</td>
                                </tr>
                            </table>
                        </td>
                        <td></td>
                    ...
                    <tr>
                        ...
                        <td class="data">
                            <table class="waktu">
                                <tr>
                                    <td class="border" style="text-align: left">
                                        {{ $formSvaSuratPemeriksaanRutin->nomor_polisi }}
                                    </td>
                                </tr>
                            </table>
                        </td>
                    ...
                    <tr>
                        ...
                        <td class="data" colspan="2">
                            <table class="waktu">
                                <tr>
                                    <td class="border" style="text-align: left">
                                        {{ $formSvaSuratPemeriksaanRutin->tujuan_keperluan }}
                                    </td>
                                </tr>
                            </table>
                        </td>
                    ...
                    <tr>
                        ...
                        <td class="data" colspan="2">
                            <table class="waktu">
                                <tr>
                                    <td class="border" style="text-align: left">
                                        {{ $formSvaSuratPemeriksaanRutin->lokasi_pekerjaan }}
                                    </td>
                                </tr>
                            </table>
                        </td>
                    ...
                    <tr style="border-top: 1px solid black;">
                        <td colspan="3" height="80">
                            ...
                            <br></br>
                        <br></br>
                            {!! $formSvaSuratPemeriksaanRutin->catatan !!}
                        </td>
                    </tr>
