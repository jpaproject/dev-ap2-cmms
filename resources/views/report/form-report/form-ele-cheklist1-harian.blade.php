                    ...
                    <tr style="border: none;">
                        ...
                        <td style="border: none; width: 50%;">
                            ...
                            <div class="table">
                                <table>
                                    <tr>
                                        <td>Tanggal: {{ $formEleChecklist1Harians[0]->tanggal }}</td>
                                    </tr>
                                    <tr>
                                        <td>Jam (Pagi): {{ $formEleChecklist1Harians[0]->jam_pagi }}</td>
                                    </tr>
                                    <tr>
                                        <td>Jam (Sore): {{ $formEleChecklist1Harians[0]->jam_sore }}</td>
                                    </tr>
                                </table>
                            </div>
                        </td>
                    ...
                    {{-- <div class="table"> --}}
                        <table>
                            ...
                            <tr style=" background-color: white; width:30%;">
                                ...
                                <td>{{ $formEleChecklist1Harians[0]->tanggal }}</td>
                            </tr>
                            <tr style=" background-color: white;">
                                <td>Jam (Pagi):</td>
                                <td>{{ $formEleChecklist1Harians[0]->jam_pagi }}</td>
                            </tr>
                            <tr style=" background-color: white;">
                                <td>Jam (Sore):</td>
                                <td>{{ $formEleChecklist1Harians[0]->jam_sore }}</td>
                            </tr>
                        </table>
                    {{-- </div> --}}
                </td>
        ...
        <div class="body">
            <div class="table">
                <table style="text-align:center" class="table-data">
                    <tr>
                        <th colspan="6" class="center" style=" background-color: grey; font-weight:bold">R C M S</th>
                    </tr>
                    <tr>
                        <th style="width: 5%; background-color: white;" rowspan="3" class="center">NO</th>
                        <th style="width: 40%; background-color: white;" rowspan="3" class="center">PERALATAN</th>
                        <th style="width: 30%; background-color: white;" colspan="4" class="center">HASIL</th>
                    </tr>
                    <tr>
                        <th style="width: 5%" colspan="2" class="center" style=" background-color: white;">PAGI</th>
                        <th style="width: 40%" colspan="2" class="center" style=" background-color: white;">SORE</th>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        <td colspan="6" style=" background-color: grey; font-weight:bold" class="center">
                            SISI UTARA
                        </td>
                    </tr>
                    @foreach ( $formEleChecklist1HarianUtaras as $key => $item )
                        <tr>
                            <td>{{$loop->iteration}}</td>
                            <td>{{ $item->pertanyaan ?? '' }}</td>
                            <td class="center">
                                <span style="font-family: DejaVu Sans, sans-serif; font-size: 15px"> @if($item->pagi == "on")  ✔ @else  @endif </span>
                            </td>
                            <td class="center">
                                <span style="font-family: DejaVu Sans, sans-serif; font-size: 15px"> @if($item->pagi == "off")  ✔ @else  @endif </span>
                            </td>

                            <td class="center">
                                <span style="font-family: DejaVu Sans, sans-serif; font-size: 15px"> @if($item->sore == "on")  ✔ @else  @endif </span></td>
                            </td>
                            <td class="center">
                                <span style="font-family: DejaVu Sans, sans-serif; font-size: 15px"> @if($item->sore == "off")  ✔ @else  @endif </span></td>
                            </td>
                        </tr>
                    @endforeach
                    <tr>
                    ...
                    @foreach ( $formEleChecklist1HarianSelatans as $key => $item )
                        <tr>
                            <td>{{$loop->iteration}}</td>
                            <td>{{ $item->pertanyaan ?? '' }}</td>
                            <td class="center">
                ...
                <table class="table-data">
                    ...
                    <tr style="height:50px;">
                        <td style="width:70%; font-weight:bold; font-size:25px;" class="center">
