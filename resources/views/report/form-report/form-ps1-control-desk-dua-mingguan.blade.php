    ...
    <div class="content">
        ...
        <div class="body">
            <div class="table">
                <table>
                    <tr>
                        <th style="width: 20%">C.DESK & PC Mont.</th>
                        <th style="width: 20%">GS1</th>
                        <th style="width: 20%">GS2</th>
                        <th style="width: 20%">SATUAN</th>
                        <th style="width: 20%">KETERANGAN</th>
                    </tr>
                    @foreach ($formPs1ControlDeskDuaMingguanBelakangControl as $key => $control)
                        <tr>
            ...
            <div class="table">
                <table>
                    ...
                    @foreach ($formPs1ControlDeskDuaMingguanBelakangPanel as $key => $panel)
                        <tr>
        ...
        <div class="catatan" width="100">
            ...
            {!! nl2br($formPs1ControlDeskDuaMingguanBelakangControl[0]->catatan ?? '') !!}
        </div>
        {{-- <div class="ttd-left">
