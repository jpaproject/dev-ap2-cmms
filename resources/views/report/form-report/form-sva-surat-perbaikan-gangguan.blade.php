            ...
            <div class="table">
                <table style="text-align:center" class="table-data">
                    <tr class="header-table">
                        <th style="background-color: white; font-size:15px" class="center" colspan="3"> <u>SURAT PERBAIKAN GANGGUAN</u></th>
                    </tr>
                    <tr>
                            ...
                            <table class="waktu">
                                <tr>
                                    <td class="border" style="text-align: left">
                                        {{ $formSvaSuratPerbaikanGangguan->nama_petugas_atc }}
                                    </td>
                                </tr>
                            </table>
                        </td>
                    ...
                    <tr>
                        ...
                        <td class="data">
                            <table class="waktu">
                                <tr>
                                    <td class="border">{{ $formSvaSuratPerbaikanGangguan->jam_masuk[0] }}</td>
                                    <td class="border">{{ $formSvaSuratPerbaikanGangguan->jam_masuk[1] }}</td>
                                    <td class="hide" style="text-align: center">-</td>
                                    <td class="border">{{ $formSvaSuratPerbaikanGangguan->jam_masuk[3] }}</td>
                                    <td class="border">{{ $formSvaSuratPerbaikanGangguan->jam_masuk[4] }}</td>
                                </tr>
                            </table>
                        </td>
                        <td></td>
                    ...
                    <tr>
                        ...
                        <td class="data">
                            <table class="waktu">
                                <tr>
                                    <td class="border">{{ $formSvaSuratPerbaikanGangguan->jam_keluar[0] }}</td>
                                    <td class="border">{{ $formSvaSuratPerbaikanGangguan->jam_keluar[1] }}</td>
                                    <td class="hide" style="text-align: center">-</td>
                                    <td class="border">{{ $formSvaSuratPerbaikanGangguan->jam_keluar[3] }}</td>
                                    <td class="border">{{ $formSvaSuratPerbaikanGangguan->jam_keluar[4] }}</td>
                                </tr>
                            </table>
                        </td>
                        <td></td>
                    ...
                    <tr>
                        ...
                        <td class="data">
                            <table class="waktu">
                                <tr>
                                    <td class="border" style="text-align: left">
                                        {{ $formSvaSuratPerbaikanGangguan->nomor_polisi }}
                                    </td>
                                </tr>
                            </table>
                        </td>
                    ...
                    <tr>
                        ...
                        <td class="data" colspan="2">
                            <table class="waktu">
                                <tr>
                                    <td class="border" style="text-align: left">
                                        {{ $formSvaSuratPerbaikanGangguan->tujuan_keperluan }}
                                    </td>
                                </tr>
                            </table>
                        </td>
                    ...
                    <tr>
                        ...
                        <td class="data" colspan="2">
                            <table class="waktu">
                                <tr>
                                    <td class="border" style="text-align: left">
                                        {{ $formSvaSuratPerbaikanGangguan->lokasi_pekerjaan }}
                                    </td>
                                </tr>
                            </table>
                        </td>
                    ...
                    <tr style="border-top: 1px solid black;">
                        ...
                        <br></br>
                        <br></br>
                            {!! $formSvaSuratPerbaikanGangguan->catatan !!}
                        </td>
                    </tr>
