        ...
        <div class="body">
            <div class="table">
                <table class="my-table">
                    <tr>
                        ...
                        <td rowspan="4" style="width: 25%;text-align:center">
                            <h3>Lembar Pemeriksaan Harian Mechanical
                                Vehicle</h3>
                        </td>
                    ...
                    <tr>
                        ...
                        <td style="width: 30%; font-size: 7px;text-align:left">
                            {{ $formApmMekanikalVehicleBogieHarians[0]['created_at']->format('d-m-Y') }}
                ...
                <table class="my-table " style="border-top: 0pt; height:2.2%">
                    <tr>
                        <th colspan="2">PEMERIKSAAN BOGIE</th>
                    ...
                    @php
                        ...
                        $number = range(1, 10);
                        $numberlooping = range(1, 10);
                        $numberalpa = range(1,27)
                    @endphp
                    @php
                        $numberalpa = 0;
                    @endphp
                    ...
                    @if ($key == 0) 
                        ...
                        @endphp
                            ...
                            <th style="width: 5%;font-size: 10px" rowspan="2">{{ $alphabet[$numberalpa] }}</th>
                                <th style="width: 55%;" rowspan="2">
                                    <h5 style="font-size: 10px vertical-align:middle; text-align:left">
                                        {{ $formApmMekanikalVehicleBogieHarian->pemeriksaan_bogie_group }}</h5>
                                </th>

                                <th colspan="2" style="font-size: 7px">MC 1</th>
                                <th colspan="2" style="font-size: 7px">MC 2</th>

                                <th style=" width: 21%;" rowspan="2">
                                    <h3 style=" font-size: 8px vertical-align:middle;"></h3>
                                </th>
                            </tr>
                            <tr style="background-color:#999696;">
                        ...
                        @if ($key == 0 ||
                            $formApmMekanikalVehicleBogieHarian->pemeriksaan_bogie !=
                                $formApmMekanikalVehicleBogieHarians[$key - 1]->pemeriksaan_bogie)
                                @php
                                    $numberlooping =1;
                                @endphp
                                @if (
                            ...
                            @else
                                ...
                                @endif
                            <tr>
                                <th style="width: 5%" rowspan="{{ $numberloop }}">{{ $number }} </th>
                                <th colspan="5" style="text-align: left; font-size:10px">
                                    {{ $formApmMekanikalVehicleBogieHarian->pemeriksaan_bogie }} </th>
                                <td rowspan="{{ $numberloop }}" style="width: 21%" rowspan>
                                <h3 style="font-size: 10px;  text-align:left; vertical-align:middle;">
                                    {{ $formApmMekanikalVehicleBogieHarian->referensi }}</h3>
                            </td>
                            </tr>
                            @php
                                $number++;
                        ...
                        <tr >
                            ...
                            <th style="width: 55%">{{ $numberlooping }}</th>
                            <td style=" font-size: 7px;text-align:center"><span
                                    style="font-family: DejaVu Sans, sans-serif; font-size: 12px;widith:50%;">{{ $formApmMekanikalVehicleBogieHarian->hasil_mc1 == 'ok' ? '✔' : '' }}</span>
                            <td style=" font-size: 7px;text-align:center"><span
                                    style="font-family: DejaVu Sans, sans-serif; font-size: 12px;widith:50%">{{ $formApmMekanikalVehicleBogieHarian->hasil_mc1 == 'nok' ? '✔' : '' }}</span>
                            </td>
                            <td style=" font-size: 7px;text-align:center"><span
                                    style="font-family: DejaVu Sans, sans-serif; font-size: 12px;widith:50%;">{{ $formApmMekanikalVehicleBogieHarian->hasil_mc2 == 'ok' ? '✔' : '' }}</span>
                            </td>
                            <td style=" font-size: 7px;text-align:center"><span
                                    style="font-family: DejaVu Sans, sans-serif; font-size: 12px;widith:50%">{{ $formApmMekanikalVehicleBogieHarian->hasil_mc2 == 'nok' ? '✔' : '' }}</span>
                            </td>
                            @php
                                $numberlooping++;
                            @endphp
                    ...
                    <tr>
                        <td colspan="7" style="text-align: left; vertical-align:baseline" height="40" >CATATAN : {!! $formApmMekanikalVehicleBogieHarians[49]->catatan !!}</td>
                    </tr>
                </table>
            </div>
        </div>
