            ...
            <div class="table">
                <table class="my-table">
                    ...
                    <tr class="row-title">
                        ...
                        <td style="text-align:center; width: 6%;" colspan="3">ENGINE STARTS</td>
                        <td style="text-align:center; width: 6%;" colspan="2">Oil Level Check</td>
                        <td style="text-align:center; width: 6%;" colspan="2">CLEANING HEAD	</td>
                        <td style="text-align:center; width: 6%;" rowspan="2">Error Codes</td>
                        <td style="text-align:center; width: 6%;" colspan="2">BRUSH	</td>
                    ...
                    <tr>
                        ...
                        <td style="text-align:center; width: 6%;">Operating RPM</td>
                        <td style="text-align:center; width: 6%;">Engine Oil</td>
                        <td style="text-align:center; width: 6%;">Transmission oil</td>
                        <td style="text-align:center; width: 6%;">Nozzles Blocked?</td>
                        <td style="text-align:center; width: 6%;">Any Leaks?</td>
                        <td style="text-align:center; width: 6%;">Side brush</td>
                        <td style="text-align:center; width: 6%;">Middle brush</td>
                    </tr>
                    @foreach ($formAewRubberRemoverHarians as $key1 => $item)
                        <tr class="row-white">
                            ...
                            <td style="text-align:center">
                                <span style="font-family: DejaVu Sans, sans-serif; font-size: 15px font-weight: bold;">{{$item['q12']}}</span>
                            </td>
                        </tr>
                    @endforeach
                </table>
