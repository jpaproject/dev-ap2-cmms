...
<body>
    <div class="content">
        <div class="header">
            <div class="title">
                <table style="padding:20px 20px 0px 20px;" class="title-table">
                    <tr style="background-color: white;">
                        ...
                        <td style=" width: 60%; text-align:center;">
                            Data teknis perawatan 3 Bulanan
                        </td>
                    </tr>
                    <tr style="background-color: white;">
                ...
                {{-- <img style="width: 120px; text-align:left; display:inline; margin-right:30px"
                    src="{{ public_path('img/AP2.png') }}" alt="">
                <h1 style="font-size: 18px; display:inline; margin-right:165px; ">Data teknis perawatan 3 Bulanan</h1>
                <h1 style="font-size: 18px; text-align:center">Gs Standby Perkins 2000Kva No 1 & 2
                </h1> --}}
            </div>
        </div>
        <div class="body">
            <div class="table">
                <table style="table-layout: fixed;">
                    <tr>
                        ...
                        <th style="width: 10%" class="center">GS1</th>
                        <th style="width: 10%" class="center">GS1</th>
                        <th style="width: 15%" class="center">SATUAN</th>
                        <th style="width: 35%" class="center">KETERANGAN</th>
                    </tr>
                    @foreach ($formPs1GensetStandbyTigaBulanans as $key => $control)
                        <tr>
                            <td>{{ $tigaBulanans[$key]['dataTeknis'] ?? '' }}</td>
        ...
        <div class="catatan" width="100">
            ...
            {!! nl2br($formPs1GensetStandbyTigaBulanans[0]->catatan ?? '') !!}
        </div>
        {{-- <div class="ttd-left">
