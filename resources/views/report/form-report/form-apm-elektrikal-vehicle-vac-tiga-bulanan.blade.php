        ...
        <div class="body">
            <div class="table">
                <table class="my-table">
                    <tr>
                        ...
                        <td rowspan="4" style="width: 25%;text-align:center">
                            <h3>Lembar Pemeriksaan 3 Bulanan VAC</h3>
                        </td>
                    ...
                    <tr>
                        ...
                        <td style="width: 30%; font-size: 7px;text-align:left">
                            {{ $formApmElektrikalVehicleExteriorVACTigaBulanans[0]['created_at']->format('d-m-Y') }}
                ...
                <table class="my-table">
                    ...
                    <tr>
                        <th style="width: 30px" colspan="2">VAC 1</th>
                        <th style="width: 30px" colspan="2">VAC 2</th>
                    </tr>
                    <tr>
                ...
                @php
                    $numberalpa = 0;
                @endphp
                @foreach ($formApmElektrikalVehicleExteriorVACTigaBulanans as
                            $key=> $formApmElektrikalVehicleExteriorVACTigaBulanan)
                            @if ($key == 0)
                                @php
                                    $number = 1;
                                @endphp
                    <tr style="background-color:#999696;">
                        ...
                        <td colspan="6" style="text-align: left;width: 55%">
                            {{ $formApmElektrikalVehicleExteriorVACTigaBulanan->pemeriksaan_vac_group }}
                        </td>
                    </tr>
                    @php
                        $numberalpa++;
                ...
                @php
                    ...
                    <tr>
                        ...
                        <th style="text-align: left; widith:55%">
                            <h2>{{ $formApmElektrikalVehicleExteriorVACTigaBulanan->pemeriksaan_vac }}
                            </h2>

                        </th>

                        <td style=" font-size: 7px;text-align:center"><span
                                style="font-family: DejaVu Sans, sans-serif; font-size: 12px;">{{ $formApmElektrikalVehicleExteriorVACTigaBulanan->hasil_mc1 == 'ok' ? '✔' : '' }}</span>
                        </td>
                        <td style=" font-size: 7px;text-align:center"><span
                                style="font-family: DejaVu Sans, sans-serif; font-size: 12px;">{{ $formApmElektrikalVehicleExteriorVACTigaBulanan->hasil_mc1 == 'nok' ? '✔' : '' }}</span>
                        </td>
                        <td style=" font-size: 7px;text-align:center"><span
                                style="font-family: DejaVu Sans, sans-serif; font-size: 12px;">{{ $formApmElektrikalVehicleExteriorVACTigaBulanan->hasil_mc2 == 'ok' ? '✔' : '' }}</span>
                        </td>
                        <td style=" font-size: 7px;text-align:center"><span
                                style="font-family: DejaVu Sans, sans-serif; font-size: 12px;">{{ $formApmElektrikalVehicleExteriorVACTigaBulanan->hasil_mc2 == 'nok' ? '✔' : '' }}</span>
                        </td>
                        <td style="width: 21%">
                            <h3 style="font-size: 12px;  text-align:left; vertical-align:middle;">
                                {{ $formApmElektrikalVehicleExteriorVACTigaBulanan->referensi }}</h3>
                        </td>
                    </tr>
                    @php
                        $number++;
                    ...
                    <tr>
                        <td colspan="7" style="text-align: left">Catatan : {!! $formApmElektrikalVehicleExteriorVACTigaBulanans[0]->catatan !!}</td>
                    </tr>
