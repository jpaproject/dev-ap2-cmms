...
<body>
    <div class="content">
    <table class="table-borderless" style="margin-top:30px; text-align:center">
            ...
            <tr  style=" background-color: white;">
                <td colspan="13" style="text-align: left;font-size:10px">
                    Substation T8
                </td>
                <td colspan="4" style="text-align: right">
                    Suhu Ruangan (°C) : {{ $formNvaConstantCurrentRegulations[0]->suhu }} °C
                </td>
            </tr>
        </table>
        <table class="my-table" style="text-align:center">
            <tr style="text-align:center">
                ...
                <td rowspan="2">Supply Voltage</td>
                <td rowspan="2">System Remote</td>
        ...
        @if ($formNvaConstantCurrentRegulation->substation == 'Substation T8')
            ...
            <th>{{ $formNvaConstantCurrentRegulation->peralatan }}</th>
            <td>{{ $formNvaConstantCurrentRegulation->merk }}</td>
            <td>{{ $formNvaConstantCurrentRegulation->tipe }}</td>
            <td>{{ $formNvaConstantCurrentRegulation->kapasitas }}</td>
            <td>{{ $formNvaConstantCurrentRegulation->tahun_pemasangan }}</td>
            <td>{{ $formNvaConstantCurrentRegulation->supply_voltage }}</td>
            <td>{{ $formNvaConstantCurrentRegulation->system_remote }}</td>
            <td>{{ $formNvaConstantCurrentRegulation->running_hours }}</td>
            <td>{{ $formNvaConstantCurrentRegulation->ampere }}</td>
            <td>{{ $formNvaConstantCurrentRegulation->step1 }}</td>
            <td>{{ $formNvaConstantCurrentRegulation->step2 }}</td>
            <td>{{ $formNvaConstantCurrentRegulation->step3 }}</td>
            <td>{{ $formNvaConstantCurrentRegulation->step4 }}</td>
            <td>{{ $formNvaConstantCurrentRegulation->step5 }}</td>
            <td>{{ $formNvaConstantCurrentRegulation->cg }}</td>
            <td>{{ $formNvaConstantCurrentRegulation->cc }}</td>
        </tr>
        @endif
        @endforeach
    </table>
    ...
    <table class="table-borderless"  style="margin-top:10px;">
            ...
            <tr  style=" background-color: white;">
                ...
                <td colspan="4" style="text-align: right">
                    Suhu Ruangan (°C) : {{ $formNvaConstantCurrentRegulations[1]->suhu }} °C
                </td>
            </tr>
        </table>
        <table class="my-table" style="text-align:center">
    ...
    <table class="table-borderless" style="margin-top:10px;" >
            ...
            <tr  style=" background-color: white;">
                ...
                <td colspan="4" style="text-align: right">
                    Suhu Ruangan (°C) : {{ $formNvaConstantCurrentRegulations[2]->suhu }} °C
                </td>
            </tr>
        </table>
        <table class="my-table" style="text-align:center">
...
<tr>
        ...
        <td>{{ $formNvaConstantCurrentRegulations[0]->tanggal }}</td>
        <td>
            <table>
