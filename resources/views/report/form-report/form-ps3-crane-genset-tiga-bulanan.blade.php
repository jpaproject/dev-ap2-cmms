    ...
    <div class="content">
        <div class="header">
            <div class="title">
                ...
                <h1 style="font-size: 18px; text-align:center">POWER STATION 3 - CRANE GENSET DUA MINGGUAN</h1>
            </div>
        </div>
        <div class="body">
            <div class="table">
                    ...
                    <tr>
                        <td style="background-color: white">
                            <div class="float-left">
                                <h2 style="font-weight: bold; text-align: left;">PEMERIKSAAN ARUS MOTOR CRANE</h2>
                                <div class="group">
                                    <p>· CRANE (A)</p>
                                    <p>· CRANE (B)</p>
                                </div>
                                <h2 style="font-weight: bold; text-align: left;">TEGANGAN INPUT PANEL CRANE</h2>
                                <div class="group">
                                    <p>· CRANE (A)</p>
                                    <p>· CRANE (B)</p>
                                </div>
                            ...
                            <div class="float-right">
                                <div class="group">
                                    <p style="margin-top:10px;">: {{ $formPs3CraneGensetTigaBulanan->arus_motor_crane_a }} A</p>
                                    <p>: {{ $formPs3CraneGensetTigaBulanan->arus_motor_crane_b }} A</p>
                                </div>
                                <div class="group">
                                    <p style="margin-top:10px;">: {{ $formPs3CraneGensetTigaBulanan->panel_crane_a }} A</p>
                                    <p>: {{ $formPs3CraneGensetTigaBulanan->panel_crane_b }} A</p>
                                </div>
                            </div>
