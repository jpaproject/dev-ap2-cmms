    ...
    <div class="content">
        <div class="body">
            <div class="table">
                <table class="my-table">
                    <tr>
                        ...
                        <td rowspan="4" style="width: 25%;text-align:center">
                            <h3>Lembar Pemeriksaan Mingguan Electric Vehicle Exterior</h3>
                        </td>
                    ...
                    <tr>
                        ...
                        <td style="width: 30%; font-size: 7px;text-align:left">
                            {{ $formApmElektrikalVehicleExteriorMingguans[0]['created_at']->format('d-m-Y') }}
                ...
                <table class="my-table">
                    <tr>
                        <th colspan="2" style="width: 55%">PEMERIKSAAN </th>
                ...
                @endphp
                    ...
                    @if ($key == 0 || $formApmElektrikalVehicleExteriorMingguan->pemeriksaan_exterior_group != $formApmElektrikalVehicleExteriorMingguans[$key - 1]->pemeriksaan_exterior_group)
                        @php
                            $number = 1;
                        @endphp
                        @if ($formApmElektrikalVehicleExteriorMingguan->pemeriksaan_exterior_group == 'Filter VVVF')
                            <tr style="background-color:#999696;">
                                ...
                                <td rowspan="2"  style="text-align: left;width: 55%">
                                    {{ $formApmElektrikalVehicleExteriorMingguan->pemeriksaan_exterior_group }}
                                </td>
                    ...
                    @if ($formApmElektrikalVehicleExteriorMingguan->pemeriksaan_exterior_group == 'Filter VVVF')
                        <tr>
                                    ...
                                    <th  style="text-align: left">
                                        <h2>{{ $formApmElektrikalVehicleExteriorMingguan->pemeriksaan_exterior }}
                                        </h2>

                                    </th>
                            <td colspan="2" style=" font-size: 7px;text-align:center"><span
                                            style="font-family: DejaVu Sans, sans-serif; font-size: 12px;widith:50%;">{{ $formApmElektrikalVehicleExteriorMingguan->hasil_mc1  }}</span>
                                    </td>
                                    <td colspan="2" style=" font-size: 7px;text-align:center"><span
                                            style="font-family: DejaVu Sans, sans-serif; font-size: 12px;widith:50%">{{ $formApmElektrikalVehicleExteriorMingguan->hasil_mc1  }}</span>
                                    </td>
                                    ...
                                    <td style="width: 21%">
                                        <h3 style="font-size: 12px;  text-align:left; vertical-align:middle;">
                                            {{ $formApmElektrikalVehicleExteriorMingguan->referensi }}</h3>
                                    </td>
                                </tr>
                                @php
                                    $number++;
                    ...
                    @else
                            ...
                            <td style=" font-size: 7px;text-align:center"><span
                                            style="font-family: DejaVu Sans, sans-serif; font-size: 12px;widith:50%;">{{ $formApmElektrikalVehicleExteriorMingguan->hasil_mc1 == 'ok' ? '✔' : '' }}</span>
                                    </td>
                                    <td style=" font-size: 7px;text-align:center"><span
                                            style="font-family: DejaVu Sans, sans-serif; font-size: 12px;widith:50%">{{ $formApmElektrikalVehicleExteriorMingguan->hasil_mc1 == 'nok' ? '✔' : '' }}</span>
                                    </td>
                                    <td style=" font-size: 7px;text-align:center"><span
                                            style="font-family: DejaVu Sans, sans-serif; font-size: 12px;widith:50%;">{{ $formApmElektrikalVehicleExteriorMingguan->hasil_mc2 == 'ok' ? '✔' : '' }}</span>
                                    </td>
                                    <td style=" font-size: 7px;text-align:center"><span
                                            style="font-family: DejaVu Sans, sans-serif; font-size: 12px;widith:50%">{{ $formApmElektrikalVehicleExteriorMingguan->hasil_mc2 == 'nok' ? '✔' : '' }}</span>
                                    </td>
                                    <td style="width: 21%">
                                        <h3 style="font-size: 12px;  text-align:left; vertical-align:middle;">
                                            {{ $formApmElektrikalVehicleExteriorMingguan->referensi }}</h3>
                    ...
                    <tr>
                        <td colspan="7" style="text-align: left">Catatan : {!! $formApmElektrikalVehicleExteriorMingguans[0]->catatan !!}</td>
                    </tr>
