...
<body>
    <div class="content">
        <div class="header">
            <div class="title">
                ...
                {{-- <img style="width: 120px; text-align:left; display:inline; margin-right:30px"
                    src="{{ public_path('img/AP2.png') }}" alt="">
                <h1 style="font-size: 18px; display:inline; margin-right:165px; ">Data teknis perawatan Tahunan --}}
                </h1>
            </div>
        </div>
        <div class="body">
            <div class="table">
                <table>
                    <tr>
                        ...
                        <th style="width: 20%" class="center">Gs {{ $formPs1GensetMobileTahunans[0]->tipe }} KVA</th>
                        <th style="width: 20%" class="center">SATUAN</th>
                        <th style="width: 20%" class="center">KETERANGAN</th>
                    </tr>
                    @foreach ($formPs1GensetMobileTahunans as $key => $control)
                        <tr>
        ...
        <div class="catatan" width="100">
            ...
            {!! nl2br($formPs1GensetMobileTahunans[0]->catatan) !!}
        </div>
        {{-- <div class="ttd-left">
