        ...
        <div class="body">
            <div class="table">
                <table class="my-table" >
                    <tr class="row-title">
                        <td class="bold" colspan="2" style="text-align:center">LAPORAN HASIL KERJA OPERASIONAL MALAM</td>
                    </tr>
                    <tr class="row-title">
                    ...
                    <tr class="row-white">
                        ...
                        <td style="text-align:center; padding: 5px;"><span
                                >{{ $formUpsLaporanHasilKerjaMalam->koordinasi  }}</span>
                        </td>
                    </tr>
                    <tr class="row-white">
                        <td class="row-title" style="text-align:left"> Cek visual peralatan via monitoring RCMS :</td>
                        <td style="text-align:center; padding: 5px;"><span
                                >{{ $formUpsLaporanHasilKerjaMalam->hasil_visual  }}</span>
                        </td>
                    </tr>
                    <tr class="row-white">
                    ...
                    <tr class="row-white">
                        ...
                        <td style="text-align:center; padding: 5px;"><span
                                style="font-family: DejaVu Sans, sans-serif; font-size: 20px">{{ $formUpsLaporanHasilKerjaMalam->toolkit == true ? '✔' : '' }}</span>
                        </td>
                    </tr>
                    <tr class="row-white">
                        <td "><span
                        ...
                        <td style="text-align:center; padding: 5px;"><span
                                style="font-family: DejaVu Sans, sans-serif; font-size: 20px">{{ $formUpsLaporanHasilKerjaMalam->avometer == true ? '✔' : '' }}</span>
                        </td>
                    </tr>
                    <tr class="row-white">
                        <td ><span
                        ...
                        <td style="text-align:center; padding: 5px;"><span
                                style="font-family: DejaVu Sans, sans-serif; font-size: 20px">{{ $formUpsLaporanHasilKerjaMalam->kendaraan == true ? '✔' : '' }}</span>
                        </td>
                    </tr>
                    <tr class="row-white">
                        <td ><span
                        ...
                        <td style="text-align:center; padding: 5px;"><span
                                style="font-family: DejaVu Sans, sans-serif; font-size: 20px">{{ $formUpsLaporanHasilKerjaMalam->apd == true ? '✔' : '' }}</span>
                        </td>
                    </tr>
                    <tr class="row-white">
                        <td><span
                        ...
                        <td style="text-align:center; padding: 5px;"><span
                                style="font-family: DejaVu Sans, sans-serif; font-size: 20px">{{ $formUpsLaporanHasilKerjaMalam->reytex == true ? '✔' : '' }}</span>
                        </td>
                    </tr>
                    <tr class="row-white">
                        <td ><span
                        ...
                        <td style="text-align:center; padding: 5px;"><span
                                style="font-family: DejaVu Sans, sans-serif; font-size: 20px">{{ $formUpsLaporanHasilKerjaMalam->alat_cleaning == true ? '✔' : '' }}</span>
                        </td>
                    </tr>
                    <tr class="row-white">
                        ...
                        <td style="text-align:center; padding: 5px;"><span
                                style="font-family: DejaVu Sans, sans-serif; font-size: 20px">{{ $formUpsLaporanHasilKerjaMalam->pengukuran == true ? '✔' : '' }}</span>
                        </td>
                    </tr>
                    <tr class="row-white">
                        <td class="row-title" style="text-align:left">Mengecek temperatur peralatan dan ruangan sekitar peralatan.</td>
                        <td style="text-align:center; padding: 5px;"><span
                                style="font-family: DejaVu Sans, sans-serif; font-size: 20px">{{ $formUpsLaporanHasilKerjaMalam->temperatur == true ? '✔' : '' }}</span>
                        </td>
                    </tr>
                    <tr class="row-white">
                        <td class="row-title" style="text-align:left">Membersihkan bagian-bagian peralatan dan area sekitar peralatan.</td>
                        <td style="text-align:center; padding: 5px;"><span
                                style="font-family: DejaVu Sans, sans-serif; font-size: 20px">{{ $formUpsLaporanHasilKerjaMalam->membersihkan == true ? '✔' : '' }}</span>
                        </td>
                    </tr>
                    <tr class="row-white">
                        <td class="row-title" style="text-align:left">Data dan dokumetasi selama kegiatan terlampir.</td>
                        <td style="text-align:center; padding: 5px;"><span
                                style="font-family: DejaVu Sans, sans-serif; font-size: 20px">{{ $formUpsLaporanHasilKerjaMalam->dokumentasi == true ? '✔' : '' }}</span>
                        </td>
                    </tr>
                    <tr class="row-white">
                        <td class="row-title" style="text-align:left">Serah terima tugas dengan petugas dinas Pagi siang (PS)</td>
                        <td style="text-align:center; padding: 5px;"><span
                                style="font-family: DejaVu Sans, sans-serif; font-size: 20px">{{ $formUpsLaporanHasilKerjaMalam->serahterima == true ? '✔' : '' }}</span>
                        </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        <td class="row-white" colspan="2" style="height: 80px; vertical-align: start">
                            {!! $formUpsLaporanHasilKerjaMalam->catatan ?? '' !!}</td>
                    </tr>
                </table>
            </div>
        </div>
