...
<body>
    <div class="content">
            ...
            <div class="table">
                <table>
                    <tr>
                        ...
                        <th style="width: 20%" class="center">Gs {{ $formPs1GensetMobileDuaMingguans[0]->tipe }} KVA
                        </th>
                        <th style="width: 20%" class="center">SATUAN</th>
                    </tr>
                    @foreach ($formPs1GensetMobileDuaMingguans as $key => $control)
                        <tr>
        ...
        <div class="catatan" width="100">
            ...
            {!! nl2br($formPs1GensetMobileDuaMingguans[0]->catatan) !!}
        </div>
        {{-- <div class="ttd-left">
