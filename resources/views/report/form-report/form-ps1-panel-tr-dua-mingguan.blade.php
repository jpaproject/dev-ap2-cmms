...
<body>
    <div class="content">
        <div class="header">
            <div class="title">
                <table style="padding:20px 20px 0px 20px;" class="title-table">
                    ...
                    <tr style="background-color: white;">
                        <td>Panel TR, Panel SDP dan Lighting Ged.PS1 New</td>
                    </tr>
                </table>
            </div>
            <div class="body">
                <div class="table">
                    <table>
                        ...
                        @foreach ($formPs1PanelTrDuaMingguanNp0s as $key => $formPs1PanelTrDuaMingguanNp0)
                            <tr>
                                <td>{{ $formPs1PanelTrDuaMingguanNp0->pertanyaan }}</td>
                                <td class="center">{{ $formPs1PanelTrDuaMingguanNp0->q1 ?? '' }}</td>
                                <td class="center">{{ $formPs1PanelTrDuaMingguanNp0->q2 ?? '' }}</td>
                                <td class="center">{{ $formPs1PanelTrDuaMingguanNp0->q3 ?? '' }}</td>
                                <td>{{ $formPs1PanelTrDuaMingguanNp0->satuan }}</td>
                                <td>{{ $formPs1PanelTrDuaMingguanNp0->keterangan ?? '' }}</td>
                            </tr>
                        @endforeach
                    </table>
                </div>
                ...
                <div class="table">
                    <table>
                        ...
                        @foreach ($formPs1PanelTrDuaMingguanT0s as $key => $formPs1PanelTrDuaMingguanT0)
                            <tr>
                                <td>{{ $formPs1PanelTrDuaMingguanT0->pertanyaan }}</td>
                                <td class="center">{{ $formPs1PanelTrDuaMingguanT0->q1 ?? '' }}</td>
                                <td class="center">{{ $formPs1PanelTrDuaMingguanT0->q2 ?? '' }}</td>
                                <td class="center">{{ $formPs1PanelTrDuaMingguanT0->q3 ?? '' }}</td>
                                <td>{{ $formPs1PanelTrDuaMingguanT0->satuan }}</td>
                                <td>{{ $formPs1PanelTrDuaMingguanT0->keterangan ?? '' }}</td>
                            </tr>
                        @endforeach
                    </table>
                </div>
        ...
        {{-- <div class="catatan" width="100">
            ...
            {!! nl2br($formPs1PanelTrDuaMingguanNp0s[0]->catatan) !!}
        </div> --}}
