...
<body>
    ...
    @if(!$formPs3TrafoEnamBulananTahunan->phase_a == null || !$formPs3TrafoEnamBulananTahunan->phase_b == null || !$formPs3TrafoEnamBulananTahunan->phase_c == null)
        <div class="content @if (!$loop->last) page-break @endif">
            <div class="header">
                <div class="title">
                    ...
                    <h1 style="font-size: 18px; text-align:center">POWER STATION 3 - TRAFO ENAM BULANAN | TAHUNAN</h1>
                </div>
            </div>
            <div class="body">
                <div class="table">
                        ...
                        <tr>
                            <td style="background-color: white">
                                <div class="float-left">
                                    ...
                                    <h3 style="margin-top: 5px; text-align: left;">TRAFO {{ $formPs3TrafoEnamBulananTahunan->type }}</h3>
                                    <div class="group">
                                ...
                                <div class="float-right">
                                    <div class="group">
                                        <p style="margin-top: 45px">= {{ $formPs3TrafoEnamBulananTahunan->phase_a }}</p>
                                        <p>= {{ $formPs3TrafoEnamBulananTahunan->phase_b }}</p>
                                        <p>= {{ $formPs3TrafoEnamBulananTahunan->phase_c }}</p>
                                    </div>
                                </div>
