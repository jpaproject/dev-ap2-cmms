        ...
        <div class="body">
            <div class="table">
                <table class="my-table">
                    <tr>
                        ...
                        <td rowspan="4" style="width: 25%;text-align:center">
                            <h3>Lembar Pemeriksaan 3 Bulanan MDS & Fuse Box</h3>
                        </td>
                    ...
                    <tr>
                        ...
                        <td style="width: 30%; font-size: 7px;text-align:left">
                            {{ $formApmElektrikalVehicleExteriorMDSTigaBulanans[0]['created_at']->format('d-m-Y') }}
                ...
                <table class="my-table">
                    ...
                    <tr>
                        <th colspan="2" style="width: 15px" >OK</th>
                        <th colspan="2" style="width: 15px">NOK</th>
                    </tr>
                    @php
                ...
                @php
                    $numberalpa = 0;
                @endphp
                @foreach ($formApmElektrikalVehicleExteriorMDSTigaBulanans as
                            $key=> $formApmElektrikalVehicleExteriorMDSTigaBulanan)
                            @if ($key == 0)
                                @php
                                    $number = 1;
                                @endphp
                    <tr style="background-color:#999696;">
                        ...
                        <td colspan="6" style="text-align: left;width: 55%">
                            {{ $formApmElektrikalVehicleExteriorMDSTigaBulanan->pemeriksaan_mds_group }}
                        </td>
                    </tr>
                    @php
                        $numberalpa++;
                ...
                @php
                    ...
                    @if ($key == 4)
                    <tr>
                        <th rowspan="4" style="width: 5%">5 </th>
                        <th colspan="6" style="text-align: left; widith:55%">
                            <h2>Kondisi Knife Switch
                            </h2>
                        </th></tr>
                    <tr>
                        <th style="text-align: left; widith:55%">
                            <h2>{{ $formApmElektrikalVehicleExteriorMDSTigaBulanan->pemeriksaan_mds }}
                            </h2>
                        </th>

                        <td colspan="2" style=" font-size: 7px;text-align:center"><span
                                style="font-family: DejaVu Sans, sans-serif; font-size: 12px;">{{ $formApmElektrikalVehicleExteriorMDSTigaBulanan->hasil_mc1 == 'ok' ? '✔' : '' }}</span>
                        </td>
                        <td colspan="2" style=" font-size: 7px;text-align:center"><span
                                style="font-family: DejaVu Sans, sans-serif; font-size: 12px;">{{ $formApmElektrikalVehicleExteriorMDSTigaBulanan->hasil_mc1 == 'nok' ? '✔' : '' }}</span>
                        </td>
                        <td  rowspan="2" style="width: 21%">
                            <h3 style="font-size: 12px;  text-align:left; vertical-align:middle;">
                                {{ $formApmElektrikalVehicleExteriorMDSTigaBulanan->referensi }}</h3>
                        </td>
                    </tr>
                    @elseif($key == 5)
                    <tr>
                    ...
                    @php
                        $number++;
                    @endphp
                    @elseif($formApmElektrikalVehicleExteriorMDSTigaBulanan->pemeriksaan_mds_group == 'FUSE BOX')
                    <tr>
                        ...
                        <td style=" font-size: 7px;text-align:center"><span
                                style="font-family: DejaVu Sans, sans-serif; font-size: 12px;">{{ $formApmElektrikalVehicleExteriorMDSTigaBulanan->hasil_mc2 == 'ok' ? '✔' : '' }}</span>
                        </td>
                        <td style=" font-size: 7px;text-align:center"><span
                                style="font-family: DejaVu Sans, sans-serif; font-size: 12px;">{{ $formApmElektrikalVehicleExteriorMDSTigaBulanan->hasil_mc2 == 'nok' ? '✔' : '' }}</span>
                        </td>
                        <td style="width: 21%">
                            <h3 style="font-size: 12px;  text-align:left; vertical-align:middle;">
                                {{ $formApmElektrikalVehicleExteriorMDSTigaBulanan->referensi }}</h3>
                    ...
                    <tr>
                        <td colspan="7" style="text-align: left">Catatan : {!! $formApmElektrikalVehicleExteriorMDSTigaBulanans[0]->catatan !!}</td>
                    </tr>
