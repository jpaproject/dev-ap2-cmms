    ...
    <div class="content">
        <div class="header">
            <div class="title">
                ...
                <h1 style="font-size: 18px; text-align:center">POWER STATION 3 - SUMP TANK LAMA ENAM BULANAN DAN TAHUNAN</h1>
            </div>
        </div>
        <div class="body">
            <div class="table">
                <table style="table-layout: fixed;">
                    ...
                    <tr>
                        <td style="background-color: white">
                            <span class="float-left">SUMP TANK1</span><span class="float-right">: {{ $formPs3SumpTankLamaEnamBulananTahunan->sump_tank1 }} L</span>
                            <div style="clear: both"></div>
                            <span class="float-left">SUMP TANK2</span><span class="float-right">: {{ $formPs3SumpTankLamaEnamBulananTahunan->sump_tank2 }} L</span>
                            <div style="clear: both"></div>
                            <br>
