        ...
        <div class="body">
            <div class="table">
                <table class="my-table">
                    <tr>
                        ...
                        <td rowspan="4" style="width: 25%;text-align:center">
                            <h3>Lembar Pemeriksaan 3 Bulanan Brake HSCB</h3>
                        </td>
                    ...
                    <tr>
                        ...
                        <td style="width: 30%; font-size: 7px;text-align:left">
                            {{ $formApmElektrikalVehicleExteriorHSCBTigaBulanans[0]['created_at']->format('d-m-Y') }}
                ...
                @php
                    $numberalpa =0;
                @endphp
                @foreach ($formApmElektrikalVehicleExteriorHSCBTigaBulanans as $key => $formApmElektrikalVehicleExteriorHSCBTigaBulanan) 
                    @if ($key == 0 || $formApmElektrikalVehicleExteriorHSCBTigaBulanan->pemeriksaan_hscb_group != $formApmElektrikalVehicleExteriorHSCBTigaBulanans[$key - 1]->pemeriksaan_hscb_group)
                        @php
                            $number = 1;
                        @endphp    
                        <tr style="background-color:#999696;">
                                ...
                                <td colspan="4" style="text-align: left;width: 55%">
                                    {{ $formApmElektrikalVehicleExteriorHSCBTigaBulanan->pemeriksaan_hscb_group }}
                                </td>
                            </tr>
                            @php
                                $numberalpa++;
                        ...
                        @endif
                                ...
                                <tr>
                                    ...
                                    <th style="text-align: left; widith:55%">
                                        <h2>{{ $formApmElektrikalVehicleExteriorHSCBTigaBulanan->pemeriksaan_hscb }}
                                        </h2>

                                    </th>

                                    <td style=" font-size: 7px;text-align:center"><span
                                            style="font-family: DejaVu Sans, sans-serif; font-size: 12px;">{{ $formApmElektrikalVehicleExteriorHSCBTigaBulanan->hasil_mc1 == 'ok' ? '✔' : '' }}</span>
                                    </td>
                                    <td style=" font-size: 7px;text-align:center"><span
                                            style="font-family: DejaVu Sans, sans-serif; font-size: 12px;">{{ $formApmElektrikalVehicleExteriorHSCBTigaBulanan->hasil_mc1 == 'nok' ? '✔' : '' }}</span>
                                    </td>
                                    
                                    <td style="width: 21%">
                                        <h3 style="font-size: 12px;  text-align:left; vertical-align:middle;">
                                            {{ $formApmElektrikalVehicleExteriorHSCBTigaBulanan->referensi }}</h3>
                                    </td>
                                </tr>
                                @php
                                    $number++;
                ...
                @endforeach
                    ...
                    <tr>
                        <td colspan="5" style="text-align: left">Catatan : {!! $formApmElektrikalVehicleExteriorHSCBTigaBulanans[0]->catatan !!}</td>
                    </tr>
