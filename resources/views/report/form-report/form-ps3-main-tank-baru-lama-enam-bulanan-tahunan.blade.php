    ...
    <div class="content">
        <div class="header">
            <div class="title">
                ...
                <h1 style="font-size: 18px; text-align:center">POWER STATION 3 - MAIN TANK BARU ENAM BULANAN DAN TAHUNAN</h1>
            </div>
        </div>
        <div class="body">
            <div class="table">
                <table style="table-layout: fixed;">
                    ...
                    <tr>
                        <td style="background-color: white">
                            <span class="float-left">MAIN TANK1</span><span class="float-right">: {{ $formPs3MainTankBaruLamaEnamBulananTahunan->main_tank1 }} L</span>
                            <div style="clear: both"></div>
                            <span class="float-left">MAIN TANK2</span><span class="float-right">: {{ $formPs3MainTankBaruLamaEnamBulananTahunan->main_tank2 }} L</span>
                            <div style="clear: both"></div>
                            <span class="float-left">MAIN TANK3</span><span class="float-right">: {{ $formPs3MainTankBaruLamaEnamBulananTahunan->main_tank3 }} L</span>
                            <div style="clear: both"></div>
                            <br>
                            <p style="margin-left: 20px; text-align:left; font-size:12px ">{{ $formPs3MainTankBaruLamaEnamBulananTahunan->catatan}}</p>
                        </td>
                    </tr>
                </table>
            </div>
