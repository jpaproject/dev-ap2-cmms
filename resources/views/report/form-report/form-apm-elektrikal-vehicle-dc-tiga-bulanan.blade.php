        ...
        <div class="body">
            <div class="table">
                <table class="my-table">
                    <tr>
                        ...
                        <td rowspan="4" style="width: 25%;text-align:center">
                            <h3>Lembar Pemeriksaan 3 Bulanan DC Arrester</h3>
                        </td>
                    ...
                    <tr>
                        ...
                        <td style="width: 30%; font-size: 7px;text-align:left">
                            {{ $formApmElektrikalVehicleExteriorDCTigaBulanans[0]['created_at']->format('d-m-Y') }}
                ...
                @php
                    $numberalpa =0;
                @endphp
                @foreach ($formApmElektrikalVehicleExteriorDCTigaBulanans as $key => $formApmElektrikalVehicleExteriorDCTigaBulanan) 
                    @if ($key == 0 || $formApmElektrikalVehicleExteriorDCTigaBulanan->pemeriksaan_dc_group != $formApmElektrikalVehicleExteriorDCTigaBulanans[$key - 1]->pemeriksaan_dc_group)
                        @php
                            $number = 1;
                        @endphp    
                        <tr style="background-color:#999696;">
                                ...
                                <td colspan="4" style="text-align: left;width: 55%">
                                    {{ $formApmElektrikalVehicleExteriorDCTigaBulanan->pemeriksaan_dc_group }}
                                </td>
                            </tr>
                            @php
                                $numberalpa++;
                        ...
                        @endif
                                ...
                                <tr>
                                    ...
                                    <th style="text-align: left; widith:55%">
                                        <h2>{{ $formApmElektrikalVehicleExteriorDCTigaBulanan->pemeriksaan_dc }}
                                        </h2>

                                    </th>

                                    <td style=" font-size: 7px;text-align:center"><span
                                            style="font-family: DejaVu Sans, sans-serif; font-size: 12px;">{{ $formApmElektrikalVehicleExteriorDCTigaBulanan->hasil_mc1 == 'ok' ? '✔' : '' }}</span>
                                    </td>
                                    <td style=" font-size: 7px;text-align:center"><span
                                            style="font-family: DejaVu Sans, sans-serif; font-size: 12px;">{{ $formApmElektrikalVehicleExteriorDCTigaBulanan->hasil_mc1 == 'nok' ? '✔' : '' }}</span>
                                    </td>
                                    <td style="width: 21%">
                                        <h3 style="font-size: 12px;  text-align:left; vertical-align:middle;">
                                            {{ $formApmElektrikalVehicleExteriorDCTigaBulanan->referensi }}</h3>
                                    </td>
                                </tr>
                                @php
                                    $number++;
                ...
                @endforeach
                    ...
                    <tr>
                        <td colspan="5" style="text-align: left">Catatan : {!! $formApmElektrikalVehicleExteriorDCTigaBulanans[0]->catatan !!}</td>
                    </tr>
