                ...
                <table class="my-table">
                    ...
                    <tr >
                            ...
                            <table class="my-table">
                                ...
                                @foreach ($formSntChecklistPerawatanIncinerator567Harians as $key => $formSntChecklistPerawatanIncinerator567Harian)
                                    @if ($formSntChecklistPerawatanIncinerator567Harian->incinerator == 'INCINERATOR NOMER 5')
                                        @if ($prevGroup != $formSntChecklistPerawatanIncinerator567Harian->group)
                                            <tr class="my-table" style="background-color: rgb(206, 247, 255)2)">
                                                <td>
                                                    {{ $roman[$number] }}
                                                </td>
                                                <td style="text-align: left" colspan="3">
                                                    {{ $formSntChecklistPerawatanIncinerator567Harian->group }}</td>
                                            </tr>
                                            @php
                                                $prevGroup = $formSntChecklistPerawatanIncinerator567Harian->group;
                                                $number++;
                                                $number2 = 1;
                                            @endphp
                                    ...
                                    @if ($key == 8||$key ==9 || $key ==16)
                                        <tr>
                                            <td></td>
                                            <td>{{ $formSntChecklistPerawatanIncinerator567Harian->nama_peralatan }}
                                            </td>
                                            <td style="text-align:center; padding: 5px;"><span
                                                    style="font-family: DejaVu Sans, sans-serif; font-size: 10px">{{ $formSntChecklistPerawatanIncinerator567Harian->kondisi == 'BAIK' ? '✔' : '' }}</span>
                                            </td>
                                            <td style="text-align:center; padding: 5px;"><span
                                                    style="font-family: DejaVu Sans, sans-serif; font-size: 10px">{{ $formSntChecklistPerawatanIncinerator567Harian->kondisi == 'TROUBLE' ? '✔' : '' }}</span>
                                            </td>
                                        </tr>
                                        @else
                                        <tr>
                        ...
                        <td style="vertical-align: baseline;">
                            <table class="my-table">
                                <tr>
                                    <td colspan="4" style="background-color: yellow">INCINERATOR NOMER 7</td>
                                </tr>
                                <tr style="background-color: chocolate">
                                    <td rowspan="2" style="width: 2%">NO</td>
                                    <td rowspan="2" >URAIAN PERALATAN</td>
                    ...
                    <tr>
                        <td colspan="3" height="40" style="vertical-align: baseline;text-align:left">{!! $formSntChecklistPerawatanIncinerator567Harian->catatan !!}</td>
                    </tr>
                </table>
