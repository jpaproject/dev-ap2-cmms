...
<body>
    <div class="content">
        ...
        <table class="my-table" style="text-align:center">
            <tr style=" background-color:rgb(230, 181, 121);text-align:center">
                <td rowspan="2" style="width: 5%">NO</td>
                <td rowspan="2">Facility Inspected</td>
                <td colspan="4">PAPI Slope Angle</td>
                <td>Flight check On Slope</td>
                <td rowspan="2">Current Calibration</td>
                    ...
                    @if ($key == 0 || $key == 3)
                        @if ($key == 0)
                            <tr>
                                ...
                                <td rowspan="6">{{ $formNvaHFCPapiHarian->Fi }}</td>
                                <td style=" background-color: rgb(198, 193, 193);" colspan="5">STANDARD (ILS)</td>
                                <td rowspan="6">{{ $formNvaHFCPapiHarians[5]->current_calibration }}</td>
                                <td rowspan="6">{{ $formNvaHFCPapiHarians[5]->next_calibration }}</td>
                            </tr>
                            <tr style=" background-color: white;">
                                <td>{{ $formNvaHFCPapiHarian->glide_a_derajat }}°{{ $formNvaHFCPapiHarian->glide_a_menit }}'
                                </td>
                                <td>{{ $formNvaHFCPapiHarian->glide_b_derajat }}°{{ $formNvaHFCPapiHarian->glide_b_menit }}'
                                </td>
                                <td>{{ $formNvaHFCPapiHarian->glide_c_derajat }}°{{ $formNvaHFCPapiHarian->glide_c_menit }}'
                                </td>
                                <td>{{ $formNvaHFCPapiHarian->glide_d_derajat }}°{{ $formNvaHFCPapiHarian->glide_d_menit }}'
                                </td>
                                <td>{{ $formNvaHFCPapiHarian->ccos }}</td>
