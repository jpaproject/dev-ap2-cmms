            ...
            <div class="table">
                <table>
                    <tr>
                        ...
                        <th style="width: 20%" class="center">GS. MPS 2 NO. 1</th>
                        <th style="width: 20%" class="center">GS. MPS 2 NO. 2</th>
                    </tr>
                    @foreach ($formPs1ControlDeskTahunans as $key => $control)
                        <tr>
                            <td>{{ $key + 1 }}</td>
                            <td>{{ $control->pertanyaan }}</td>
                            <td class="center">{{ $control->q1 ?? '' }} @if ($satuan[$key] != '')
                                    <span class="text-muted"> {{ $satuan[$key] }}</span>
                                @endif
                            </td>
                            <td class="center">{{ $control->q2 ?? '' }} @if ($satuan[$key] != '')
                                    <span class="text-muted"> {{ $satuan[$key] }}</span>
                                @endif
                            </td>
                        </tr>
