            ...
            <div class="table">
                ...
                <table style="table-layout: fixed;">
                    <tr>
                        ...
                        <th style="width: 7%">Setting Arus Max</th>
                        <th style="width: 7%">Setting Arus Bocor</th>
                        <th style="width: 7%">Setting Tegangan Short</th>
                        <th style="width: 7%">Counter CB</th>
                    ...
                    @foreach ($panelSynchrons as $key => $panelSynchron)
                        <tr>
                            ...
                            <td class="center">{{ $panelSynchron->setting_arus_max }}</td>
                            <td class="center">{{ $panelSynchron->setting_arus_bocor }}</td>
                            <td class="center">{{ $panelSynchron->setting_tegangan_short }}</td>
                            <td class="center">{{ $panelSynchron->counter_cb }}</td>
                ...
                <table style="table-layout: fixed;">
                    ...
                    @foreach ($er1bs as $key => $er1b)
                        <tr>
                            ...
                            <td class="center">{{ $er1b->setting_arus_max }}</td>
                            <td class="center">{{ $er1b->setting_arus_bocor }}</td>
                            <td class="center">{{ $er1b->setting_tegangan_short }}</td>
                            <td class="center">{{ $er1b->counter_cb }}</td>
                ...
                <table style="table-layout: fixed;">
                    ...
                    @foreach ($er7s as $key => $er7)
                        <tr>
                            ...
                            <td class="center">{{ $er7->setting_arus_max }}</td>
                            <td class="center">{{ $er7->setting_arus_bocor }}</td>
                            <td class="center">{{ $er7->setting_tegangan_short }}</td>
                            <td class="center">{{ $er7->counter_cb }}</td>
                ...
                <table style="table-layout: fixed;">
                    ...
                    @foreach ($er6s as $key => $er6)
                        <tr>
                            ...
                            <td class="center">{{ $er6->setting_arus_max }}</td>
                            <td class="center">{{ $er6->setting_arus_bocor }}</td>
                            <td class="center">{{ $er6->setting_tegangan_short }}</td>
                            <td class="center">{{ $er6->counter_cb }}</td>
                ...
                <table style="table-layout: fixed;">
                    ...
                    @foreach ($er2as as $key => $er2a)
                        <tr>
                            ...
                            <td class="center">{{ $er2a->setting_arus_max }}</td>
                            <td class="center">{{ $er2a->setting_arus_bocor }}</td>
                            <td class="center">{{ $er2a->setting_tegangan_short }}</td>
                            <td class="center">{{ $er2a->counter_cb }}</td>
                ...
                <table style="table-layout: fixed;">
                    ...
                    @foreach ($er2bs as $key => $er2b)
                        <tr>
                            ...
                            <td class="center">{{ $er2b->setting_arus_max }}</td>
                            <td class="center">{{ $er2b->setting_arus_bocor }}</td>
                            <td class="center">{{ $er2b->setting_tegangan_short }}</td>
                            <td class="center">{{ $er2b->counter_cb }}</td>
