            ...
            <div class="table">
                <table class="my-table">
                    <tr>
                        ...
                        <td rowspan="4" style="width: 25%;text-align:center"><h3>Lembar Pemeriksaan Harian Mechanical Vehicle</h3></td>
                        <th style=" font-size: 10px;text-align:left">No. Dokumen</th>
                        <th style="width: 5%; font-size: 10px;text-align:left">:</th>
                        <th style="width: 30%; font-size: 10px;text-align:left">FRM-MOP-APMS-42-003</th>
                    ...
                    <tr>
                        <td style=" font-size: 10px;">Tanggal Efektif</td>
                        <td style="width: 5%; font-size: 10px;">:</td>
                        <th style="width: 30%; font-size: 10px;text-align:left">
                            {{ $formApmVehicleCarBodyHarians[0]['created_at']->format('d-m-Y') }} </td>
                    </tr>
                    <tr>
                        <td style=" font-size: 10px;">Revisi</td>
                        <td style="width: 5%; font-size: 10px;">:</td>
                        <th style="width: 30%; font-size: 10px;text-align:left">
                            </td>
                    </tr>
                    <tr>
                        ...
                        <td style="width: 5%; font-size: 10px;">:</td>
                        <th style="width: 30%; font-size: 10px;text-align:left">1 Halaman</td>
                    </tr>
                    <tr>
                        <td colspan="6"></td>
                    </tr>
                ...
                <table class="my-table">
                    ...
                    <tr>
                        ...
                        <td style="width: 30%; font-size: 10px;">
                            {{ $formApmVehicleCarBodyHarians[0]['created_at']->format('d-m-Y') }}
                        </td>
                ...
                <table class="my-table" style="table-layout: fixed" >
                    <tr>
                        <th colspan="2">PEMERIKSAAN CARBODY </th>
                        <th colspan="4">HASIL</th>HARIAN
                        <th>REFERENSI</th>
                    </tr>
                    @foreach ($formApmVehicleCarBodyHarians as $formApmVehicleCarBodyHarian)
                        <tr style="background-color:#999696;">
                            ...
                            <th style="width: 55%" rowspan="2">
                                <h4 style="font-size: 15px vertical-align:middle; text-align:left">
                                    {{ $formApmVehicleCarBodyHarian->pemeriksaan_carbody_group }}</h4>
                            </th>
                        ...
                        <tr>
                            <td style="width: 5%;text-align:center" height="30">1.</td>
                            <td style="width: 55%">
                                <h3 style="font-size: 12px; vertical-align:middle; text-align=left;">
                                    {{ $formApmVehicleCarBodyHarian->pemeriksaan_carbody }}</h3>
                            </td>
                                <td style="text-align:center"><span
                                        style="font-family: DejaVu Sans, sans-serif; font-size: 12px;;">{{ $formApmVehicleCarBodyHarian->hasil_mc1 == 'ok' ? '✔' : '' }}</span>
                                </td>
                                <td style="text-align:center"><span
                                        style="font-family: DejaVu Sans, sans-serif; font-size: 12px;">{{ $formApmVehicleCarBodyHarian->hasil_mc1 == 'nok' ? '✔' : '' }}</span>
                                </td>
                                <td style="text-align:center"><span
                                        style="font-family: DejaVu Sans, sans-serif; font-size: 12px;;">{{ $formApmVehicleCarBodyHarian->hasil_mc2 == 'ok' ? '✔' : '' }}</span>
                                </td>
                                <td style="text-align:center"><span
                                        style="font-family: DejaVu Sans, sans-serif; font-size: 12px;">{{ $formApmVehicleCarBodyHarian->hasil_mc2 == 'nok' ? '✔' : '' }}</span>
                                </td>
                            </td>
                            <td style="width: 21%" rowspan>
                                <h3 style="font-size: 12px;  text-align:left; vertical-align:middle;">
                                    {{ $formApmVehicleCarBodyHarian->referensi }}</h3>
                            </td>
                        </tr>
                    @endforeach
                    <tr>
                    ...
                    <tr>
                        <td colspan="7" height="60" style="text-align: left; vertical-align:baseline ">CATATAN : {!! $formApmVehicleCarBodyHarians[0]->catatan !!}</td>
                    </tr>
                </table>
            </div>
        </div>
