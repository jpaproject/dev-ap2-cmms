...
<body>
    <div class="content">
        <div class="header">
            <div class="title">
                <table style="padding:20px 20px 0px 20px;" class="title-table">
                    ...
                    <tr style="background-color: white;">
                        <td>Standby Perkins 2000Kva No 1</td>
                    </tr>
                </table>
                {{-- <img style="width: 120px; text-align:left; display:inline; margin-right:30px"
                    src="{{ public_path('img/AP2.png') }}" alt="">
                <h1 style="font-size: 18px; display:inline; margin-right:165px; ">Data teknis perawatan 2 Mingguan</h1>
                <h1 style="font-size: 18px; text-align:center">Standby Perkins 2000Kva No 1
                </h1> --}}
            </div>
        </div>
        <div class="body">
            <div class="table">
                <table>
                    <tr>
                        ...
                        <th style="width: 20%" class="center" colspan="2">GS1</th>
                        <th style="width: 15%" class="center">SATUAN</th>
                        <th style="width: 35%" class="center">KETERANGAN</th>
                    </tr>
                    @foreach ($formPs1GensetStandbyNo1DuaMingguans as $key => $control)
                        <tr>
                            <td>{{ $duaMingguans[$key] ?? '' }}</td>
        ...
        <div class="catatan" width="100">
            ...
            {!! nl2br($formPs1GensetStandbyNo1DuaMingguans[0]->catatan ?? '') !!}
        </div>
        {{-- <div class="ttd-left">
