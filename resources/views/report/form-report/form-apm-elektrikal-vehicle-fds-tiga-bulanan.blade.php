        ...
        <div class="body">
            <div class="table">
                <table class="my-table">
                    <tr>
                        ...
                        <td rowspan="4" style="width: 25%;text-align:center">
                            <h3>Lembar Pemeriksaan 3 Bulanan Fire Detection System</h3>
                        </td>
                    ...
                    <tr>
                        ...
                        <td style="width: 30%; font-size: 7px;text-align:left">
                            {{ $formApmElektrikalVehicleInteriorFDSTigaBulanans[0]['created_at']->format('d-m-Y') }}
                ...
                @php
                    $numberalpa = 0;
                @endphp
                @foreach ($formApmElektrikalVehicleInteriorFDSTigaBulanans as $key=>
                            $formApmElektrikalVehicleInteriorFDSTigaBulanan)
                            @if (
                                $key == 0 ||
                                    $formApmElektrikalVehicleInteriorFDSTigaBulanan->pemeriksaan_fds_group !=
                                        $formApmElektrikalVehicleInteriorFDSTigaBulanans[$key - 1]->pemeriksaan_fds_group)
                                @php
                                    $number = 1;
                                @endphp
                    ...
                    @if ($key == 3 || $key == 11)
                        <tr>
                            <th rowspan="5" style="width: 5%">{{ $number }} </th>
                            <th rowspan="2" style="text-align: left; widith:55%">
                                <h2>{{ 'Kondisi kebersihan sensor Fire Detection' }}
                                </h2>
                            </th>
                            <th colspan="2" ">HASIL</th>
                                    <td rowspan="2"></td>
                                ...
                                <tr>
                                    <td><h2 style="text-align: left">{{ $formApmElektrikalVehicleInteriorFDSTigaBulanan->pemeriksaan_fds }}
                                        </h2></td>
                                    <td style=" font-size: 7px;text-align:center"><span
                                            style="font-family: DejaVu Sans, sans-serif; font-size: 12px;">{{ $formApmElektrikalVehicleInteriorFDSTigaBulanan->hasil_mc1 == 'ok' ? '✔' : '' }}</span>
                                    </td>
                                    <td style=" font-size: 7px;text-align:center"><span
                                            style="font-family: DejaVu Sans, sans-serif; font-size: 12px;">{{ $formApmElektrikalVehicleInteriorFDSTigaBulanan->hasil_mc1 == 'nok' ? '✔' : '' }}</span>
                                    </td>
                                    
                                    <td rowspan="3" style="width: 21%">
                                        <h3 style="font-size: 12px;  text-align:left; vertical-align:middle;">
                                            {{ $formApmElektrikalVehicleInteriorFDSTigaBulanan->referensi }}</h3>
                                    </td>
                                </tr>
@elseif($key == 4 || $key == 12)
<tr>
                            ...
                            <th colspan="2" ">NILAI</th>
                                ...
                                <tr>
                                    ...
                                    <td colspan="2" style=" font-size: 7px;text-align:center"><span
                                            style="font-family: DejaVu Sans, sans-serif; font-size: 12px;">{{ $formApmElektrikalVehicleInteriorFDSTigaBulanan->hasil_mc1  }}</span>
                                    </td>
                                    <td style="width: 21%">
                                        <h3 style="font-size: 12px;  text-align:left; vertical-align:middle;">
                                            {{ $formApmElektrikalVehicleInteriorFDSTigaBulanan->referensi }}</h3>
...
<tr>
                                    ...
                                    <th style="text-align: left; widith:55%">
                                        <h2>{{ $formApmElektrikalVehicleInteriorFDSTigaBulanan->pemeriksaan_fds }}
                                        </h2>
...
@endif
                    ...
                    <tr>
                        <td colspan="5" style="text-align: left">Catatan : {!! $formApmElektrikalVehicleInteriorFDSTigaBulanans[0]->catatan !!}</td>
                    </tr>
