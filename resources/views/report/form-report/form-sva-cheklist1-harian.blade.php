                    ...
                    {{-- <div class="table"> --}}
                        <table>
                            ...
                            <tr style=" background-color: white; width:30%;">
                                ...
                                <td>{{ $formSvaChecklist1Harians[0]->tanggal }}</td>
                            </tr>
                            <tr style=" background-color: white;">
                                <td>Jam (Pagi):</td>
                                <td>{{ $formSvaChecklist1Harians[0]->jam_pagi }}</td>
                            </tr>
                            <tr style=" background-color: white;">
                                <td>R/W IN USE (PAGI):</td>
                                <td>{{ $formSvaChecklist1Harians[0]->rw_in_use_pagi }}</td>
                            </tr>
                            <tr style=" background-color: white;">
                                <td>Jam (Sore):</td>
                                <td>{{ $formSvaChecklist1Harians[0]->jam_sore }}</td>
                            </tr>
                            <tr style=" background-color: white;">
                                <td>R/W IN USE (SORE):</td>
                                <td>{{ $formSvaChecklist1Harians[0]->rw_in_use_sore }}</td>
                            </tr>
                        </table>
                    {{-- </div> --}}
                </td>
        ...
        <div class="body">
            <div class="table">
                <table style="text-align:center" class="table-data">
                    <tr>
                        <th colspan="6" class="center" style="font-size:15px; background-color: grey; font-weight:bold">R C M S</th>
                    </tr>
                    <tr>
                    ...
                    @foreach ( $formSvaChecklist1Harians as $key => $item )
                        <tr>
                            <td>{{$loop->iteration}}</td>
                            <td>{{ $item->peralatan ?? '' }}</td>
                            <td class="center">
                                <span style="font-family: DejaVu Sans, sans-serif; font-size: 10px">{{$item->hasil_pagi == 'OFF' ? '' : $item->hasil_pagi}}</span>
                            </td>
                            <td class="center">
                                <span style="font-family: DejaVu Sans, sans-serif; font-size: 10px"> {{$item->hasil_pagi !== 'OFF' ? '' : $item->hasil_pagi}} </span>
                            </td>
                            ...
                            <td class="center">
                                <span style="font-family: DejaVu Sans, sans-serif; font-size: 10px">{{$item->hasil_sore == 'OFF' ? '' : $item->hasil_sore}}</span>
                            </td>
                            <td class="center">
                                <span style="font-family: DejaVu Sans, sans-serif; font-size: 10px"> {{$item->hasil_sore !== 'OFF' ? '' : $item->hasil_sore}} </span>
                            </td>
                ...
                <table class="table-data">
                    ...
                    <tr>
                        ...
                        {{ $formSvaChecklist1Harians[0]->oleh }}
                        </td>
