    ...
    <div class="content">
        <div class="header">
            <div class="title">
                ...
                <h1 style="font-size: 18px; text-align:center">POWER STATION 3 - EPCC SIMULATOR</h1>
            </div>
        </div>
        <div class="body">
            <div class="table">
                <table style="table-layout: fixed;">
                    ...
                    <tr>
                        <td style="background-color: white">
                            <span class="float-left">TEGANGAN INPUT EPCC </span><span class="float-right">: {{ $formPs3EpccSimulatorEnamBulananTahunan->tegangan_input_epcc }} VDC</span>
                            <div style="clear: both"></div>
                            <br>
                            <p style="margin-left: 20px; text-align:left; font-size:12px ">{{ $formPs3EpccSimulatorEnamBulananTahunan->catatan }}</p>
                        </td>
                    </tr>
                </table>
            </div>
