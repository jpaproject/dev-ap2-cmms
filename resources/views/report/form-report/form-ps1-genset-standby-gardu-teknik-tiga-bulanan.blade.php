    ...
    <div class="content">
                ...
                <table style="padding:20px 20px 0px 20px;" class="title-table">
                    <tr style="background-color: white;">
                        ...
                        <td style=" width: 60%; text-align:center;">
                            GENSET STANDBY GARDU TEKNIK 3 BULANAN
                        </td>
                    </tr>
                </table>
        ...
        <div class="body">
                ...
                <table style="table-layout: fixed;">
                    ...
                    @foreach ($gensetStandbyGarduTeknikTigaBulanans as $gensetStandbyGarduTeknikTigaBulanan)
                        <tr>
                            ...
                            <td>{{ $gensetStandbyGarduTeknikTigaBulanan->data_teknis ?? '' }}</td>
                            <td>{{ $gensetStandbyGarduTeknikTigaBulanan->satuan ?? '' }}</td>
                            <td>{{ $gensetStandbyGarduTeknikTigaBulanan->keterangan ?? '' }}</td>
                        </tr>
                    @endforeach
                </table>
            </div>
            <div class="catatan" width="100">
                ...
                {!! nl2br($gensetStandbyGarduTeknikTigaBulanans[0]->catatan) !!}
            </div>
            {{-- <div class="ttd-left">
