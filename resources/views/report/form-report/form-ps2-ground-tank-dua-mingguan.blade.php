    ...
    <div class="content page-break">
        <div class="header">
            <div class="title">
                ...
                <h1 style="font-size: 18px; display:inline; margin-right:100px; ">DATA PARAMETER 2 MINGGUAN GROUND TANK
                </h1>
            </div>
        </div>
        <div class="body">
            ...
            <div class="table">
                <table class="my-table">
                    <tr>
                        ...
                        <th style="width: 15%">VOLUME SEBULAN</th>
                        <th style="width: 15%">VOLUME SESUDAH</th>
                        <th style="width: 15%">KETERANGAN</th>
                    </tr>
                    <tr class="row-title">
                        <td colspan="6">PANEL MAIN TANK</td>
                    </tr>
                    @for ($i = 0; $i < 3; $i++)
                        <tr class="row-white">
                            <td>1.{{ $i + 1 }}</td>
                            <td>{{ $formPs2GroundTankDuaMingguans[$i]->nama_peralatan }}</td>
                            <td>{{ $formPs2GroundTankDuaMingguans[$i]->q1 }}</td>
                            <td>{{ $formPs2GroundTankDuaMingguans[$i]->q2 }}</td>
                            <td>{{ $formPs2GroundTankDuaMingguans[$i]->q3 }}</td>
                            <td>{{ $formPs2GroundTankDuaMingguans[$i]->q4 }}</td>
                        </tr>
                    @endfor
                    <tr class="row-title">
                        <td colspan="6">PANEL FCP 2</td>
                    </tr>
                    @for ($i = 3; $i < 13; $i++)
                        @php
                            $number = 0;
