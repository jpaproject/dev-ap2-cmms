                    ...
                    {{-- <div class="table"> --}}
                        <table>
                            ...
                            <tr style=" background-color: white;">
                                ...
                                <td>: {{ $formSvaChecklist2Harians[0]->tanggal }}</td>
                            </tr>
                            <tr style=" background-color: white;">
                                <td>Jam</td>
                                <td>: {{ $formSvaChecklist2Harians[0]->jam }}</td>
                            </tr>
                            <tr style=" background-color: white;">
                                <td>R/W IN USE</td>
                                <td>: {{ $formSvaChecklist2Harians[0]->qfu }}</td>
                            </tr>
                        </table>
                    {{-- </div> --}}
                </td>
        ...
        <div class="body">
            <div class="table">
                <table style="text-align:center" class="table-data">
                    <tr>
                        <th colspan="5" class="center" style="font-size:15px; background-color: grey; font-weight:bold">RUNWAY SELATAN</th>
                    </tr>
                    <tr>
                    ...
                    @foreach ( $formSvaChecklist2Harians as $key => $item )
                        <tr>
                            ...
                            <td class="center">
                                <span style="font-family: DejaVu Sans, sans-serif; font-size: 15px"> @if($item->hasil == "ON")  ✔ @else  @endif </span>
                            </td>
                            <td class="center">
                                <span style="font-family: DejaVu Sans, sans-serif; font-size: 15px"> @if($item->hasil == "OFF")  ✔ @else  @endif </span>
                            </td>
                            <td >
                                {{$item->keterangan}}
                            </td>
