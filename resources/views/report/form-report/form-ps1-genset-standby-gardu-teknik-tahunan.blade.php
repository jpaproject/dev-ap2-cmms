                ...
                <table style="padding:20px 20px 0px 20px;" class="title-table">
                    <tr style="background-color: white;">
                        ...
                        <td style=" width: 60%; text-align:center;">
                            GENSET STANDBY GARDU TEKNIK TAHUNAN
                        </td>
                    </tr>
                </table>
                {{-- <img style="width: 120px; text-align:left; display:inline; margin-right:60px"
                    src="{{ public_path('img/AP2.png') }}" alt="">
                <h1 style="font-size: 18px; display:inline; margin-right:150px; ">GENSET STANDBY GARDU TEKNIK TAHUNAN
                </h1> --}}
            </div>
        </div>
        <div class="body">
                ...
                <table style="table-layout: fixed;">
                    ...
                    @foreach ($gensetStandbyGarduTeknikTahunans as $gensetStandbyGarduTeknikTahunan)
                        <tr>
                            ...
                            <td>{{ $gensetStandbyGarduTeknikTahunan->data_teknis ?? '' }}</td>
                            <td>{{ $gensetStandbyGarduTeknikTahunan->satuan ?? '' }}</td>
                            <td>{{ $gensetStandbyGarduTeknikTahunan->keterangan ?? '' }}</td>
                        </tr>
                    @endforeach
                </table>
            </div>
            ...
            <div class="catatan" width="100">
                ...
                {!! nl2br($gensetStandbyGarduTeknikTahunans[0]->catatan) !!}
            </div>
            {{-- <div class="ttd-left">
