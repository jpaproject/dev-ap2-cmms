    ...
    <div class="content">
        <div class="body">
            <div class="table">
                <table class="my-table">
                    <tr>
                        ...
                        <td rowspan="4" style="width: 25%;text-align:center">
                            <h3>Lembar Pemeriksaan 3 Bulanan Electric Horn</h3>
                        </td>
                    ...
                    <tr>
                        ...
                        <td style="width: 30%; font-size: 7px;text-align:left">
                            {{ $formApmElektrikalVehicleExteriorEHTigaBulanans[0]['created_at']->format('d-m-Y') }}
                ...
                <table class="my-table">
                    <tr>
                        <th colspan="2" rowspan="3" style="width:55%">PEMERIKSAAN </th>
                        <th colspan="4" ">HASIL</th>
                        <th rowspan="3" style="width: 20%;">REFERENSI</th>
                    </tr>
                    <tr>
                        <th style="width: 30px" colspan="2">HORN (R)</th>
                        <th style="width: 30px" colspan="2">HORN (L)</th>
                    </tr>
                    <tr>
                ...
                @php
                    $numberalpa = 0;
                @endphp
                @foreach ($formApmElektrikalVehicleExteriorEHTigaBulanans as
                            $key=> $formApmElektrikalVehicleExteriorEHTigaBulanan)
                            @if ($key == 0)
                                @php
                                    $number = 1;
                                @endphp
                    <tr style="background-color:#999696;">
                        ...
                        <td colspan="6" style="text-align: left;width: 55%">
                            {{ $formApmElektrikalVehicleExteriorEHTigaBulanan->pemeriksaan_eh_group }}
                        </td>
                    </tr>
                    @php
                        $numberalpa++;
                ...
                @php
                    ...
                    @endphp
                    @endif
                    @if ($formApmElektrikalVehicleExteriorEHTigaBulanan->pemeriksaan_eh == 'Lakukan pengukuran tegangan input')
                        <tr>
                        <th rowspan="3" style="width: 5%">{{ $number  }} </th>
                        <th rowspan="3" style="text-align: left; widith:55%">
                            <h2>{{ $formApmElektrikalVehicleExteriorEHTigaBulanan->pemeriksaan_eh }}
                            </h2>
                            </th>
                        <th colspan="4" ">NILAI</th>
                        <td rowspan="3" style="width: 21%">
                            <h3 style="font-size: 12px;  text-align:left; vertical-align:middle;">
                                {{ $formApmElektrikalVehicleExteriorEHTigaBulanan->referensi }}</h3>
                        </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        <td colspan="2" style=" font-size: 7px;text-align:center"><span
                                style="font-family: DejaVu Sans, sans-serif; font-size: 12px;">{{ $formApmElektrikalVehicleExteriorEHTigaBulanan->hasil_mc1 }}</span>
                        </td>
                        
                        <td colspan="2" style=" font-size: 7px;text-align:center"><span
                                style="font-family: DejaVu Sans, sans-serif; font-size: 12px;">{{ $formApmElektrikalVehicleExteriorEHTigaBulanan->hasil_mc2 }}</span>
                        </td>
                    ...
                    <tr>
                        ...
                        <td style=" font-size: 7px;text-align:center"><span
                                style="font-family: DejaVu Sans, sans-serif; font-size: 12px;">{{ $formApmElektrikalVehicleExteriorEHTigaBulanan->hasil_mc1 == 'ok' ? '✔' : '' }}</span>
                        </td>
                        <td style=" font-size: 7px;text-align:center"><span
                                style="font-family: DejaVu Sans, sans-serif; font-size: 12px;">{{ $formApmElektrikalVehicleExteriorEHTigaBulanan->hasil_mc1 == 'nok' ? '✔' : '' }}</span>
                        </td>
                        <td style=" font-size: 7px;text-align:center"><span
                                style="font-family: DejaVu Sans, sans-serif; font-size: 12px;">{{ $formApmElektrikalVehicleExteriorEHTigaBulanan->hasil_mc2 == 'ok' ? '✔' : '' }}</span>
                        </td>
                        <td style=" font-size: 7px;text-align:center"><span
                                style="font-family: DejaVu Sans, sans-serif; font-size: 12px;">{{ $formApmElektrikalVehicleExteriorEHTigaBulanan->hasil_mc2 == 'nok' ? '✔' : '' }}</span>
                        </td>
                        <td style="width: 21%">
                            <h3 style="font-size: 12px;  text-align:left; vertical-align:middle;">
                                {{ $formApmElektrikalVehicleExteriorEHTigaBulanan->referensi }}</h3>
                    ...
                    <tr>
                        <td colspan="7" style="text-align: left">Catatan : {!! $formApmElektrikalVehicleExteriorEHTigaBulanans[0]->catatan !!}</td>
                    </tr>
