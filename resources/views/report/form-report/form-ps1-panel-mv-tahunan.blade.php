...
<body>
    <div class="content">
            ...
            <div class="table">
                <table style="table-layout: fixed;">
                    ...
                    @foreach ($formPs1PanelMvTahunans as $key => $formPs1PanelMvTahunan)
                        @if ($key < 3)
                            <tr>
                                <td style="text-align: left">{{ $formPs1PanelMvTahunan->data_teknis ?? '' }}</td>
                                <td>{{ $formPs1PanelMvTahunan->r ?? '' }}</td>
                                <td>{{ $formPs1PanelMvTahunan->s ?? '' }}</td>
                                <td>{{ $formPs1PanelMvTahunan->t ?? '' }}</td>
                                <td>{{ $formPs1PanelMvTahunan->satuan ?? '' }}</td>
                                <td>{{ $formPs1PanelMvTahunan->keterangan ?? '' }}</td>
                            </tr>
                        @endif
                        @if ($key > 2)
                            <tr>
                                <td style="text-align: left">{{ $formPs1PanelMvTahunan->data_teknis ?? '' }}</td>
                                <td colspan="3">{{ $formPs1PanelMvTahunan->q1 ?? '' }}</td>
                                <td>{{ $formPs1PanelMvTahunan->satuan ?? '' }}</td>
                                <td>{{ $formPs1PanelMvTahunan->keterangan ?? '' }}</td>
                            </tr>
                        @endif
        ...
        <div class="catatan" width="100">
            ...
            {!! nl2br($formPs1PanelMvTahunans[0]->catatan) !!}
        </div>
        {{-- <div class="ttd-left">
