        ...
        <table style="margin-top:50px; padding:20px; border: none;">
            <tr style=" background-color: white;">
                ...
                <td style="border: none; width: 50%;">
                    ...
                    <br>
                    <h1 class="center" style="color:cornflowerblue; text-decoration:underline;">PEMELIHARAAN TAHUNAN GIS 150 KV</h1>
                </td>
            ...
            <div class="table">
                <table class="table-data">
                                        ...
                                        <table style="border: none;">
                                            <tr style="border: none;">
                                                ...
                                                <td style="border: none; border-bottom:1px solid black; width: 50%;">
                                                    {{$formHmvGisTahunans[0]->equipment_number}}
                                                </td>
                                            </tr>
                                            <tr style="border: none;">
                                                <td style="border: none;">LOCATION/STATION</td>
                                                <td style="border: none; border-bottom:1px solid black; width: 50%;">
                                                    {{$formHmvGisTahunans[0]->location_station}}
                                                </td>
                                            </tr>
                                            <tr style="border: none;">
                                            ...
                                            <tr style="border: none;">
                                                ...
                                                <td style="border: none; border-bottom:1px solid black; width: 50%;">
                                                    {{$formHmvGisTahunans[0]->reference_drawing}}
                                                </td>
                                            </tr>
                                        ...
                                        <table style="border: none;">
                                            <tr style="border: none;">
                                                ...
                                                <td style="border: none; border-bottom:1px solid black; width:70%;">
                                                    {{$formHmvGisTahunans[0]->inspection_date}}
                                                </td>
                                            </tr>
                                            <tr style="border: none;">
                                                <td style="border: none;">SERIAL NUMBER</td>
                                                <td style="border: none; border-bottom:1px solid black; width:70%;">
                                                    {{$formHmvGisTahunans[0]->serial_number}}
                                                </td>
                                            </tr>
                                            ...
                                            <tr style="border: none;">
                                                ...
                                                <td style="border: none; border-bottom:1px solid black; width:70%;">
                                                    {{$formHmvGisTahunans[0]->brand_merk}}
                                                </td>
                                            </tr>
                                            ...
                                            <tr style="border: none;">
                                                ...
                                                <td style="border: none; border-bottom:1px solid black; width:70%;">
                                                    {{$formHmvGisTahunans[0]->name_plate}}
                                                </td>
                                            </tr>
                                                    ...
                                                    <table>
                                                        <tr>
                                                            <td style="border: 1px solid black;">
                                                                <span style="font-family: DejaVu Sans, sans-serif; font-size: 10px;">{{ $formHmvGisTahunans[0]->status == 'OPS' ? '✔' : '' }}</span>
                                                            </td>
                                                            <td style="border:none;">OPS</td>
                                                            <td style="border: 1px solid black;">
                                                                <span style="font-family: DejaVu Sans, sans-serif; font-size: 10px;">{{ $formHmvGisTahunans[0]->status == 'STBY' ? '✔' : '' }}</span>
                                                            </td>
                                                            <td style="border:none;">STBY</td>
                                                            <td style="border: 1px solid black;">
                                                                <span style="font-family: DejaVu Sans, sans-serif; font-size: 10px;">{{ $formHmvGisTahunans[0]->status == 'REPAIR' ? '✔' : '' }}</span>
                                                            </td>
                    ...
                    <tr>
                            ...
                            <table>
                                ...
                                <tr>
                                    <td style="border: 1px solid black; width:40px;">
                                        {{ $formHmvGisTahunans[0]->awal }}
                                    </td>
                                    <td style="border:none;">&deg;C</td>
                                    <td style="border: 1px solid black; width:40px;">45.6</td>
                                    <td style="border:none;">&deg;C (2)</td>
                                </tr>
                            </table>
                        </td>
                        <td style="width: 24%;" class="table-data">
                        ...
                        <td style="width: 24%; border: none;" class="table-data"> <table> <tr><td style="border:none; border-bottom:1px solid black;">{{$formHmvGisTahunans[0]->remarks}}</td></tr></table></td>
                    </tr>
                    <tr>
                        ...
                        <td style="width: 24%;" class="table-data">
                            <table>
                                <tr>
                                    <td style="border: 1px solid black; width:40px;">
                                        {{ $formHmvGisTahunans[1]->awal }}
                                    </td>
                                    <td style="border:none;">ppmv</td>
                                    <td style="border: 1px solid black; width:40px;">3960</td>
                                    <td style="border:none;">ppmv (1)</td>
                                </tr>
                            </table>
                        </td>
                        <td style="width: 24%;" class="table-data">
                        ...
                        <td style="width: 24%; border: none;" class="table-data"> <table> <tr><td style="border:none; border-bottom:1px solid black;">{{$formHmvGisTahunans[1]->remarks}}</td></tr></table></td>
                    </tr>
                    <tr>
                        ...
                        <td style="width: 24%;" class="table-data">
                            <table>
                                <tr>
                                    <td style="border: 1px solid black; width:40px;">
                                        {{ $formHmvGisTahunans[2]->awal }}
                                    </td>
                                    <td style="border:none;"></td>
                                    <td style="border: 1px solid black; width:40px;">118kV to be not more than 5 pC (3)</td>
                                    <td style="border:none;"></td>
                                </tr>
                            </table>
                        </td>
                        ...
                        <td style="width: 24%; border: none;" class="table-data"> <table> <tr><td style="border:none; border-bottom:1px solid black;">{{$formHmvGisTahunans[2]->remarks}}</td></tr></table></td>
                    </tr>
                    <tr>
                        <td colspan="5" style="height: 10px; border: 1px solid black;">
                            REMARKS: {{$formHmvGisTahunans[0]->catatan}}
                        </td>
                    </tr>
                    <tr>
                        <td colspan="5" style="height: 10px; border: 1px solid black;">
