    ...
    <div class="content">
        <div class="body">
            <div class="table">
                <table class="my-table">
                    ...
                    <tr>
                        ...
                        <td style="width: 30%; font-size: 7px;text-align:left">
                            {{ $formApmMekanikalVehicleAirBrakeSystemTigaBulanans[0]['created_at']->format('d-m-Y') }}
                ...
                <table class="my-table">
                    <tr>
                        <th colspan="2" rowspan="2" style="width: 55%">PEMERIKSAAN AIR BRAKE SYSTEM</th>
                    ...
                    @foreach ($formApmMekanikalVehicleAirBrakeSystemTigaBulanans as $key => $formApmMekanikalVehicleAirBrakeSystemTigaBulanan)
                        @if (
                            $key == 0 ||
                                $formApmMekanikalVehicleAirBrakeSystemTigaBulanan->pemeriksaan_air_brake_system_group !=
                                    $formApmMekanikalVehicleAirBrakeSystemTigaBulanans[$key - 1]->pemeriksaan_air_brake_system_group)
                            @php
                                $number = 1;
                            @endphp
                            @if (
                                ...
                                <tr style="background-color:#999696;">
                                    <td rowspan="2">{{ $alphabet[$numberalpa] }}</td>
                        ...
                        @if (
                            ...
                            <tr>
                                ...
                                <th style="text-align: left">
                                    <h2>{{ $formApmMekanikalVehicleAirBrakeSystemTigaBulanan->pemeriksaan_air_brake_system }}
                                    </h2>

                                </th>

                                <td colspan="2" style=" font-size: 7px;text-align:center"><span
                                        style="font-family: DejaVu Sans, sans-serif; font-size: 12px;widith:50%;">{{ $formApmMekanikalVehicleAirBrakeSystemTigaBulanan->hasil_mc2 == 'ok' ? '✔' : '' }}</span>
                                </td>
                                <td colspan="2" style=" font-size: 7px;text-align:center"><span
                                        style="font-family: DejaVu Sans, sans-serif; font-size: 12px;widith:50%">{{ $formApmMekanikalVehicleAirBrakeSystemTigaBulanan->hasil_mc2 == 'nok' ? '✔' : '' }}</span>
                                </td>
                                <td style="width: 21%">
                                    <h3 style="font-size: 12px;  text-align:left; vertical-align:middle;">
                                        {{ $formApmMekanikalVehicleAirBrakeSystemTigaBulanan->referensi }}</h3>
                                </td>
                            </tr>
                        @else
                            <tr>
                                ...
                                <td style=" font-size: 7px;text-align:center"><span
                                        style="font-family: DejaVu Sans, sans-serif; font-size: 12px;widith:50%;">{{ $formApmMekanikalVehicleAirBrakeSystemTigaBulanan->hasil_mc1 == 'ok' ? '✔' : '' }}</span>
                                </td>
                                <td style=" font-size: 7px;text-align:center"><span
                                        style="font-family: DejaVu Sans, sans-serif; font-size: 12px;widith:50%">{{ $formApmMekanikalVehicleAirBrakeSystemTigaBulanan->hasil_mc1 == 'nok' ? '✔' : '' }}</span>
                                </td>
                                <td style=" font-size: 7px;text-align:center"><span
                                        style="font-family: DejaVu Sans, sans-serif; font-size: 12px;widith:50%;">{{ $formApmMekanikalVehicleAirBrakeSystemTigaBulanan->hasil_mc2 == 'ok' ? '✔' : '' }}</span>
                                </td>
                    ...
                    <tr>
                        <td colspan="7" style="text-align: left">Catatan : {!! $formApmMekanikalVehicleAirBrakeSystemTigaBulanans[33]->catatan !!}</td>
                    </tr>
