        ...
        <div class="body">
            <div class="table">
                <table class="my-table">
                    <tr>
                        ...
                        <td rowspan="4" style="width: 25%;text-align:center">
                            <h3>Lembar Pemeriksaan 3 Bulanan Brake HJB</h3>
                        </td>
                    ...
                    <tr>
                        ...
                        <td style="width: 30%; font-size: 7px;text-align:left">
                            {{ $formApmElektrikalVehicleExteriorHJBTigaBulanans[0]['created_at']->format('d-m-Y') }}
                ...
                <table class="my-table">
                    ...
                    <tr>
                        <th style="width: 30px" colspan="2">HJB MC 1</th>
                        <th style="width: 30px" colspan="2">HJB MC 2</th>
                    </tr>
                    <tr>
                ...
                @php
                    $numberalpa =0;
                @endphp
                @foreach ($formApmElektrikalVehicleExteriorHJBTigaBulanans as $key => $formApmElektrikalVehicleExteriorHJBTigaBulanan) 
                    @if ($key == 0 || $formApmElektrikalVehicleExteriorHJBTigaBulanan->pemeriksaan_hjb_group != $formApmElektrikalVehicleExteriorHJBTigaBulanans[$key - 1]->pemeriksaan_hjb_group)
                        @php
                            $number = 1;
                        @endphp    
                        <tr style="background-color:#999696;">
                                ...
                                <td colspan="6" style="text-align: left;width: 55%">
                                    {{ $formApmElektrikalVehicleExteriorHJBTigaBulanan->pemeriksaan_hjb_group }}
                                </td>
                            </tr>
                            @php
                                $numberalpa++;
                        ...
                        @endif
                                ...
                                <tr>
                                    ...
                                    <th style="text-align: left; widith:55%">
                                        <h2>{{ $formApmElektrikalVehicleExteriorHJBTigaBulanan->pemeriksaan_hjb }}
                                        </h2>

                                    </th>

                                    <td style=" font-size: 7px;text-align:center"><span
                                            style="font-family: DejaVu Sans, sans-serif; font-size: 12px;">{{ $formApmElektrikalVehicleExteriorHJBTigaBulanan->hasil_mc1 == 'ok' ? '✔' : '' }}</span>
                                    </td>
                                    <td style=" font-size: 7px;text-align:center"><span
                                            style="font-family: DejaVu Sans, sans-serif; font-size: 12px;">{{ $formApmElektrikalVehicleExteriorHJBTigaBulanan->hasil_mc1 == 'nok' ? '✔' : '' }}</span>
                                    </td>
                                    <td style=" font-size: 7px;text-align:center"><span
                                            style="font-family: DejaVu Sans, sans-serif; font-size: 12px;">{{ $formApmElektrikalVehicleExteriorHJBTigaBulanan->hasil_mc2 == 'ok' ? '✔' : '' }}</span>
                                    </td>
                                    <td style=" font-size: 7px;text-align:center"><span
                                            style="font-family: DejaVu Sans, sans-serif; font-size: 12px;">{{ $formApmElektrikalVehicleExteriorHJBTigaBulanan->hasil_mc2 == 'nok' ? '✔' : '' }}</span>
                                    </td>
                                    <td style="width: 21%">
                                        <h3 style="font-size: 12px;  text-align:left; vertical-align:middle;">
                                            {{ $formApmElektrikalVehicleExteriorHJBTigaBulanan->referensi }}</h3>
                                    </td>
                                </tr>
                                @php
                                    $number++;
                ...
                @endforeach
                    ...
                    <tr>
                        <td colspan="7" style="text-align: left">Catatan : {!! $formApmElektrikalVehicleExteriorHJBTigaBulanans[0]->catatan !!}</td>
                    </tr>
