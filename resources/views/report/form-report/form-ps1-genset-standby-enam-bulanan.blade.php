...
<body>
    <div class="content">
        <div class="header">
            <div class="title">
                ...
                {{-- <img style="width: 120px; text-align:left; display:inline; margin-right:30px"
                    src="{{ public_path('img/AP2.png') }}" alt="">
                <h1 style="font-size: 18px; display:inline; margin-right:165px; ">Data teknis perawatan 6 Bulanan</h1>
        ...
        <div class="body">
            <div class="table">
                <table style="table-layout: fixed;">
                    ...
                    @foreach ($formPs1GensetStandbyEnamBulanans as $key => $control)
                        <tr>
                            <td>{{ $enamBulanans[$key]['dataTeknis'] ?? '' }}</td>
        ...
        <div class="catatan" width="100">
            ...
            {!! nl2br($formPs1GensetStandbyEnamBulanans[0]->catatan ?? '') !!}
        </div>
        {{-- <div class="ttd-left">
