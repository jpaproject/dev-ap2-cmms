        ...
        <div class="body">
            <div class="table">
                <table class="my-table">
                    <tr>
                        ...
                        <td rowspan="4" style="width: 25%;text-align:center">
                            <h3>Lembar Pemeriksaan 3 Bulanan Led Passanger Light</h3>
                        </td>
                    ...
                    <tr>
                        ...
                        <td style="width: 30%; font-size: 7px;text-align:left">
                            {{ $formApmElektrikalVehicleInteriorLPLTigaBulanans[0]['created_at']->format('d-m-Y') }}
                ...
                @foreach ($formApmElektrikalVehicleInteriorLPLTigaBulanans as $key => $formApmElektrikalVehicleInteriorLPLTigaBulanan) 
                    @if ($key == 0 || $formApmElektrikalVehicleInteriorLPLTigaBulanan->pemeriksaan_led_group != $formApmElektrikalVehicleInteriorLPLTigaBulanans[$key - 1]->pemeriksaan_led_group)
                        @php
                            $number = 1;
                        @endphp    
                        <tr style="background-color:#999696;">
                                ...
                                <td colspan="4" style="text-align: left;width: 55%">
                                    {{ $formApmElektrikalVehicleInteriorLPLTigaBulanan->pemeriksaan_led_group }}
                                </td>
                            </tr>
                            @php
                                $numberalpa++;
                        ...
                        @endif
                                ...
                                <tr>
                                    ...
                                    <th style="text-align: left; widith:55%">
                                        <h2>{{ $formApmElektrikalVehicleInteriorLPLTigaBulanan->pemeriksaan_led }}
                                        </h2>

                                    </th>

                                    <td style=" font-size: 7px;text-align:center"><span
                                            style="font-family: DejaVu Sans, sans-serif; font-size: 12px;">{{ $formApmElektrikalVehicleInteriorLPLTigaBulanan->hasil_mc1 == 'ok' ? '✔' : '' }}</span>
                                    </td>
                                    <td style=" font-size: 7px;text-align:center"><span
                                            style="font-family: DejaVu Sans, sans-serif; font-size: 12px;">{{ $formApmElektrikalVehicleInteriorLPLTigaBulanan->hasil_mc1 == 'nok' ? '✔' : '' }}</span>
                                    </td>
                                    
                                    <td style="width: 21%">
                                        <h3 style="font-size: 12px;  text-align:left; vertical-align:middle;">
                                            {{ $formApmElektrikalVehicleInteriorLPLTigaBulanan->referensi }}</h3>
                                    </td>
                                </tr>
                                @php
                                    $number++;
                ...
                @endforeach
                    ...
                    <tr>
                        <td colspan="5" style="text-align: left">Catatan : {!! $formApmElektrikalVehicleInteriorLPLTigaBulanans[0]->catatan !!}</td>
                    </tr>
