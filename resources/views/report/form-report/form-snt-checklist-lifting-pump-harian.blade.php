            ...
            <div class="table">
                <table>
                    ...
                    <tr class="header-table">
                        ...
                        <th colspan="5" style="background-color: white;" class="center">
                            LOKASI
                        </th>
                    ...
                    <tr class="header-table">
                        ...
                        <th colspan="5" rowspan="2" style="background-color: white;" class="center">
                    ...
                    @foreach ($formSntChecklistLiftingPumpHarians as $key => $formSntChecklistLiftingPumpHarian)
                        <tr class="my-table">
                            ...
                            <td style="text-align: left">{{ $formSntChecklistLiftingPumpHarian->nama_peralatan }}</td>
                            @if ($key == 0 || $key == 3 || $key == 6 || $key == 9 || $key == 12 || $key == 15 || $key == 18 || $key == 21 || $key == 24 || $key == 27)
                                <td style="text-align: center;background-color:#dddddd" rowspan="3">{{ $formSntChecklistLiftingPumpHarian->lokasi }}</td>
                            @endif
                            
                            <td style="text-align: left">{{ $formSntChecklistLiftingPumpHarian->merk }}</td>
                            <td style="text-align: left">{{ $formSntChecklistLiftingPumpHarian->tipe }}</td>
                            <td style="text-align:center; padding: 5px;"><span
                                    style="font-family: DejaVu Sans, sans-serif; font-size: 10px">{{ $formSntChecklistLiftingPumpHarian->kondisi == 'OPERASI' ? '✔' : '' }}</span>
                            </td>
                            <td style="text-align:center; padding: 5px;"><span
                                    style="font-family: DejaVu Sans, sans-serif; font-size: 10px">{{ $formSntChecklistLiftingPumpHarian->kondisi == 'OFF' ? '✔' : '' }}</span>
                            </td>
                            <td style="text-align: left">{{ $formSntChecklistLiftingPumpHarian->keterangan }}</td>
                        </tr>
                    @endforeach
                </table>
