                ...
                <table class="my-table">
                    ...
                    <tr class="row-white">
                        ...
                        <td colspan="2" style="width: 10%; text-align:center">
                            {{ $formPs3ControlRoomHarian->er2a_mca }}</td>
                        <td colspan="2" style="width: 10%; text-align:center">
                            {{ $formPs3ControlRoomHarian->er2a_mcb }}</td>
                        <td colspan="2" style="width: 10%; text-align:center">
                            {{ $formPs3ControlRoomHarian->er2b_mcd }}</td>
                        <td colspan="2" style="width: 10%; text-align:center">
                            {{ $formPs3ControlRoomHarian->er2b_mce }}</td>
                        <td style="text-align:center">
                            {{ $formPs3ControlRoomHarian->keterangan_pln_incoming }}</td>
                    </tr>
                    <tr class="row-title">
                        ...
                        <td class="bold" colspan="4" style="text-align:center">ER2A.MCG</td>
                        <td class="bold" style="text-align:center">KETERANGAN</td>
                    </tr>
                    <tr class="row-white">
                        <td style="width: 5%"></td>
                        ...
                        <td colspan="4" style="text-align:center">
                            {{ $formPs3ControlRoomHarian->er2a_mcf }}</td>
                        <td colspan="4" style="text-align:center">
                            {{ $formPs3ControlRoomHarian->er2a_mcg }}</td>
                        <td style="text-align:center">
                            {{ $formPs3ControlRoomHarian->keterangan_genset_incoming }}</td>
                    </tr>
                    <tr class="row-title">
                        ...
                        <td class="bold" style="text-align:center; width: 5%;">GS8</td>
                        <td class="bold" style="text-align:center">KETERANGAN</td>
                    </tr>
                    <tr class="row-white">
                        <td style="width: 5%"></td>
                        <td style="width: 30%;">DEIF Conctroller</td>
                        <td style="text-align:center">{{ $formPs3ControlRoomHarian->genset1 }}</td>
                        <td style="text-align:center">{{ $formPs3ControlRoomHarian->genset2 }}</td>
                        <td style="text-align:center">{{ $formPs3ControlRoomHarian->genset3 }}</td>
                        <td style="text-align:center">{{ $formPs3ControlRoomHarian->genset4 }}</td>
                        <td style="text-align:center">{{ $formPs3ControlRoomHarian->genset5 }}</td>
                        <td style="text-align:center">{{ $formPs3ControlRoomHarian->genset6 }}</td>
                        <td style="text-align:center">{{ $formPs3ControlRoomHarian->genset7 }}</td>
                        <td style="text-align:center">{{ $formPs3ControlRoomHarian->genset8 }}</td>
                        <td style="text-align:center">{{ $formPs3ControlRoomHarian->keterangan_hmi }}</td>
                    </tr>
                    <tr class="row-white">
                        <td style="width: 5%"></td>
                        ...
                        <td style="text-align:center; padding: 5px;"><span
                                style="font-family: DejaVu Sans, sans-serif; font-size: 20px">{{ $formPs3ControlRoomHarian->busbar_a == true ? '✔' : '' }}</span>
                        </td>
                        <td class="row-title" colspan="3" style="text-align:center">Busbar B</td>
                        <td style="text-align:center; padding: 5px;"><span
                                style="font-family: DejaVu Sans, sans-serif; font-size: 20px"">{{ $formPs3ControlRoomHarian->busbar_b == true ? '✔' : '' }}</span>
                        </td>
                    ...
                    <tr class="row-title">
                        ...
                        <td style="text-align:center; width: 6%;">GS8</td>
                    ...
                    @foreach ($gensetRoomLists as $key1 => $gensetRoomList)
                        <tr class="row-white">
                            ...
                            @foreach ($formPs3GensetRoomHarians as $key2 => $formPs3GensetRoomHarian)
                                @php
                                    $object = 'q' . strval($key1 + 1);
                                @endphp
                                <td style="text-align:center;">
                                    {{ $formPs3GensetRoomHarian->$object }}
                                </td>
                            @endforeach
                    ...
                    <tr class="row-white">
                        ...
                        <td colspan="8"><span style="margin-right: 19%;">GT 1:
                                {{ $formPs3GensetRoomHarians[0]->q16_gt1 }}</span><span style="margin-right: 19%;">GT
                                2: {{ $formPs3GensetRoomHarians[0]->q16_gt2 }}</span><span>GT 3:
                                {{ $formPs3GensetRoomHarians[0]->q16_gt3 }}</span></td>
                        <td>Liter</td>
                    </tr>
                    <tr class="row-white">
                        ...
                        <td colspan="7" style="text-align: center"><span
                                style="font-family: DejaVu Sans, sans-serif; font-size: 20px">{{ $formPs3GensetRoomHarians[0]->q17 ? '✔' : '' }}</span>
                        </td>
                        <td></td>
