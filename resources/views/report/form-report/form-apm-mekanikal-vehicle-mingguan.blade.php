            ...
            <div class="table">
                <table class="my-table">
                    <tr>
                        ...
                        <td rowspan="4" style="width: 25%;text-align:center">
                            <h3>Lembar Pemeriksaan Mingguan Mechanical
                                Vehicle</h3>
                        </td>
                        <th style=" font-size: 7px;text-align:left">Form No.</th>
                    ...
                    <tr>
                        ...
                        <td style="width: 30%; font-size: 7px;text-align:left">
                            {{ $formApmMekanikalVehicleMingguans[0]['created_at']->format('d-m-Y') }}
                ...
                <table class="my-table">
                    ...
                    <tr>
                        ...
                        <td style="width: 5%; font-size: 7px;">:</td>
                        <td style="width: 30%; font-size: 7px;">per 1 minggu</td>
                    </tr>
                    <tr>
                        <td colspan="9"></td>
                    </tr>
                ...
                <table class="my-table" style="border-top: 0pt; height:2.2%">
                    ...
                    <tr style="background-color:#999696;">
                        <th style="width: 5%;font-size: 12px" rowspan="2">A.</th>
                        <th style="width: 55%;" rowspan="2">
                            <h5 style="font-size: 10px vertical-align:middle; text-align:left">
                                {{ $formApmMekanikalVehicleMingguans[0]['pemeriksaan_mingguan_group'] }}</h5>
                        </th>

                        <th colspan="2" style="font-size: 12px">MC 1</th>
                        <th colspan="2" style="font-size: 12px">MC 2</th>

                        <th style=" width: 21%;" rowspan="2">
                            <h3 style=" font-size: 12px vertical-align:middle;"></h3>
                        </th>
                    </tr>
                    <tr style="background-color:#999696;">
                    ...
                    <tr>
                        <th style="width: 5%" rowspan="6">1. </th>
                        <th  style="text-align: left;" rowspan="2">
                            {{ $formApmMekanikalVehicleMingguans[0]['pemeriksaan_mingguan'] }} </th>
                        <th  colspan="2"style="font-size: 12px">MC 1</th>
                        <th  colspan="2"style="font-size: 12px">MC 2</th>
                        <th   style="text-align: left;" rowspan="2"></th>
                    </tr>
                    <tr>
                        <th colspan="2" style="font-size: 12px">Nilai</th>
                        <th colspan="2" style="font-size: 12px">Nilai</th>
                    </tr>
                        @php
                            $counter = 0;
                        @endphp
                        @foreach ($formApmMekanikalVehicleMingguans as $key => $formApmMekanikalVehicleMingguan)
                            @php
                                $counter++;
                            @endphp
                    <tr>
                        <th style="width: 55%">{{ $loop->iteration }}</th>
                        <td colspan="2" style=" font-size: 12px;text-align:center"><span
                                style="font-family: DejaVu Sans, sans-serif; font-size: 12px;widith:50%;">{{ $formApmMekanikalVehicleMingguan->hasil_mc1 }}</span>
                        
                        <td colspan="2" style=" font-size: 12px;text-align:center"><span
                                style="font-family: DejaVu Sans, sans-serif; font-size: 12px;widith:50%;">{{ $formApmMekanikalVehicleMingguan->hasil_mc2 }}</span>
                        </td>
                        
                        <td style="width: 21%" rowspan>
                            <h3 style="font-size: 12px;  text-align:left; vertical-align:middle;">
                                {{ $formApmMekanikalVehicleMingguan->referensi }}</h3>
                        </td>
                    </tr>
                    ...
                    <tr>
                        <td colspan="7" style="text-align: left">Catatan : {!! $formApmMekanikalVehicleMingguans[0]->catatan !!}</td>
                    </tr>
                </table>
            </div>
        </div>
