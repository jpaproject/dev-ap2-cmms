                    ...
                    {{-- <div class="table"> --}}
                        <table>
                            ...
                            <tr style=" background-color: white;">
                                ...
                                <td>: {{ $formEleChecklist2Harians[0]->tanggal }}</td>
                            </tr>
                            <tr style=" background-color: white;">
                                <td>Jam</td>
                                <td>: {{ $formEleChecklist2Harians[0]->jam }}</td>
                            </tr>
                        </table>
                    {{-- </div> --}}
                </td>
        ...
        <div class="body">
            <div class="table">
                <table style="text-align:center" class="table-data">
                    <tr>
                        <th colspan="5" class="center" style=" background-color: grey; font-weight:bold">SISI UTARA</th>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        <th class="center" style=" background-color: white;">BAIK</th>
                        <th class="center" style=" background-color: white;">RUSAK</th>
                    </tr>
                    @foreach ( $formEleChecklist2HarianUtaras as $key => $item )
                        <tr>
                            <td>{{$loop->iteration}}</td>
                            <td>{{ $item->pertanyaan ?? '' }}</td>
                            <td class="center">
                                <span style="font-family: DejaVu Sans, sans-serif; font-size: 15px"> @if($item->hasil == "baik")  ✔ @else  @endif </span>
                            </td>
                            <td class="center">
                                <span style="font-family: DejaVu Sans, sans-serif; font-size: 15px"> @if($item->hasil == "rusak")  ✔ @else  @endif </span>
                            </td>
                            <td class="center">
                                {{$item->keterangan}}
                            </td>
                    ...
                    @foreach ( $formEleChecklist2HarianSelatans as $key => $item )
                        <tr>
                            <td>{{$loop->iteration}}</td>
                            <td>{{ $item->pertanyaan ?? '' }}</td>
                            <td class="center">
