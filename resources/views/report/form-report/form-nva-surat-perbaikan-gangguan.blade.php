                ...
                <table style="text-align:center" class="table-data">
                            ...
                            <table class="waktu">
                                <tr>
                                    <td class="border" style="text-align: left">
                                        {{ $formNvaSuratPerbaikanGangguan->nama_petugas_atc }}
                                    </td>
                                </tr>
                            </table>
                        </td>
                    ...
                    <tr>
                        ...
                        <td class="data">
                            <table class="waktu">
                                <tr>
                                    <td class="border">{{ $formNvaSuratPerbaikanGangguan->jam_masuk[0] }}</td>
                                    <td class="border">{{ $formNvaSuratPerbaikanGangguan->jam_masuk[1] }}</td>
                                    <td class="hide" style="text-align: center">-</td>
                                    <td class="border">{{ $formNvaSuratPerbaikanGangguan->jam_masuk[3] }}</td>
                                    <td class="border">{{ $formNvaSuratPerbaikanGangguan->jam_masuk[4] }}</td>
                                </tr>
                            </table>
                        </td>
                        <td></td>
                    ...
                    <tr>
                        ...
                        <td class="data">
                            <table class="waktu">
                                <tr>
                                    <td class="border">{{ $formNvaSuratPerbaikanGangguan->jam_keluar[0] }}</td>
                                    <td class="border">{{ $formNvaSuratPerbaikanGangguan->jam_keluar[1] }}</td>
                                    <td class="hide" style="text-align: center">-</td>
                                    <td class="border">{{ $formNvaSuratPerbaikanGangguan->jam_keluar[3] }}</td>
                                    <td class="border">{{ $formNvaSuratPerbaikanGangguan->jam_keluar[4] }}</td>
                                </tr>
                            </table>
                        </td>
                        <td></td>
                    ...
                    <tr>
                        ...
                        <td class="data">
                            <table class="waktu">
                                <tr>
                                    <td class="border" style="text-align: left">
                                        {{ $formNvaSuratPerbaikanGangguan->nomor_polisi }}
                                    </td>
                                </tr>
                            </table>
                        </td>
                    ...
                    <tr>
                        ...
                        <td class="data" colspan="2">
                            <table class="waktu">
                                <tr>
                                    <td class="border" style="text-align: left">
                                        {{ $formNvaSuratPerbaikanGangguan->tujuan_keperluan }}
                                    </td>
                                </tr>
                            </table>
                        </td>
                    ...
                    <tr>
                        ...
                        <td class="data" colspan="2">
                            <table class="waktu">
                                <tr>
                                    <td class="border" style="text-align: left">
                                        {{ $formNvaSuratPerbaikanGangguan->lokasi_pekerjaan }}
                                    </td>
                                </tr>
                            </table>
                        </td>
                    ...
                    <tr style="border-top: 1px solid black;">
                        ...
                        <br></br>
                        <br></br>
                            {!! $formNvaSuratPerbaikanGangguan->catatan !!}
                        </td>
                    </tr>
