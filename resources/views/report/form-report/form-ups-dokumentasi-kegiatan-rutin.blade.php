            ...
            <div class="table">
                ...
                <table class="my-table">
                    <tr >
                        ...
                        <td class="center">NAMA PERALATAN</td>
                        <td colspan="2">               </td>
                    ...
                    <tr style="background-color: white;" class="center">
                        ...
                        <td colspan="2" class="center">NAMA LOKASI</td>
                        <td class="center" rowspan="12"><img style="width: 50px; text-align:right; display:inline;"
                    ...
                    <tr class="center">
                        <td rowspan="9" class="center">KEGIATAN DI AWAL</td>
                        <td class="center">Nama Task</td>
