        ...
        <div class="body">
            <div class="table">
                <table class="table-data">
                                        ...
                                        <table style="border: none;">
                                            <tr style="border: none;">
                                                ...
                                                <td style="border: none; border-bottom:1px solid black; width: 50%;">
                                                    {{$formHmvPowerTahunans[0]->equipment_number}}
                                                </td>
                                            </tr>
                                            <tr style="border: none;">
                                                <td style="border: none;">LOCATION/STATION</td>
                                                <td style="border: none; border-bottom:1px solid black; width: 50%;">
                                                    {{$formHmvPowerTahunans[0]->location_station}}
                                                </td>
                                            </tr>
                                            <tr style="border: none;">
                                                <td style="border: none;">NUMBER OF CABLE</td>
                                                <td style="border: none; border-bottom:1px solid black; width: 50%;">
                                                    {{$formHmvPowerTahunans[0]->number_of_cable}}
                                                </td>
                                            </tr>
                                            <tr style="border: none;">
                                                <td style="border: none;">NUMBER OF CIRCUITS</td>
                                                <td style="border: none; border-bottom:1px solid black; width: 50%;">
                                                    {{$formHmvPowerTahunans[0]->number_of_circuits}}
                                                </td>
                                            </tr>
                                            <tr style="border: none;">
                                            ...
                                            <tr style="border: none;">
                                                ...
                                                <td style="border: none; border-bottom:1px solid black; width: 50%;">
                                                    {{$formHmvPowerTahunans[0]->reference_drawing}}
                                                </td>
                                            </tr>
                                            <tr style="border: none;">
                                                <td style="border: none;"></td>
                                        ...
                                        <table style="border: none;">
                                            <tr style="border: none;">
                                                ...
                                                <td style="border: none; border-bottom:1px solid black; width:70%;">
                                                    {{$formHmvPowerTahunans[0]->inspection_date}}
                                                </td>
                                            </tr>
                                            <tr style="border: none;">
                                                <td style="border: none;">SERIAL NUMBER</td>
                                                <td style="border: none; border-bottom:1px solid black; width:70%;">
                                                    {{$formHmvPowerTahunans[0]->serial_number}}
                                                </td>
                                            </tr>
                                            ...
                                            <tr style="border: none;">
                                                ...
                                                <td style="border: none; border-bottom:1px solid black; width:70%;">
                                                    {{$formHmvPowerTahunans[0]->brand_merk}}
                                                </td>
                                            </tr>
                                            ...
                                            <tr style="border: none;">
                                                ...
                                                <td style="border: none; border-bottom:1px solid black; width:70%;">
                                                    {{$formHmvPowerTahunans[0]->name_plate}}
                                                </td>
                                            </tr>
                                                    ...
                                                    <table>
                                                        <tr>
                                                            <td style="border: 1px solid black; width:10px">
                                                                <span style="font-family: DejaVu Sans, sans-serif; font-size: 10px;">{{ $formHmvPowerTahunans[0]->status == 'OPS' ? '✔' : '' }}</span>
                                                            </td>
                                                            <td style="border:none;">OPS</td>
                                                            <td style="border: 1px solid black; width:10px">
                                                                <span style="font-family: DejaVu Sans, sans-serif; font-size: 10px;">{{ $formHmvPowerTahunans[0]->status == 'STBY' ? '✔' : '' }}</span>
                                                            </td>
                                                            <td style="border:none;">STBY</td>
                                                            <td style="border: 1px solid black; width:10px">
                                                                <span style="font-family: DejaVu Sans, sans-serif; font-size: 10px;">{{ $formHmvPowerTahunans[0]->status == 'REPAIR' ? '✔' : '' }}</span>
                                                            </td>
                    ...
                    <tr>
                        <td colspan="5" style="height: 10px; border: 1px solid black; width:10px">
                            REMARKS: {{$formHmvPowerTahunans[0]->catatan}}
                        </td>
                    </tr>
                    <tr>
                        <td colspan="5" style="height: 10px; border: 1px solid black; width:10px">
