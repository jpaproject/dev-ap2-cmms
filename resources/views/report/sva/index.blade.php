...
@section('script')
    ...
    <script>
        ...
        $('#printPreventive').click(function() {
            printReport("{{ route('report.electrical-utility.south-visual-aid.preventive') }}");
        });
        $('#printChecklist1').click(function() {
            printReport("{{ route('report.electrical-utility.south-visual-aid.checklist1') }}");
        });
        $('#printChecklist2').click(function() {
            printReport("{{ route('report.electrical-utility.south-visual-aid.checklist2') }}");
        });
        $('#printsuratIzin').click(function() {
            printReport("{{ route('report.electrical-utility.south-visual-aid.suratIzin') }}");
        });
        $('#printsuratPerbaikan').click(function() {
            printReport("{{ route('report.electrical-utility.south-visual-aid.suratPerbaikan') }}");
        });
        $('#printsuratPemeriksaan').click(function() {
            printReport("{{ route('report.electrical-utility.south-visual-aid.suratPemeriksaan') }}");
        });
        $('#printflightCalibration').click(function() {
            printReport("{{ route('report.electrical-utility.south-visual-aid.flightCalibration') }}");
        });
        $('#printcurrentRegulator').click(function() {
            printReport("{{ route('report.electrical-utility.south-visual-aid.currentRegulator') }}");
        });
        ...
        const submitDate = async () => {
            ...
            try {
                const url ="{{ route('sva-work-orders') }}";
