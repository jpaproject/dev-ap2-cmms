                    ...
                    <form method="POST" action="{{ route('materials.store') }}">
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control @error('brand') is-invalid @enderror" id="brand" name="brand" value="{{ old('brand') }}" placeholder="Enter brand">
                            ...
                            <div class="form-group">
                                ...
                                <input type="date" class="form-control @error('purchase_at') is-invalid @enderror" id="purchase_at" name="purchase_at" value="{{ old('purchase_at') }}" placeholder="Enter purchase_at">
                            ...
                            <div class="form-group">
                                ...
                                <input type="number" class="form-control @error('purchase_price') is-invalid @enderror" id="purchase_price" name="purchase_price" value="{{ old('purchase_price') }}" placeholder="Enter Price">
