...
@section('breadcumb')
    ...
    <li class="breadcrumb-item"><a href="{{ route('user-technical-groups.index') }}">User Technical Group</a></li>
            ...
            <div class="col-sm-6">
                <div class="card card-primary">
                    <div class="card-header">
                        <h3 class="card-title">Add User Technical Group</h3>
                    </div>
                    ...
                    <form method="POST" action="{{ route('user-technical-groups.store') }}" novalidate>
                        ...
                        <div class="card-body">
                            ...
                            <input type="text" name="from" id="from" value="user_technical_group" class="d-none">
                        ...
                        <div class="card-footer">
                            ...
                            <a href="{{ route('user-technical-groups.index') }}" class="btn btn-secondary btn-footer">Back</a>
                        </div>
                    </form>
                </div>
            </div>
