...
@section('breadcumb')
    <li class="breadcrumb-item"><a href="{{ route('assets.index') }}">Schedule Maintenance</a></li>
                ...
                <div class="col-lg-12">
                    <div class="card card-primary">
                        <div class="card-header">
                            <h3 class="card-title">Edit Schedule Maintenance</h3>
                        </div>

                        <form method="POST" action="{{ route('schedule-maintenances.update', $schedule_maintenance->id) }}"
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                            ...
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text"
                                                        ...
                                                        id="code" name="code"
                                                        value="{{ old('code') ?? $schedule_maintenance->code }}"
                                            ...
                                            <div class="col-md-9">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text"
                                                        ...
                                                        id="name" name="name"
                                                        value="{{ old('name') ?? $schedule_maintenance->name }}"
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="icheck-danger d-inline mr-3">
                                                <input type="radio" name="status" id="paused"
                                                    {{ (old('status') ?? $schedule_maintenance->status) == '0' ? 'checked' : '' }}
                                                    value="0">
                                            ...
                                            <div class="icheck-success d-inline mr-5">
                                                <input type="radio" name="status" id="running"
                                                    {{ (old('status') ?? $schedule_maintenance->status) == '1' ? 'checked' : '' }}
                                                    value="1">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="text" class="form-control float-right" id="dateRange"
                                                    name="date_range"
                                                    value="{{ old('date_range') ?? date('d/m/Y', strtotime($schedule_maintenance->start_date)) . ' - ' . date('d/m/Y', strtotime($schedule_maintenance->end_date)) }}">
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="date"
                                                    ...
                                                    id="start_date" name="start_date" value="{{ old('start_date') ?? $schedule_maintenance->start_date }}"
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group" id="end-date">
                                                ...
                                                <input type="date"
                                                    ...
                                                    id="end_date" name="end_date" value="{{ old('end_date')?? $schedule_maintenance->end_date }}"
                                        ...
                                        <div class="form-group">
                                            ...
                                            <textarea name="description" class="form-control @error('description') is-invalid @enderror" id="description"
                                                cols="30" rows="3" placeholder="Enter description">{{ old('description') ?? $schedule_maintenance->description }}</textarea>
                                                    ...
                                                    <select
                                                        ...
                                                        @foreach ($work_order_statuses as $work_order_status)
                                                            <option value="{{ $work_order_status->id }}"
                                                                {{ (old('work_order_status_id') ?? $schedule_maintenance->work_order_status_id) == $work_order_status->id ? 'selected' : '' }}>
                                                    ...
                                                    <select
                                                        ...
                                                        @foreach ($maintenance_types as $maintenances_type)
                                                            <option value="{{ $maintenances_type->id }}"
                                                                {{ (old('maintenance_type_id') ?? $schedule_maintenance->maintenance_type_id) == $maintenances_type->id ? 'selected' : '' }}>
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <select class="form-control  @error('priority') is-invalid @enderror"
                                                        ...
                                                        <option value="lowest"
                                                            {{ (old('priority') ?? $schedule_maintenance->priority) == 'lowest' ? 'selected' : '' }}>
                                                            Lowest</option>
                                                        <option value="low"
                                                            {{ (old('priority') ?? $schedule_maintenance->priority) == 'low' ? 'selected' : '' }}>
                                                            Low</option>
                                                        <option value="medium"
                                                            {{ (old('priority') ?? $schedule_maintenance->priority) == 'medium' ? 'selected' : '' }}>
                                                            Medium</option>
                                                        <option value="high"
                                                            {{ (old('priority') ?? $schedule_maintenance->priority) == 'high' ? 'selected' : '' }}>
                                                            High</option>
                                                        <option value="highest"
                                                            {{ (old('priority') ?? $schedule_maintenance->priority) == 'highest' ? 'selected' : '' }}>
                                                            Highest</option>
                                                    </select>
                                                    @error('priority')
                                                        <span class="invalid-feedback" role="alert">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="radio" name="schedule" onclick="scheduleSwitch();" id="hour" {{( old('schedule') ?? $schedule_maintenance->schedule) == "hour" ? "checked" : ""}}  value="hour">
                                            ...
                                            <div class="d-inline mr-3">
                                                <input type="radio" name="schedule" onclick="scheduleSwitch();"
                                                    id="day"
                                                    {{ (old('schedule') ?? $schedule_maintenance->schedule) == 'day' ? 'checked' : '' }}
                                                    value="day">
                                            ...
                                            <div class="d-inline mr-3">
                                                <input type="radio" name="schedule" onclick="scheduleSwitch();"
                                                    id="week"
                                                    {{ (old('schedule') ?? $schedule_maintenance->schedule) == 'week' ? 'checked' : '' }}
                                                    value="week">
                                            ...
                                            <div class="d-inline mr-3">
                                                <input type="radio" name="schedule" onclick="scheduleSwitch();"
                                                    id="month"
                                                    {{ (old('schedule') ?? $schedule_maintenance->schedule) == 'month' ? 'checked' : '' }}
                                                    value="month">
                                            ...
                                            <div class="d-inline">
                                                <input type="radio" name="schedule" onclick="scheduleSwitch();"
                                                    id="year"
                                                    {{ (old('schedule') ?? $schedule_maintenance->schedule) == 'year' ? 'checked' : '' }}
                                                    value="year">
                                        ...
                                        <div class="col-2">
                                            <input type="number"
                                                ...
                                                value="{{ old('hour') ?? ($schedule_maintenance->hour ?? 1) }}"
                                        ...
                                        <div class="form-group row day-group d-none">
                                            ...
                                            <div class="col-2">
                                                <input type="number"
                                                    ...
                                                    value="{{ old('day_of_month') ?? ($schedule_maintenance->day_of_month ?? 1) }}"
                                                    placeholder="Enter day" min="1" max="31"
                                                    disabled='true'>
                                            </div>
                                        ...
                                        <div class="form-group row week-group d-none">
                                            ...
                                            <div class="col-2">
                                                <input type="number"
                                                    ...
                                                    id="week-group-week" name="week"
                                                    value="{{ old('week') ?? ($schedule_maintenance->week ?? 1) }}"
                                        ...
                                        <div class="form-group row month-group d-none">
                                            ...
                                            <div class="col-2">
                                                <input type="number"
                                                    ...
                                                    value="{{ old('month') ?? ($schedule_maintenance->month ?? 1) }}"
                                                    placeholder="Enter month" min="1" max="12"
                                                    disabled='true'>
                                            </div>
                                        ...
                                        <div class="form-group row year-group d-none">
                                            ...
                                            <div class="col-2">
                                                <input type="number"
                                                    ...
                                                    id="year-group-year" name="year"
                                                    value="{{ old('year') ?? ($schedule_maintenance->year ?? 1) }}"
                                                ...
                                                <select class="form-control  @error('month') is-invalid @enderror"
                                                    ...
                                                    @foreach ($months as $month)
                                                        <option value="{{ $loop->iteration }}"
                                                            {{ (old('month') ?? $schedule_maintenance->month) == $loop->iteration ? 'selected' : '' }}>
                                                            {{ $month }}</option>
                                                    @endforeach
                                                </select>
                                            </div>
                                        ...
                                        <div class="form-group row day-of-week-group d-none">
                                            <div class="custom-control custom-checkbox col-3">
                                                <input class="custom-control-input day-of-week" type="checkbox"
                                                    ...
                                                    {{ is_array(old('day_of_week')) ? (in_array('1', old('day_of_week')) ? 'checked' : '') : (in_array('1', json_decode($schedule_maintenance->day_of_week ?? '[]')) ? 'checked' : '') }}>
                                                <label for="monday" class="custom-control-label">Monday</label>
                                            </div>
                                            <div class="custom-control custom-checkbox col-3">
                                                <input class="custom-control-input day-of-week" type="checkbox"
                                                    id="tuesday" value="2" name="day_of_week[]" disabled='true'
                                                    {{ is_array(old('day_of_week')) ? (in_array('2', old('day_of_week')) ? 'checked' : '') : (in_array('2', json_decode($schedule_maintenance->day_of_week ?? '[]')) ? 'checked' : '') }}>
                                                <label for="tuesday" class="custom-control-label">Tuesday</label>
                                            </div>
                                            <div class="custom-control custom-checkbox col-3">
                                                <input class="custom-control-input day-of-week" type="checkbox"
                                                    id="wednesday" value="3" name="day_of_week[]" disabled='true'
                                                    {{ is_array(old('day_of_week')) ? (in_array('3', old('day_of_week')) ? 'checked' : '') : (in_array('3', json_decode($schedule_maintenance->day_of_week ?? '[]')) ? 'checked' : '') }}>
                                                <label for="wednesday" class="custom-control-label">Wednesday</label>
                                            </div>
                                            <div class="custom-control custom-checkbox col-3">
                                                <input class="custom-control-input day-of-week" type="checkbox"
                                                    id="thursday" value="4" name="day_of_week[]" disabled='true'
                                                    {{ is_array(old('day_of_week')) ? (in_array('4', old('day_of_week')) ? 'checked' : '') : (in_array('4', json_decode($schedule_maintenance->day_of_week ?? '[]')) ? 'checked' : '') }}>
                                                <label for="thursday" class="custom-control-label">Thursday</label>
                                            </div>
                                            <div class="custom-control custom-checkbox col-3">
                                                <input class="custom-control-input day-of-week" type="checkbox"
                                                    id="friday" value="5" name="day_of_week[]" disabled='true'
                                                    {{ is_array(old('day_of_week')) ? (in_array('5', old('day_of_week')) ? 'checked' : '') : (in_array('5', json_decode($schedule_maintenance->day_of_week ?? '[]')) ? 'checked' : '') }}>
                                                <label for="friday" class="custom-control-label">Friday</label>
                                            </div>
                                            <div class="custom-control custom-checkbox col-3">
                                                <input class="custom-control-input day-of-week" type="checkbox"
                                                    id="saturday" value="6" name="day_of_week[]" disabled='true'
                                                    {{ is_array(old('day_of_week')) ? (in_array('6', old('day_of_week')) ? 'checked' : '') : (in_array('6', json_decode($schedule_maintenance->day_of_week ?? '[]')) ? 'checked' : '') }}>
                                                <label for="saturday" class="custom-control-label">Saturday</label>
                                            </div>
                                            <div class="custom-control custom-checkbox col-3">
                                                <input class="custom-control-input day-of-week" type="checkbox"
                                                    id="sunday" value="7" name="day_of_week[]" disabled='true'
                                                    {{ is_array(old('day_of_week')) ? (in_array('7', old('day_of_week')) ? 'checked' : '') : (in_array('0', json_decode($schedule_maintenance->day_of_week ?? '[]')) ? 'checked' : '') }}>
                                                ...
                                                <div class="col-3">
                                                    ...
                                                    <div class="d-inline mr-3">
                                                        <input type="checkbox" name="shift_pagi" id="shift_pagi"
                                                            {{ old('shift_pagi') | ($schedule_maintenance->pagi == true) ? 'checked' : '' }}
                                                ...
                                                <div class="col-3">
                                                    ...
                                                    <div class="d-inline mr-3">
                                                        <input type="checkbox" name="shift_malam" id="shift_malam"
                                                            {{ $schedule_maintenance->shift_malam == true ? 'checked' : '' }}
                                            ...
                                            <select class="form-control  @error('asset_id') is-invalid @enderror"
                                                ...
                                                @foreach ($assets as $asset)
                                                    <option value="{{ $asset['id'] }}"
                                                        {{ (old('asset_id') ?? $schedule_maintenance->asset_id) == $asset['id'] ? 'selected' : '' }}>
                                                        {{ $asset['name'] }}</option>
                                                @endforeach
                                            </select>
                                        ...
                                        <div class="form-group">
                                            ...
                                            @if (old('assetFormId'))
                                                ...
                                                @endforeach
                                            @else
                                                @foreach ($schedule_maintenance->detailScheduleMaintenanceForms as $scheduleMaintenanceForm)
                                                    <input type="hidden" class="assetFormId" name="assetFormId[]"
                                                        value="{{ $scheduleMaintenanceForm->form_id }}">
                                                @endforeach
                                            @endif
                                        </div>
                                    ...
                                    <div class="row col-12">
                                        ...
                                        <div class="col-md-5">
                                            ...
                                            @if (old('referenceId'))
                                                ...
                                                @endforeach
                                            @else
                                                @foreach ($schedule_maintenance->documents as $document)
                                                    <input type="hidden" class="referenceId" name="referenceId[]"
                                                        value="{{ $document->id }}">
                                                @endforeach
                                            @endif
...
@section('script')
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            //Date range picker
            let daterange = $('#dateRange').daterangepicker({
                "startDate": {!! json_encode(date('d/m/Y', strtotime($schedule_maintenance->start_date))) !!},
                "endDate": {!! json_encode(date('d/m/Y', strtotime($schedule_maintenance->end_date))) !!},
                "maxSpan": {
                    "years": 1
                },
                "showDropdowns": true,
            ...
            @elseif ($schedule_maintenance->taskGroups->pluck('id'))
                id_task_groups = @json($schedule_maintenance->taskGroups->pluck('id')).map(String);
                taskGroupOption(id_task_groups);
            @else
                taskGroupOption([]);
            @endif
            ...
            @if (old('tasks'))
                ...
                taskOption(id_tasks);
            @elseif ($schedule_maintenance->tasks->pluck('id'))
                id_tasks = @json($schedule_maintenance->tasks->pluck('id')).map(String);
                taskOption(id_tasks);
            @else
                taskOption([]);
            @endif
            ...
            @elseif ($schedule_maintenance->userTechnicals->pluck('id'))
                oldUserTechnicals(@json($schedule_maintenance->userTechnicals->pluck('id')))
            @else
                $.ajax({
                    type: 'GET',
            ...
            @elseif ($schedule_maintenance->userGroups->pluck('id'))
                oldUserTechnicalGroups(@json($schedule_maintenance->userGroups->pluck('id')))
            @else
                $.ajax({
                    type: 'GET',
                            ...
                            $.each(asset_form_rows_selected, function(index, id) {
                                ...
                                $.ajax({
                                    ...
                                    success: function(data) {
                                        ...
                                        console.log("Diatas ini datanya");
        ...
        function scheduleSwitch() {
            if ($('input[name="schedule"]:checked').val() == 'hour') {
                ...
                $('#year-group-year').attr('disabled', false);
                $('#month-group-month').attr('disabled', true);
                $('#week-group-week').attr('disabled', true);
                $('#day-group-day').attr('disabled', true);
                // $('#hour-group-hour').attr('disabled', true);
