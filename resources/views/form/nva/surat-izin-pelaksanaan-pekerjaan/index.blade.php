            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="card card-primary">
                        ...
                        <form method="POST"
                            action="{{ route('form.nva.surat-izin-pelaksanaan-pekerjaan.update', $detailWorkOrderForm->id) }}"
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-6 col-10">
                                        <input type="text"
                                            ...
                                            value="{{ old('nama_petugas_atc') ?? $formNvaSuratIzinPelaksanaanPekerjaan->nama_petugas_atc }}"
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-6 col-10">
                                        <input type="time" class="form-control @error('jam_masuk') is-invalid @enderror"
                                            ...
                                            value="{{ old('jam_masuk') ?? $formNvaSuratIzinPelaksanaanPekerjaan->jam_masuk }}"
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-6 col-10">
                                        <input type="time" class="form-control @error('jam_keluar') is-invalid @enderror"
                                            ...
                                            value="{{ old('jam_keluar') ?? $formNvaSuratIzinPelaksanaanPekerjaan->jam_keluar }}"
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-6 col-10">
                                        <select class="form-control select2 @error('kendaraan') is-invalid @enderror"
                                            ...
                                            @if (
                                                $formNvaSuratIzinPelaksanaanPekerjaan->kendaraan == 'PICK UP' ||
                                                    $formNvaSuratIzinPelaksanaanPekerjaan->kendaraan == 'TRUCK' ||
                                                    $formNvaSuratIzinPelaksanaanPekerjaan->kendaraan == 'ST. WAGON/MINIBUS' ||
                                                    $formNvaSuratIzinPelaksanaanPekerjaan->kendaraan == '')
                                                <option value="PICK UP"
                                                    {{ old('kendaraan') ?? $formNvaSuratIzinPelaksanaanPekerjaan->kendaraan == 'PICK UP' ? 'selected' : '' }}>
                                                    PICK UP
                                                </option>
                                                <option value="TRUCK"
                                                    {{ old('kendaraan') ?? $formNvaSuratIzinPelaksanaanPekerjaan->kendaraan == 'TRUCK' ? 'selected' : '' }}>
                                                    TRUCK
                                                </option>
                                                <option value="ST. WAGON/MINIBUS"
                                                    {{ old('kendaraan') ?? $formNvaSuratIzinPelaksanaanPekerjaan->kendaraan == 'ST. WAGON/MINIBUS' ? 'selected' : '' }}>
                                                    ST. WAGON/MINIBUS
                                                </option>
                                            @else
                                                <option value="{{ $formNvaSuratIzinPelaksanaanPekerjaan->kendaraan }}"
                                                    selected>
                                                    {{ $formNvaSuratIzinPelaksanaanPekerjaan->kendaraan }}
                                                </option>
                                                <option value="PICK UP">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-6 col-10">
                                        <input type="text"
                                            ...
                                            value="{{ old('nomor_polisi') ?? $formNvaSuratIzinPelaksanaanPekerjaan->nomor_polisi }}"
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-6 col-10">
                                        <input type="text"
                                            ...
                                            value="{{ old('tujuan_keperluan') ?? $formNvaSuratIzinPelaksanaanPekerjaan->tujuan_keperluan }}"
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-6 col-10">
                                        <input type="text"
                                            ...
                                            value="{{ $formNvaSuratIzinPelaksanaanPekerjaan->lokasi_pekerjaan ?? ($workOrder->asset->location->name ?? '') }}"
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-12">
                                        <textarea name="catatan" class="form-control @error('catatan') is-invalid @enderror" id="catatan" cols="30"
                                            rows="3" placeholder="Enter Catatan">{!! $formNvaSuratIzinPelaksanaanPekerjaan->catatan !!}</textarea>
                                    </div>
                                </div>
                            </div>
                            <div class="container-fluid">
