            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="card card-primary">
                        ...
                        <form method="POST"
                            action="{{ route('form.nva.pemeriksaan-rutin.update', $detailWorkOrderForm->id) }}"
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-6 col-10">
                                        <input type="date" class="form-control @error('tanggal') is-invalid @enderror"
                                            ...
                                            value="{{ $formNvaSuratPemeriksaanRutin->tanggal ?? (date('Y-m-d', strtotime($workOrder->date_generate)) ?? '') }}"
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-6 col-10">
                                        <input type="text"
                                            ...
                                            value="{{ old('nama_petugas_atc') ?? $formNvaSuratPemeriksaanRutin->nama_petugas_atc }}"
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-6 col-10">
                                        <input type="time" class="form-control @error('jam_masuk') is-invalid @enderror"
                                            ...
                                            value="{{ old('jam_masuk') ?? $formNvaSuratPemeriksaanRutin->jam_masuk }}"
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-6 col-10">
                                        <input type="time" class="form-control @error('jam_keluar') is-invalid @enderror"
                                            ...
                                            value="{{ old('jam_keluar') ?? $formNvaSuratPemeriksaanRutin->jam_keluar }}"
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-6 col-10">
                                        <select class="form-control select2 @error('kendaraan') is-invalid @enderror"
                                            ...
                                            @if (
                                                $formNvaSuratPemeriksaanRutin->kendaraan == 'PICK UP' ||
                                                    $formNvaSuratPemeriksaanRutin->kendaraan ==
                                                        'U
                                                                                                                                    U' ||
                                                    $formNvaSuratPemeriksaanRutin->kendaraan == 'ST. WAGON/MINIBUS' ||
                                                    $formNvaSuratPemeriksaanRutin->kendaraan == null)
                                                <option value="PICK UP"
                                                    {{ old('kendaraan') ?? $formNvaSuratPemeriksaanRutin->kendaraan == 'PICK UP' ? 'selected' : '' }}>
                                                    PICK UP
                                                </option>
                                                <option value="TRUCK"
                                                    {{ old('kendaraan') ?? $formNvaSuratPemeriksaanRutin->kendaraan == 'TRUCK' ? 'selected' : '' }}>
                                                    TRUCK
                                                </option>
                                                <option value="ST. WAGON/MINIBUS"
                                                    {{ old('kendaraan') ?? $formNvaSuratPemeriksaanRutin->kendaraan == 'ST. WAGON/MINIBUS' ? 'selected' : '' }}>
                                                    ST. WAGON/MINIBUS
                                                </option>
                                            @else
                                                <option value="{{ $formNvaSuratPemeriksaanRutin->kendaraan }}" selected>
                                                    {{ $formNvaSuratPemeriksaanRutin->kendaraan }}
                                                </option>
                                                <option value="PICK UP">
                                                    PICK UP
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-6 col-10">
                                        <input type="text"
                                            ...
                                            value="{{ old('nomor_polisi') ?? $formNvaSuratPemeriksaanRutin->nomor_polisi }}"
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-6 col-10">
                                        <input type="text"
                                            ...
                                            value="{{ old('tujuan_keperluan') ?? $formNvaSuratPemeriksaanRutin->tujuan_keperluan }}"
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-6 col-10">
                                        <input type="text"
                                            ...
                                            value="{{ $formNvaSuratPemeriksaanRutin->lokasi_pekerjaan ?? ($workOrder->asset->location->name ?? '') }}"
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-12">
                                        <textarea name="catatan" class="form-control @error('catatan') is-invalid @enderror" id="catatan" cols="30"
                                            rows="3" placeholder="Enter Catatan">{!! old('catatan') ?? $formNvaSuratPemeriksaanRutin->catatan !!}</textarea>
                                    </div>
                                </div>
                            </div>
                            <div class="container-fluid">
