...
@section('content')
    <section class="content">
        <form method="POST" action="{{ route('form.hmv.sistem-pelaporan.power.tiga-bulanan.update', $detailWorkOrderForm->id) }}" enctype="multipart/form-data"
        id="form">
        @method('patch')
        @csrf
        <div class="container-fluid">
            <div class="row">
                <div class="col-lg-12">
                                    ...
                                    <tr>
                                        <td>
                                            <input type="text"
                                                ...
                                                name="equipment_number" value="{{ old('equipment_number') ?? $formHmvPowerTigaBulanans[0]->equipment_number }}"
                                    ...
                                    <tr>
                                        <td>
                                            <input type="text"
                                                ...
                                                name="location_station" value="{{ old('location_station') ?? $formHmvPowerTigaBulanans[0]->location_station }}"
                                    ...
                                    <tr>
                                        <td>
                                            <input type="text"
                                                ...
                                                name="number_of_cable" value="{{ old('number_of_cable') ?? $formHmvPowerTigaBulanans[0]->number_of_cable }}"
                                    ...
                                    <tr>
                                        <td>
                                            <input type="text"
                                                ...
                                                name="number_of_circuits" value="{{ old('number_of_circuits') ?? $formHmvPowerTigaBulanans[0]->number_of_circuits }}"
                                    ...
                                    <tr>
                                        <td>
                                            <input type="text"
                                                ...
                                                name="reference_drawing" value="{{ old('reference_drawing') ?? $formHmvPowerTigaBulanans[0]->reference_drawing }}"
                                    ...
                                    <tr>
                                        <td>
                                            <input type="date"
                                                ...
                                                name="inspection_date" value="{{ old('inspection_date') ?? $formHmvPowerTigaBulanans[0]->inspection_date }}"
                                    ...
                                    <tr>
                                        <td>
                                            <input type="text"
                                                ...
                                                name="serial_number" value="{{ old('serial_number') ?? $formHmvPowerTigaBulanans[0]->serial_number }}"
                                    ...
                                    <tr>
                                        <td>
                                            <input type="text"
                                                ...
                                                name="brand_merk" value="{{ old('brand_merk') ?? $formHmvPowerTigaBulanans[0]->brand_merk }}"
                                    ...
                                    <tr>
                                        <td>
                                            <input type="text"
                                                ...
                                                name="name_plate" value="{{ old('name_plate') ?? $formHmvPowerTigaBulanans[0]->name_plate }}"
                                    ...
                                    <tr>
                                        <td>
                                            <select class="form-control" aria-label="Default select example" name="status">
                                                ...
                                                <option value="OPS"
                                                    {{ (old('status') ?? $formHmvPowerTigaBulanans[0]->status) == 'OPS' ? 'selected' : '' }}
                                                >OPS</option>
                                                <option value="STBY"
                                                    {{ (old('status') ?? $formHmvPowerTigaBulanans[0]->status) == 'STBY' ? 'selected' : '' }}
                                                >STBY</option>
                                                <option value="REPAIR"
                                                    {{ (old('status') ?? $formHmvPowerTigaBulanans[0]->status) == 'REPAIR' ? 'selected' : '' }}
                                                >REPAIR</option>
                                            </select>
                                        </td>
                                    </tr>
                    ...
                    @foreach ($formHmvPowerTigaBulanans as $key => $item)
                        <div class="card card-body">
        ...
        <div class="row">
            <div class="col-12">
                <textarea name="catatan" class="form-control @error('catatan') is-invalid @enderror" id="catatan"
                    cols="30" rows="3" placeholder="Enter Catatan">{!! $formHmvPowerTigaBulanans[0]->catatan ?? '' !!}</textarea>
            </div>
        </div>
        <div class="container-fluid">
            <div class="row">
