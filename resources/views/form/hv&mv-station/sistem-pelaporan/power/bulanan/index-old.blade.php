        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <div class="card card-body">
                        <label for="">1. Pemeriksaan level oil trafo</label>
                        <div class="row">
                    ...
                    <div class="card card-body">
                        <label for="">2. Pemeriksaan suhu oil trafo</label>
                        <div class="row">
                            <div class="col-12 col-md-6 col-lg">
                                <table class="w-100">
                                    <tr>
                    ...
                    <div class="card card-body">
                        <label for="">3. Pemeriksaan pressure</label>
                        <div class="row">
                            <div class="col-12 col-md-6 col-lg">
                                <table class="w-100">
                                    <tr>
                    ...
                    <div class="card card-body">
                        <label for="">4. Pemeriksaan kebocoran oil trafo</label>
                        <div class="row">
                            <div class="col-12 col-md-6 col-lg">
                                <table class="w-100">
                                    <tr>
                    ...
                    <div class="card card-body">
                        <label for="">5. pemeriksaan silica gel</label>
                        <div class="row">
                            <div class="col-12 col-md-6 col-lg">
                                <table class="w-100">
                                    <tr>
