                    ...
                    <div class="card card-primary">
                        ...
                        <form method="POST" action="{{ route('work-orders.store') }}" enctype="multipart/form-data"
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group row">
                                    <label class="col-12 col-lg-3">NOMOR</label>
                                    <div class="col-lg-3 col-10">
                                ...
                                <div class="form-group row">
                                    <label class="col-12 col-lg-3">KLASIFIKASI</label>
                                    <div class="col-lg-3 col-10">
                                        <select class="form-control" aria-label="Default select example">
                                            <option value"" selected>Open this select menu</option>
                                            <option value="amatSegera">Amat Segera</option>
                                ...
                                <div class="form-group row">
                                    <label class="col-12 col-lg-3">LOKASI</label>
                                    <div class="col-lg-3 col-10">
            ...
            old_user_technical.forEach(id => {
                $.ajax({
                    ...
                    success: function (data) {
                        ...
                        var img = `<img src="w/${data.data.avatar??'user.png'}"
