            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="card card-primary">
                        ...
                        <form method="POST"
                            action="{{ route('form.ps1.form-genset-standby-gardu-teknik-dua-mingguan.update', $detailWorkOrderForm->id) }}"
                                        ...
                                        <div class="col-6 col-lg-3">
                                            <div class="form-group">
                                                ...
                                                <input type="text"
                                                    ...
                                                    value="{{ $gensetStandbyGarduTeknikDuaMingguan->data_teknis ?? '' }}"
                                            ...
                                            <div class="form-group">
                                                ...
                                                @if (is_array($datas[$key]['satuan']))
                                                    <select class="form-control select2 @error('satuan') is-invalid @enderror"
                                                        ...
                                                        <option value="{{ $satuan }}" @if((old('satuan.'.$key) ?? $gensetStandbyGarduTeknikDuaMingguan->satuan) == $satuan) selected @endif>{{ $satuan }}</option>
                                                        @endforeach
                                                    </select>
                                                @else
                                                    <input type="text"
                                                        ...
                                                        value="{{ $datas[$key]['satuan'] ?? $gensetStandbyGarduTeknikDuaMingguan->satuan}}"
                                        ...
                                        <div class="col-12 col-lg-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text"
                                                    ...
                                                    value="{{ $gensetStandbyGarduTeknikDuaMingguan->keterangan ?? '' }}"
                                                    placeholder="Enter..">
                                                </select>
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-12 col-lg-9">
                                                        ...
                                                        <textarea name="catatan" class="form-control @error('catatan') is-invalid @enderror" id="catatan"
                                                            placeholder="Deskripsi">{!! $gensetStandbyGarduTeknikDuaMingguans[0]->catatan ?? '' !!}</textarea>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
