            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="card card-primary">
                        ...
                        <form method="POST"
                            action="{{ route('form.ps1.panel-mv-tahunan.update', $detailWorkOrderForm->id) }}"
                                        ...
                                        <div class="col-6 col-lg-3">
                                            <div class="form-group">
                                                ...
                                                <input type="text"
                                                    ...
                                                    value="{{ $formPs1PanelMvTahunan->data_teknis ?? '' }}"
                                            ...
                                            <div class="col-4 col-lg-3">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text"
                                                        ...
                                                        id="r" name="r[]"
                                                        value="{{ old('r.' . $key) ?? $formPs1PanelMvTahunan->r }}"
                                                        placeholder="Enter..">
                                                    @error('r.' . $key)
                                                        <span class="invalid-feedback" role="alert">
                                                            <strong>{{ $message }}</strong>
                                            ...
                                            <div class="col-4 col-lg-3">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text"
                                                        ...
                                                        id="s" name="s[]"
                                                        value="{{ old('s.' . $key) ?? $formPs1PanelMvTahunan->s }}"
                                                        placeholder="Enter..">
                                                    @error('s.' . $key)
                                                        <span class="invalid-feedback" role="alert">
                                                            <strong>{{ $message }}</strong>
                                            ...
                                            <div class="col-4 col-lg-3">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text"
                                                        ...
                                                        id="t" name="t[]"
                                                        value="{{ old('t.' . $key) ?? $formPs1PanelMvTahunan->t }}"
                                                        placeholder="Enter..">
                                                    @error('t.' . $key)
                                                        <span class="invalid-feedback" role="alert">
                                                            <strong>{{ $message }}</strong>
                                            ...
                                            <div class="col-6 col-lg-9">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text"
                                                        ...
                                                        id="q1" name="q1[]"
                                                        value="{{ old('q1.' . $key) ?? $formPs1PanelMvTahunan->q1 }}"
                                                        placeholder="Enter..">
                                                    @error('q1.' . $key)
                                                        <span class="invalid-feedback" role="alert">
                                                            <strong>{{ $message }}</strong>
                                            ...
                                            <div class="form-group">
                                                ...
                                                @if ($key == 0 || $key == 5 || $key == 6 || $key == 7 || $key == 8 || $key == 18 || $key == 19 || $key == 20)
                                                    <select class="form-control @error('satuan') is-invalid @enderror"
                                                        ...
                                                        @if ($key == 0)
                                                            <option value="normal"
                                                                {{ (old('satuan.' . $key) ?? $formPs1PanelMvTahunan->satuan) == 'normal' ? 'selected' : '' }}>
                                                                Normal</option>
                                                            <option value="rusak"
                                                                {{ (old('satuan.' . $key) ?? $formPs1PanelMvTahunan->satuan) == 'rusak' ? 'selected' : '' }}>
                                                                Rusak</option>
                                                        @endif
                                                        @if ($key == 5)
                                                            <option value="hijau"
                                                                {{ (old('satuan.' . $key) ?? $formPs1PanelMvTahunan->satuan) == 'hijau' ? 'selected' : '' }}>
                                                                Hijau</option>
                                                            <option value="merah"
                                                                {{ (old('satuan.' . $key) ?? $formPs1PanelMvTahunan->satuan) == 'merah' ? 'selected' : '' }}>
                                                                Merah</option>
                                                        @endif
                                                        @if ($key == 6)
                                                            <option value="open"
                                                                {{ (old('satuan.' . $key) ?? $formPs1PanelMvTahunan->satuan) == 'open' ? 'selected' : '' }}>
                                                                Open</option>
                                                            <option value="close"
                                                                {{ (old('satuan.' . $key) ?? $formPs1PanelMvTahunan->satuan) == 'close' ? 'selected' : '' }}>
                                                                Close</option>
                                                        @endif
                                                        @if ($key == 7)
                                                            <option value="charge"
                                                                {{ (old('satuan.' . $key) ?? $formPs1PanelMvTahunan->satuan) == 'charge' ? 'selected' : '' }}>
                                                                Charge</option>
                                                            <option value="discharge"
                                                                {{ (old('satuan.' . $key) ?? $formPs1PanelMvTahunan->satuan) == 'discharge' ? 'selected' : '' }}>
                                                                Discharge</option>
                                                        @endif
                                                        @if ($key == 8 || $key == 18 || $key == 19)
                                                            <option value="normal"
                                                                ...
                                                                Normal</option>
                                                            <option value="error"
                                                                {{ (old('satuan.' . $key) ?? $formPs1PanelMvTahunan->satuan) == 'error' ? 'selected' : '' }}>
                                                                Error</option>
                                                        @endif
                                                        @if ($key == 20)
                                                            <option value="mega"
                                                                {{ (old('satuan.' . $key) ?? $formPs1PanelMvTahunan->satuan) == 'mega' ? 'selected' : '' }}>
                                                                Mega</option>
                                                            <option value="giga_ohm"
                                                                {{ (old('satuan.' . $key) ?? $formPs1PanelMvTahunan->satuan) == 'giga_ohm' ? 'selected' : '' }}>
                                                                Giga Ohm</option>
                                                        @endif
                                                    </select>
                                                @else
                                        ...
                                        <div class="col-12 col-lg-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text"
                                                    ...
                                                    value="{{ $formPs1PanelMvTahunan->keterangan ?? '' }}"
                                                    placeholder="Enter..">
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-12 col-lg-9">
                                                        ...
                                                        <textarea name="catatan" class="form-control @error('catatan') is-invalid @enderror" id="catatan"
                                                            placeholder="Deskripsi">{!! $formPs1PanelMvTahunans[0]->catatan ?? '' !!}</textarea>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
