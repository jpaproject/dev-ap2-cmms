            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="card card-primary">
                        ...
                        <form method="POST"
                            action="{{ route('form.ps1.form-genset-standby-gardu-teknik-tiga-bulanan.update', $detailWorkOrderForm->id) }}"
                                ...
                                <div class="row">
                                    <div class="col-6 col-lg-3">
                                        <div class="form-group">
                                            ...
                                            <input type="text"
                                                ...
                                                value="{{ $gensetStandbyGarduTeknikTigaBulanan->data_teknis ?? '' }}"
                                    ...
                                    <div class="col-6 col-lg-3">
                                        <div class="form-group">
                                            ...
                                            <select class="form-control select2 @error('satuan') is-invalid @enderror" name="satuan[]">
                                                <option value="" selected>Choose Selection</option>
                                                @foreach ($datas[$key]['satuan'] as $satuan)
                                                    <option value="{{ $satuan }}" @if((old('satuan.'.$key) ?? $gensetStandbyGarduTeknikTigaBulanan->satuan) == $satuan) selected @endif>{{ $satuan }}</option>
                                                @endforeach
                                            </select>
                                            @else
                                                <input type="text"
                                    ...
                                    <div class="col-12 col-lg-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text"
                                                ...
                                                value="{{ $gensetStandbyGarduTeknikEnamBulanan->keterangan ?? '' }}"
                                                placeholder="Enter..">
                                            </select>
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-12 col-lg-9">
                                                        ...
                                                        <textarea name="catatan" class="form-control @error('catatan') is-invalid @enderror" id="catatan"
                                                            placeholder="Deskripsi">{!! $gensetStandbyGarduTeknikTigaBulanans[0]->catatan ?? '' !!}</textarea>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
