...
@section('content')
    <section class="content">
        <form method="POST"
            action="{{ route('form.snt.checklist-perawatan-incinerator-456-mingguan.update', $detailWorkOrderForm) }}"
                                                ...
                                                <div id="collapseSeat1" class="collapse" aria-labelledby="1"
                                                    ...
                                                    <div class="card-body">
                                                        ...
                                                        @foreach ($formSntChecklistPerawatanIncinerator456Mingguans as $key => $formSntChecklistPerawatanIncinerator456Mingguan)
                                                            @if ($formSntChecklistPerawatanIncinerator456Mingguan->incinerator == 'INCINERATOR NOMER 4')
                                                                @if ($formSntChecklistPerawatanIncinerator456Mingguan->group == 'PRIMARY CHAMBER')
                                                                    <div class="row">
                                                                        <span
                                                                        ...
                                                                        <div
                                                                            ...
                                                                            <h5>
                                                                                {{ $formSntChecklistPerawatanIncinerator456Mingguan->nama_peralatan }}
                                                                            </h5>
                                                                        </div>
                                                                        <div class="col-6">
                                                                            <div class="form-group">
                                                                                ...
                                                                                <select
                                                                                    ...
                                                                                    <option value="BAIK"
                                                                                        {{ old('kondisi.' . $key) ?? $formSntChecklistPerawatanIncinerator456Mingguan->kondisi == 'BAIK' ? 'selected' : '' }}>
                                                                                        BAIK</option>
                                                                                    <option value="TROUBLE"
                                                                                        {{ old('kondisi.' . $key) ?? $formSntChecklistPerawatanIncinerator456Mingguan->kondisi == 'TROUBLE' ? 'selected' : '' }}>
                                                                                        TROUBLE</option>
                                                                                </select>
                                            ...
                                            <div class="card">
                                                ...
                                                <div id="collapseSeat2" class="collapse" aria-labelledby="1"
                                                    ...
                                                    <div class="card-body">
                                                        ...
                                                        @foreach ($formSntChecklistPerawatanIncinerator456Mingguans as $key => $formSntChecklistPerawatanIncinerator456Mingguan)
                                                            @if ($formSntChecklistPerawatanIncinerator456Mingguan->incinerator == 'INCINERATOR NOMER 4')
                                                                @if ($formSntChecklistPerawatanIncinerator456Mingguan->group == 'BLOWER')
                                                                    <div class="row">
                                                                        <span
                                                                            class="col-12 d-flex justify-content-center fw-bolder">Kondisi</span>
                                                                        <div
                                            ...
                                            <div class="card">
                                                ...
                                                <div id="collapseSeat3" class="collapse" aria-labelledby="1"
                                                    ...
                                                    <div class="card-body">
                                                        ...
                                                        @foreach ($formSntChecklistPerawatanIncinerator456Mingguans as $key => $formSntChecklistPerawatanIncinerator456Mingguan)
                                                            @if ($formSntChecklistPerawatanIncinerator456Mingguan->incinerator == 'INCINERATOR NOMER 4')
                                                                @if ($formSntChecklistPerawatanIncinerator456Mingguan->group == 'BURNER')
                                                                    <div class="row">
                                                                        <span
                                                                            class="col-12 d-flex justify-content-center fw-bolder">Kondisi</span>
                                                                        <div
                                            ...
                                            <div class="card">
                                                ...
                                                <div id="collapseSeat8" class="collapse" aria-labelledby="1"
                                                    ...
                                                    <div class="card-body">
                                                        ...
                                                        @foreach ($formSntChecklistPerawatanIncinerator456Mingguans as $key => $formSntChecklistPerawatanIncinerator456Mingguan)
                                                            @if ($formSntChecklistPerawatanIncinerator456Mingguan->incinerator == 'INCINERATOR NOMER 4')
                                                                @if ($formSntChecklistPerawatanIncinerator456Mingguan->group == 'SCRUBBER PUMP')
                                                                    <div class="row">
                                                                        <span
                                                                            class="col-12 d-flex justify-content-center fw-bolder">Kondisi</span>
                                                                        <div
                                            ...
                                            <div class="card">
                                                ...
                                                <div id="collapseSeat4" class="collapse" aria-labelledby="1"
                                                    ...
                                                    <div class="card-body">
                                                        ...
                                                        @foreach ($formSntChecklistPerawatanIncinerator456Mingguans as $key => $formSntChecklistPerawatanIncinerator456Mingguan)
                                                            @if ($formSntChecklistPerawatanIncinerator456Mingguan->incinerator == 'INCINERATOR NOMER 4')
                                                                @if ($formSntChecklistPerawatanIncinerator456Mingguan->group == 'MOTOR GEARBOX ROTARY')
                                                                    <div class="row">
                                                                        <span
                                                                            class="col-12 d-flex justify-content-center fw-bolder">Kondisi</span>
                                                                        <div
                                            ...
                                            <div class="card">
                                                ...
                                                <div id="collapseSeat5" class="collapse" aria-labelledby="1"
                                                    ...
                                                    <div class="card-body">
                                                        ...
                                                        @foreach ($formSntChecklistPerawatanIncinerator456Mingguans as $key => $formSntChecklistPerawatanIncinerator456Mingguan)
                                                            @if ($formSntChecklistPerawatanIncinerator456Mingguan->incinerator == 'INCINERATOR NOMER 4')
                                                                @if ($formSntChecklistPerawatanIncinerator456Mingguan->group == 'MOTOR CONVEYOR')
                                                                    <div class="row">
                                                                        <span
                                                                            class="col-12 d-flex justify-content-center fw-bolder">Kondisi</span>
                                                                        <div
                                            ...
                                            <div class="card">
                                                ...
                                                <div id="collapseSeat6" class="collapse" aria-labelledby="1"
                                                    ...
                                                    <div class="card-body">
                                                        ...
                                                        @foreach ($formSntChecklistPerawatanIncinerator456Mingguans as $key => $formSntChecklistPerawatanIncinerator456Mingguan)
                                                            @if ($formSntChecklistPerawatanIncinerator456Mingguan->incinerator == 'INCINERATOR NOMER 4')
                                                                @if ($formSntChecklistPerawatanIncinerator456Mingguan->group == 'MOTOR SCRUW')
                                                                    <div class="row">
                                                                        <span
                                                                            class="col-12 d-flex justify-content-center fw-bolder">Kondisi</span>
                                                                        <div
                                            ...
                                            <div class="card">
                                                ...
                                                <div id="collapseInce1" class="collapse" aria-labelledby="1"
                                                    ...
                                                    <div class="card-body">
                                                        @include('components.form-message')
                                                        @foreach ($formSntChecklistPerawatanIncinerator456Mingguans as $key => $formSntChecklistPerawatanIncinerator456Mingguan)
                                                            @if ($formSntChecklistPerawatanIncinerator456Mingguan->incinerator == 'INCINERATOR NOMER 5')
                                                                @if ($formSntChecklistPerawatanIncinerator456Mingguan->group == 'MECHANICAL LIFTER')
                                                                    <div class="row">
                                                                        <span
                                                                            class="col-12 d-flex justify-content-center fw-bolder">Kondisi</span>
                                                                        <div
                                            ...
                                            <div class="card">
                                                ...
                                                <div id="collapseInce2" class="collapse" aria-labelledby="1"
                                                    ...
                                                    <div class="card-body">
                                                        ...
                                                        @foreach ($formSntChecklistPerawatanIncinerator456Mingguans as $key => $formSntChecklistPerawatanIncinerator456Mingguan)
                                                            @if ($formSntChecklistPerawatanIncinerator456Mingguan->incinerator == 'INCINERATOR NOMER 5')
                                                                @if ($formSntChecklistPerawatanIncinerator456Mingguan->group == 'RUANG BAKAR I')
                                                                    <div class="row">
                                                                        <span
                                                                            class="col-12 d-flex justify-content-center fw-bolder">Kondisi</span>
                                                                        <div
                                            ...
                                            <div class="card">
                                                ...
                                                <div id="collapseInce3" class="collapse" aria-labelledby="1"
                                                    ...
                                                    <div class="card-body">
                                                        ...
                                                        @foreach ($formSntChecklistPerawatanIncinerator456Mingguans as $key => $formSntChecklistPerawatanIncinerator456Mingguan)
                                                            @if ($formSntChecklistPerawatanIncinerator456Mingguan->incinerator == 'INCINERATOR NOMER 5')
                                                                @if ($formSntChecklistPerawatanIncinerator456Mingguan->group == 'RUANG BAKAR II')
                                                                    <div class="row">
                                                                        <span
                                                                            class="col-12 d-flex justify-content-center fw-bolder">Kondisi</span>
                                                                        <div
                                            ...
                                            <div class="card">
                                                ...
                                                <div id="collapseInce8" class="collapse" aria-labelledby="1"
                                                    ...
                                                    <div class="card-body">
                                                        ...
                                                        @foreach ($formSntChecklistPerawatanIncinerator456Mingguans as $key => $formSntChecklistPerawatanIncinerator456Mingguan)
                                                            @if ($formSntChecklistPerawatanIncinerator456Mingguan->incinerator == 'INCINERATOR NOMER 5')
                                                                @if ($formSntChecklistPerawatanIncinerator456Mingguan->group == 'WET SCRUBBER')
                                                                    <div class="row">
                                                                        <span
                                                                            class="col-12 d-flex justify-content-center fw-bolder">Kondisi</span>
                                                                        <div
                                            ...
                                            <div class="card">
                                                ...
                                                <div id="collapseInce4" class="collapse" aria-labelledby="1"
                                                    ...
                                                    <div class="card-body">
                                                        ...
                                                        @foreach ($formSntChecklistPerawatanIncinerator456Mingguans as $key => $formSntChecklistPerawatanIncinerator456Mingguan)
                                                            @if ($formSntChecklistPerawatanIncinerator456Mingguan->incinerator == 'INCINERATOR NOMER 5')
                                                                @if ($formSntChecklistPerawatanIncinerator456Mingguan->group == 'CEROBONG')
                                                                    <div class="row">
                                                                        <span
                                                                            class="col-12 d-flex justify-content-center fw-bolder">Kondisi</span>
                                                                        <div
                                            ...
                                            <div class="card">
                                                ...
                                                <div id="collapseInce5" class="collapse" aria-labelledby="1"
                                                    ...
                                                    <div class="card-body">
                                                        ...
                                                        @foreach ($formSntChecklistPerawatanIncinerator456Mingguans as $key => $formSntChecklistPerawatanIncinerator456Mingguan)
                                                            @if ($formSntChecklistPerawatanIncinerator456Mingguan->incinerator == 'INCINERATOR NOMER 5')
                                                                @if ($formSntChecklistPerawatanIncinerator456Mingguan->group == 'LAMPU PENERANGAN')
                                                                    <div class="row">
                                                                        <span
                                                                            class="col-12 d-flex justify-content-center fw-bolder">Kondisi</span>
                                                                        <div
                                            ...
                                            <div class="card">
                                                ...
                                                <div id="collapseInce6" class="collapse" aria-labelledby="1"
                                                    ...
                                                    <div class="card-body">
                                                        ...
                                                        @foreach ($formSntChecklistPerawatanIncinerator456Mingguans as $key => $formSntChecklistPerawatanIncinerator456Mingguan)
                                                            @if ($formSntChecklistPerawatanIncinerator456Mingguan->incinerator == 'INCINERATOR NOMER 5')
                                                                @if ($formSntChecklistPerawatanIncinerator456Mingguan->group == 'POMPA SOLAR')
                                                                    <div class="row">
                                                                        <span
                                                                            class="col-12 d-flex justify-content-center fw-bolder">Kondisi</span>
                                                                        <div
                                            ...
                                            <div class="card">
                                                ...
                                                <div id="collapseInce7" class="collapse" aria-labelledby="1"
                                                    ...
                                                    <div class="card-body">
                                                        ...
                                                        @foreach ($formSntChecklistPerawatanIncinerator456Mingguans as $key => $formSntChecklistPerawatanIncinerator456Mingguan)
                                                            @if ($formSntChecklistPerawatanIncinerator456Mingguan->incinerator == 'INCINERATOR NOMER 5')
                                                                @if ($formSntChecklistPerawatanIncinerator456Mingguan->group == 'PANEL KONTROL')
                                                                    <div class="row">
                                                                        <span
                                                                            class="col-12 d-flex justify-content-center fw-bolder">Kondisi</span>
                                                                        <div
                                            ...
                                            <div class="card">
                                                ...
                                                <div id="collapseIncenerator1" class="collapse" aria-labelledby="1"
                                                    ...
                                                    <div class="card-body">
                                                        @include('components.form-message')
                                                        @foreach ($formSntChecklistPerawatanIncinerator456Mingguans as $key => $formSntChecklistPerawatanIncinerator456Mingguan)
                                                            @if ($formSntChecklistPerawatanIncinerator456Mingguan->incinerator == 'INCINERATOR NOMER 6')
                                                                @if ($formSntChecklistPerawatanIncinerator456Mingguan->group == 'MECHANICAL LIFTER')
                                                                    <div class="row">
                                                                        <span
                                                                            class="col-12 d-flex justify-content-center fw-bolder">Kondisi</span>
