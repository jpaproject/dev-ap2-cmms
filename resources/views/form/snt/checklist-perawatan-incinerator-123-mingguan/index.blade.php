...
@section('content')
    <section class="content">
        <form method="POST"
            action="{{ route('form.snt.checklist-perawatan-incinerator-123-mingguan.update', $detailWorkOrderForm) }}"
            ...
            @if ($formSntChecklistPerawatanIncinerator123Mingguans->isNotEmpty())
                ...
                <div class="container-fluid">
                    <div class="accordion" id="accordionSeatMajor1">
                        <div class="card">
                            <div class="card-header" id="SeatMajor1">
                                <h2 class="mb-0">
                                    <button class="bg-primary btn btn-link btn-block text-left" type="button"
                                        data-toggle="collapse" data-target="#collapseSeatMajor1" aria-expanded="true"
                                        aria-controls="collapseSeatMajor1" onclick="showHide(this)">
                            ...
                            <div id="collapseSeatMajor1" class="collapse" aria-labelledby="1"
                                data-parent="#accordionSeatMajor1">
                                <div class="card-body">
                                    {{-- MECHANICAL LIFTER --}}
                                    <div class="container-fluid">
                                                ...
                                                <div id="collapseSeat1" class="collapse" aria-labelledby="1"
                                                    ...
                                                    <div class="card-body">
                                                        ...
                                                        @foreach ($formSntChecklistPerawatanIncinerator123Mingguans as $key => $formSntChecklistPerawatanIncinerator123Mingguan)
                                                            @if ($formSntChecklistPerawatanIncinerator123Mingguan->incinerator == 'INCINERATOR NOMER 1')
                                                                @if ($formSntChecklistPerawatanIncinerator123Mingguan->group == 'MECHANICAL LIFTER')
                                                                    <div class="row">
                                                                        <span
                                                                        ...
                                                                        <div
                                                                            ...
                                                                            <h5>
                                                                                {{ $formSntChecklistPerawatanIncinerator123Mingguan->nama_peralatan }}
                                                                            </h5>
                                                                        </div>
                                                                        <div class="col-6">
                                                                            <div class="form-group">
                                                                                ...
                                                                                <select
                                                                                    ...
                                                                                    <option value="BAIK"
                                                                                        {{ old('kondisi.' . $key) ?? $formSntChecklistPerawatanIncinerator123Mingguan->kondisi == 'BAIK' ? 'selected' : '' }}>
                                                                                        BAIK</option>
                                                                                    <option value="TROUBLE"
                                                                                        {{ old('kondisi.' . $key) ?? $formSntChecklistPerawatanIncinerator123Mingguan->kondisi == 'TROUBLE' ? 'selected' : '' }}>
                                                                                        TROUBLE</option>
                                                                                </select>
                                            ...
                                            <div class="card">
                                                ...
                                                <div id="collapseSeat2" class="collapse" aria-labelledby="1"
                                                    ...
                                                    <div class="card-body">
                                                        ...
                                                        @foreach ($formSntChecklistPerawatanIncinerator123Mingguans as $key => $formSntChecklistPerawatanIncinerator123Mingguan)
                                                            @if ($formSntChecklistPerawatanIncinerator123Mingguan->incinerator == 'INCINERATOR NOMER 1')
                                                                @if ($formSntChecklistPerawatanIncinerator123Mingguan->group == 'RUANG BAKAR I')
                                                                    <div class="row">
                                                                        <span
                                                                            class="col-12 d-flex justify-content-center fw-bolder">Kondisi</span>
                                                                        <div
                                            ...
                                            <div class="card">
                                                ...
                                                <div id="collapseSeat3" class="collapse" aria-labelledby="1"
                                                    ...
                                                    <div class="card-body">
                                                        ...
                                                        @foreach ($formSntChecklistPerawatanIncinerator123Mingguans as $key => $formSntChecklistPerawatanIncinerator123Mingguan)
                                                            @if ($formSntChecklistPerawatanIncinerator123Mingguan->incinerator == 'INCINERATOR NOMER 1')
                                                                @if ($formSntChecklistPerawatanIncinerator123Mingguan->group == 'RUANG BAKAR II')
                                                                    <div class="row">
                                                                        <span
                                                                            class="col-12 d-flex justify-content-center fw-bolder">Kondisi</span>
                                                                        <div
                                            ...
                                            <div class="card">
                                                ...
                                                <div id="collapseSeat4" class="collapse" aria-labelledby="1"
                                                    ...
                                                    <div class="card-body">
                                                        ...
                                                        @foreach ($formSntChecklistPerawatanIncinerator123Mingguans as $key => $formSntChecklistPerawatanIncinerator123Mingguan)
                                                            @if ($formSntChecklistPerawatanIncinerator123Mingguan->incinerator == 'INCINERATOR NOMER 1')
                                                                @if ($formSntChecklistPerawatanIncinerator123Mingguan->group == 'CEROBONG' )
                                                                    <div class="row">
                                                                        <span
                                                                            class="col-12 d-flex justify-content-center fw-bolder">Kondisi</span>
                                                                        <div
                                            ...
                                            <div class="card">
                                                ...
                                                <div id="collapseSeat5" class="collapse" aria-labelledby="1"
                                                    ...
                                                    <div class="card-body">
                                                        ...
                                                        @foreach ($formSntChecklistPerawatanIncinerator123Mingguans as $key => $formSntChecklistPerawatanIncinerator123Mingguan)
                                                            @if ($formSntChecklistPerawatanIncinerator123Mingguan->incinerator == 'INCINERATOR NOMER 1')
                                                                @if ($formSntChecklistPerawatanIncinerator123Mingguan->group == 'LAMPU PENERANGAN')
                                                                    <div class="row">
                                                                        <span
                                                                            class="col-12 d-flex justify-content-center fw-bolder">Kondisi</span>
                                                                        <div
                                            ...
                                            <div class="card">
                                                ...
                                                <div id="collapseSeat6" class="collapse" aria-labelledby="1"
                                                    ...
                                                    <div class="card-body">
                                                        ...
                                                        @foreach ($formSntChecklistPerawatanIncinerator123Mingguans as $key => $formSntChecklistPerawatanIncinerator123Mingguan)
                                                            @if ($formSntChecklistPerawatanIncinerator123Mingguan->incinerator == 'INCINERATOR NOMER 1')
                                                                @if ($formSntChecklistPerawatanIncinerator123Mingguan->group == 'POMPA SOLAR')
                                                                    <div class="row">
                                                                        <span
                                                                            class="col-12 d-flex justify-content-center fw-bolder">Kondisi</span>
                                                                        <div
                                        ...
                                        <div class="accordion" id="accordionSeat7">
                                            <div class="card">
                                                <div class="card-header" id="Seat7">
                                                    <h2 class="mb-0">
                                                        <button class="btn btn-link btn-block text-left" type="button"
                                                            data-toggle="collapse" data-target="#collapseSeat7"
                                                            aria-expanded="true" aria-controls="collapseSeat7"
                                                            onclick="showHide(this)">
                                                            <i class="fas fa-chevron-up d-flex justify-content-end"
                                                                id="accordion"></i>
                                                            PANEL KONTROL
                                                ...
                                                <div id="collapseSeat7" class="collapse" aria-labelledby="1"
                                                    data-parent="#accordionSeat7">
                                                    <div class="card-body">
                                                        @include('components.form-message')
                                                        @foreach ($formSntChecklistPerawatanIncinerator123Mingguans as $key => $formSntChecklistPerawatanIncinerator123Mingguan)
                                                            @if ($formSntChecklistPerawatanIncinerator123Mingguan->incinerator == 'INCINERATOR NOMER 1')
                                                                @if ($formSntChecklistPerawatanIncinerator123Mingguan->group == 'PANEL KONTROL')
                                                                    <div class="row">
                                                                        <span
                                                                            class="col-12 d-flex justify-content-center fw-bolder">Kondisi</span>
                                                                        <div
                                            ...
                                            <div class="card">
                                                ...
                                                <div id="collapseInce1" class="collapse" aria-labelledby="1"
                                                    ...
                                                    <div class="card-body">
                                                        @include('components.form-message')
                                                        @foreach ($formSntChecklistPerawatanIncinerator123Mingguans as $key => $formSntChecklistPerawatanIncinerator123Mingguan)
                                                            @if ($formSntChecklistPerawatanIncinerator123Mingguan->incinerator == 'INCINERATOR NOMER 2')
                                                                @if ($formSntChecklistPerawatanIncinerator123Mingguan->group == 'MECHANICAL LIFTER')
                                                                    <div class="row">
                                                                        <span
                                                                            class="col-12 d-flex justify-content-center fw-bolder">Kondisi</span>
                                            ...
                                            <div class="card">
                                                ...
                                                <div id="collapseInce8" class="collapse" aria-labelledby="1"
                                                    ...
                                                    <div class="card-body">
                                                        ...
                                                        @foreach ($formSntChecklistPerawatanIncinerator123Mingguans as $key => $formSntChecklistPerawatanIncinerator123Mingguan)
                                                            @if ($formSntChecklistPerawatanIncinerator123Mingguan->incinerator == 'INCINERATOR NOMER 2')
                                                                @if ($formSntChecklistPerawatanIncinerator123Mingguan->group == 'WET SCRUBBER')
                                                                    <div class="row">
                                                                        <span
                                                                            class="col-12 d-flex justify-content-center fw-bolder">Kondisi</span>
                                                                        <div
                                            ...
                                            <div class="card">
                                                ...
                                                <div id="collapseIncenerator1" class="collapse" aria-labelledby="1"
                                                    ...
                                                    <div class="card-body">
                                                        @include('components.form-message')
                                                        @foreach ($formSntChecklistPerawatanIncinerator123Mingguans as $key => $formSntChecklistPerawatanIncinerator123Mingguan)
                                                            @if ($formSntChecklistPerawatanIncinerator123Mingguan->incinerator == 'INCINERATOR NOMER 3')
                                                                @if ($formSntChecklistPerawatanIncinerator123Mingguan->group == 'BELT CONVEYOR')
                                                                    <div class="row">
                                                                        <span
                                                                            class="col-12 d-flex justify-content-center fw-bolder">Kondisi</span>
                                                                        <div
                                            ...
                                            <div class="card">
                                                ...
                                                <div id="collapseIncenerator2" class="collapse" aria-labelledby="1"
                                                    ...
                                                    <div class="card-body">
                                                        ...
                                                        @foreach ($formSntChecklistPerawatanIncinerator123Mingguans as $key => $formSntChecklistPerawatanIncinerator123Mingguan)
                                                            @if ($formSntChecklistPerawatanIncinerator123Mingguan->incinerator == 'INCINERATOR NOMER 3')
                                                                @if ($formSntChecklistPerawatanIncinerator123Mingguan->group == 'FIRST ROTARY CHAMBER')
                                                                    <div class="row">
                                                                        <span
                                                                            class="col-12 d-flex justify-content-center fw-bolder">Kondisi</span>
                                                                        <div
                                            ...
                                            <div class="card">
                                                ...
                                                <div id="collapseIncenerator3" class="collapse" aria-labelledby="1"
                                                    ...
                                                    <div class="card-body">
                                                        ...
                                                        @foreach ($formSntChecklistPerawatanIncinerator123Mingguans as $key => $formSntChecklistPerawatanIncinerator123Mingguan)
                                                            @if ($formSntChecklistPerawatanIncinerator123Mingguan->incinerator == 'INCINERATOR NOMER 3')
                                                                @if ($formSntChecklistPerawatanIncinerator123Mingguan->group == 'SECOND CHAMBER')
                                                                    <div class="row">
                                                                        <span
                                                                            class="col-12 d-flex justify-content-center fw-bolder">Kondisi</span>
                                                                        <div
