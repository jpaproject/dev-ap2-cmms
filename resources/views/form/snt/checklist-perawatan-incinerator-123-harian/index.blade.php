...
@section('content')
    <section class="content">
        <form method="POST"
            action="{{ route('form.snt.checklist-perawatan-incinerator-123-harian.update', $detailWorkOrderForm) }}"
                                                ...
                                                <div id="collapseSeat1" class="collapse" aria-labelledby="1"
                                                    ...
                                                    <div class="card-body">
                                                        ...
                                                        @foreach ($formSntChecklistPerawatanIncinerator123Harians as $key => $formSntChecklistPerawatanIncinerator123Harian)
                                                            @if ($formSntChecklistPerawatanIncinerator123Harian->incinerator == 'INCINERATOR NOMER 1')
                                                                @if ($formSntChecklistPerawatanIncinerator123Harian->group == 'MECHANICAL LIFTER')
                                                                    <div class="row">
                                                                        <span
                                                                        ...
                                                                        <div
                                                                            ...
                                                                            <h5>
                                                                                {{ $formSntChecklistPerawatanIncinerator123Harian->nama_peralatan }}
                                                                            </h5>
                                                                        </div>
                                                                        <div class="col-6">
                                                                            <div class="form-group">
                                                                                ...
                                                                                <select
                                                                                    ...
                                                                                    <option value="BAIK"
                                                                                        {{ old('kondisi.' . $key) ?? $formSntChecklistPerawatanIncinerator123Harian->kondisi == 'BAIK' ? 'selected' : '' }}>
                                                                                        BAIK</option>
                                                                                    <option value="TROUBLE"
                                                                                        {{ old('kondisi.' . $key) ?? $formSntChecklistPerawatanIncinerator123Harian->kondisi == 'TROUBLE' ? 'selected' : '' }}>
                                                                                        TROUBLE</option>
                                                                                </select>
                                            ...
                                            <div class="card">
                                                ...
                                                <div id="collapseSeat2" class="collapse" aria-labelledby="1"
                                                    ...
                                                    <div class="card-body">
                                                        ...
                                                        @foreach ($formSntChecklistPerawatanIncinerator123Harians as $key => $formSntChecklistPerawatanIncinerator123Harian)
                                                            @if ($formSntChecklistPerawatanIncinerator123Harian->incinerator == 'INCINERATOR NOMER 1')
                                                                @if ($formSntChecklistPerawatanIncinerator123Harian->group == 'RUANG BAKAR I')
                                                                    <div class="row">
                                                                        <span
                                                                            class="col-12 d-flex justify-content-center fw-bolder">Kondisi</span>
                                                                        <div
                                            ...
                                            <div class="card">
                                                ...
                                                <div id="collapseSeat3" class="collapse" aria-labelledby="1"
                                                    ...
                                                    <div class="card-body">
                                                        ...
                                                        @foreach ($formSntChecklistPerawatanIncinerator123Harians as $key => $formSntChecklistPerawatanIncinerator123Harian)
                                                            @if ($formSntChecklistPerawatanIncinerator123Harian->incinerator == 'INCINERATOR NOMER 1')
                                                                @if ($formSntChecklistPerawatanIncinerator123Harian->group == 'RUANG BAKAR II')
                                                                    <div class="row">
                                                                        <span
                                                                            class="col-12 d-flex justify-content-center fw-bolder">Kondisi</span>
                                                                        <div
                                            ...
                                            <div class="card">
                                                ...
                                                <div id="collapseSeat4" class="collapse" aria-labelledby="1"
                                                    ...
                                                    <div class="card-body">
                                                        ...
                                                        @foreach ($formSntChecklistPerawatanIncinerator123Harians as $key => $formSntChecklistPerawatanIncinerator123Harian)
                                                            @if ($formSntChecklistPerawatanIncinerator123Harian->incinerator == 'INCINERATOR NOMER 1')
                                                                @if ($formSntChecklistPerawatanIncinerator123Harian->group == 'CEROBONG' )
                                                                    <div class="row">
                                                                        <span
                                                                            class="col-12 d-flex justify-content-center fw-bolder">Kondisi</span>
                                                                        <div
                                            ...
                                            <div class="card">
                                                ...
                                                <div id="collapseSeat5" class="collapse" aria-labelledby="1"
                                                    ...
                                                    <div class="card-body">
                                                        ...
                                                        @foreach ($formSntChecklistPerawatanIncinerator123Harians as $key => $formSntChecklistPerawatanIncinerator123Harian)
                                                            @if ($formSntChecklistPerawatanIncinerator123Harian->incinerator == 'INCINERATOR NOMER 1')
                                                                @if ($formSntChecklistPerawatanIncinerator123Harian->group == 'LAMPU PENERANGAN')
                                                                    <div class="row">
                                                                        <span
                                                                            class="col-12 d-flex justify-content-center fw-bolder">Kondisi</span>
                                                                        <div
                                            ...
                                            <div class="card">
                                                ...
                                                <div id="collapseSeat6" class="collapse" aria-labelledby="1"
                                                    ...
                                                    <div class="card-body">
                                                        ...
                                                        @foreach ($formSntChecklistPerawatanIncinerator123Harians as $key => $formSntChecklistPerawatanIncinerator123Harian)
                                                            @if ($formSntChecklistPerawatanIncinerator123Harian->incinerator == 'INCINERATOR NOMER 1')
                                                                @if ($formSntChecklistPerawatanIncinerator123Harian->group == 'POMPA SOLAR')
                                                                    <div class="row">
                                                                        <span
                                                                            class="col-12 d-flex justify-content-center fw-bolder">Kondisi</span>
                                                                        <div
                                            ...
                                            <div class="card">
                                                ...
                                                <div id="collapseSeat7" class="collapse" aria-labelledby="1"
                                                    ...
                                                    <div class="card-body">
                                                        ...
                                                        @foreach ($formSntChecklistPerawatanIncinerator123Harians as $key => $formSntChecklistPerawatanIncinerator123Harian)
                                                            @if ($formSntChecklistPerawatanIncinerator123Harian->incinerator == 'INCINERATOR NOMER 1')
                                                                @if ($formSntChecklistPerawatanIncinerator123Harian->group == 'PANEL KONTROL')
                                                                    <div class="row">
                                                                        <span
                                                                            class="col-12 d-flex justify-content-center fw-bolder">Kondisi</span>
                                                                        <div
                                            ...
                                            <div class="card">
                                                ...
                                                <div id="collapseInce1" class="collapse" aria-labelledby="1"
                                                    ...
                                                    <div class="card-body">
                                                        @include('components.form-message')
                                                        @foreach ($formSntChecklistPerawatanIncinerator123Harians as $key => $formSntChecklistPerawatanIncinerator123Harian)
                                                            @if ($formSntChecklistPerawatanIncinerator123Harian->incinerator == 'INCINERATOR NOMER 2')
                                                                @if ($formSntChecklistPerawatanIncinerator123Harian->group == 'MECHANICAL LIFTER')
                                                                    <div class="row">
                                                                        <span
                                                                            class="col-12 d-flex justify-content-center fw-bolder">Kondisi</span>
                                            ...
                                            <div class="card">
                                                ...
                                                <div id="collapseInce8" class="collapse" aria-labelledby="1"
                                                    ...
                                                    <div class="card-body">
                                                        ...
                                                        @foreach ($formSntChecklistPerawatanIncinerator123Harians as $key => $formSntChecklistPerawatanIncinerator123Harian)
                                                            @if ($formSntChecklistPerawatanIncinerator123Harian->incinerator == 'INCINERATOR NOMER 2')
                                                                @if ($formSntChecklistPerawatanIncinerator123Harian->group == 'WET SCRUBBER')
                                                                    <div class="row">
                                                                        <span
                                                                            class="col-12 d-flex justify-content-center fw-bolder">Kondisi</span>
                                                                        <div
                                            ...
                                            <div class="card">
                                                ...
                                                <div id="collapseIncenerator1" class="collapse" aria-labelledby="1"
                                                    ...
                                                    <div class="card-body">
                                                        @include('components.form-message')
                                                        @foreach ($formSntChecklistPerawatanIncinerator123Harians as $key => $formSntChecklistPerawatanIncinerator123Harian)
                                                            @if ($formSntChecklistPerawatanIncinerator123Harian->incinerator == 'INCINERATOR NOMER 4')
                                                                @if ($formSntChecklistPerawatanIncinerator123Harian->group == 'BELT CONVEYOR')
                                                                    <div class="row">
                                                                        <span
                                                                            class="col-12 d-flex justify-content-center fw-bolder">Kondisi</span>
                                                                        <div
                                            ...
                                            <div class="card">
                                                ...
                                                <div id="collapseIncenerator2" class="collapse" aria-labelledby="1"
                                                    ...
                                                    <div class="card-body">
                                                        ...
                                                        @foreach ($formSntChecklistPerawatanIncinerator123Harians as $key => $formSntChecklistPerawatanIncinerator123Harian)
                                                            @if ($formSntChecklistPerawatanIncinerator123Harian->incinerator == 'INCINERATOR NOMER 4')
                                                                @if ($formSntChecklistPerawatanIncinerator123Harian->group == 'FIRST ROTARY CHAMBER')
                                                                    <div class="row">
                                                                        <span
                                                                            class="col-12 d-flex justify-content-center fw-bolder">Kondisi</span>
                                                                        <div
                                            ...
                                            <div class="card">
                                                ...
                                                <div id="collapseIncenerator3" class="collapse" aria-labelledby="1"
                                                    ...
                                                    <div class="card-body">
                                                        ...
                                                        @foreach ($formSntChecklistPerawatanIncinerator123Harians as $key => $formSntChecklistPerawatanIncinerator123Harian)
                                                            @if ($formSntChecklistPerawatanIncinerator123Harian->incinerator == 'INCINERATOR NOMER 4')
                                                                @if ($formSntChecklistPerawatanIncinerator123Harian->group == 'SECOND CHAMBER')
                                                                    <div class="row">
                                                                        <span
                                                                            class="col-12 d-flex justify-content-center fw-bolder">Kondisi</span>
                                                                        <div
