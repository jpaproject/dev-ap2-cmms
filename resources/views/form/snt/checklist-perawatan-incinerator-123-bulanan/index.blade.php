...
@section('content')
    <section class="content">
        <form method="POST"
            action="{{ route('form.snt.checklist-perawatan-incinerator-123-bulanan.update', $detailWorkOrderForm) }}"
                                                ...
                                                <div id="collapseSeat1" class="collapse" aria-labelledby="1"
                                                    ...
                                                    <div class="card-body">
                                                        ...
                                                        @foreach ($formSntChecklistPerawatanIncinerator123Bulanans as $key => $formSntChecklistPerawatanIncinerator123Bulanan)
                                                            @if ($formSntChecklistPerawatanIncinerator123Bulanan->incinerator == 'INCINERATOR NOMER 1')
                                                                @if ($formSntChecklistPerawatanIncinerator123Bulanan->group == 'MECHANICAL LIFTER')
                                                                    <div class="row">
                                                                        <span
                                                                        ...
                                                                        <div
                                                                            ...
                                                                            <h5>
                                                                                {{ $formSntChecklistPerawatanIncinerator123Bulanan->nama_peralatan }}
                                                                            </h5>
                                                                        </div>
                                                                        <div class="col-6">
                                                                            <div class="form-group">
                                                                                ...
                                                                                <select
                                                                                    ...
                                                                                    <option value="BAIK"
                                                                                        {{ old('kondisi.' . $key) ?? $formSntChecklistPerawatanIncinerator123Bulanan->kondisi == 'BAIK' ? 'selected' : '' }}>
                                                                                        BAIK</option>
                                                                                    <option value="TROUBLE"
                                                                                        {{ old('kondisi.' . $key) ?? $formSntChecklistPerawatanIncinerator123Bulanan->kondisi == 'TROUBLE' ? 'selected' : '' }}>
                                                                                        TROUBLE</option>
                                                                                </select>
                                            ...
                                            <div class="card">
                                                ...
                                                <div id="collapseSeat2" class="collapse" aria-labelledby="1"
                                                    ...
                                                    <div class="card-body">
                                                        ...
                                                        @foreach ($formSntChecklistPerawatanIncinerator123Bulanans as $key => $formSntChecklistPerawatanIncinerator123Bulanan)
                                                            @if ($formSntChecklistPerawatanIncinerator123Bulanan->incinerator == 'INCINERATOR NOMER 1')
                                                                @if ($formSntChecklistPerawatanIncinerator123Bulanan->group == 'RUANG BAKAR I')
                                                                    <div class="row">
                                                                        <span
                                                                            class="col-12 d-flex justify-content-center fw-bolder">Kondisi</span>
                                                                        <div
                                            ...
                                            <div class="card">
                                                ...
                                                <div id="collapseSeat3" class="collapse" aria-labelledby="1"
                                                    ...
                                                    <div class="card-body">
                                                        ...
                                                        @foreach ($formSntChecklistPerawatanIncinerator123Bulanans as $key => $formSntChecklistPerawatanIncinerator123Bulanan)
                                                            @if ($formSntChecklistPerawatanIncinerator123Bulanan->incinerator == 'INCINERATOR NOMER 1')
                                                                @if ($formSntChecklistPerawatanIncinerator123Bulanan->group == 'RUANG BAKAR II')
                                                                    <div class="row">
                                                                        <span
                                                                            class="col-12 d-flex justify-content-center fw-bolder">Kondisi</span>
                                                                        <div
                                            ...
                                            <div class="card">
                                                ...
                                                <div id="collapseSeat4" class="collapse" aria-labelledby="1"
                                                    ...
                                                    <div class="card-body">
                                                        ...
                                                        @foreach ($formSntChecklistPerawatanIncinerator123Bulanans as $key => $formSntChecklistPerawatanIncinerator123Bulanan)
                                                            @if ($formSntChecklistPerawatanIncinerator123Bulanan->incinerator == 'INCINERATOR NOMER 1')
                                                                @if ($formSntChecklistPerawatanIncinerator123Bulanan->group == 'CEROBONG' )
                                                                    <div class="row">
                                                                        <span
                                                                            class="col-12 d-flex justify-content-center fw-bolder">Kondisi</span>
                                                                        <div
                                            ...
                                            <div class="card">
                                                ...
                                                <div id="collapseSeat5" class="collapse" aria-labelledby="1"
                                                    ...
                                                    <div class="card-body">
                                                        ...
                                                        @foreach ($formSntChecklistPerawatanIncinerator123Bulanans as $key => $formSntChecklistPerawatanIncinerator123Bulanan)
                                                            @if ($formSntChecklistPerawatanIncinerator123Bulanan->incinerator == 'INCINERATOR NOMER 1')
                                                                @if ($formSntChecklistPerawatanIncinerator123Bulanan->group == 'LAMPU PENERANGAN')
                                                                    <div class="row">
                                                                        <span
                                                                            class="col-12 d-flex justify-content-center fw-bolder">Kondisi</span>
                                                                        <div
                                            ...
                                            <div class="card">
                                                ...
                                                <div id="collapseSeat6" class="collapse" aria-labelledby="1"
                                                    ...
                                                    <div class="card-body">
                                                        ...
                                                        @foreach ($formSntChecklistPerawatanIncinerator123Bulanans as $key => $formSntChecklistPerawatanIncinerator123Bulanan)
                                                            @if ($formSntChecklistPerawatanIncinerator123Bulanan->incinerator == 'INCINERATOR NOMER 1')
                                                                @if ($formSntChecklistPerawatanIncinerator123Bulanan->group == 'POMPA SOLAR')
                                                                    <div class="row">
                                                                        <span
                                                                            class="col-12 d-flex justify-content-center fw-bolder">Kondisi</span>
                                                                        <div
                                            ...
                                            <div class="card">
                                                ...
                                                <div id="collapseSeat7" class="collapse" aria-labelledby="1"
                                                    ...
                                                    <div class="card-body">
                                                        ...
                                                        @foreach ($formSntChecklistPerawatanIncinerator123Bulanans as $key => $formSntChecklistPerawatanIncinerator123Bulanan)
                                                            @if ($formSntChecklistPerawatanIncinerator123Bulanan->incinerator == 'INCINERATOR NOMER 1')
                                                                @if ($formSntChecklistPerawatanIncinerator123Bulanan->group == 'PANEL KONTROL')
                                                                    <div class="row">
                                                                        <span
                                                                            class="col-12 d-flex justify-content-center fw-bolder">Kondisi</span>
                                                                        <div
                                            ...
                                            <div class="card">
                                                ...
                                                <div id="collapseInce1" class="collapse" aria-labelledby="1"
                                                    ...
                                                    <div class="card-body">
                                                        @include('components.form-message')
                                                        @foreach ($formSntChecklistPerawatanIncinerator123Bulanans as $key => $formSntChecklistPerawatanIncinerator123Bulanan)
                                                            @if ($formSntChecklistPerawatanIncinerator123Bulanan->incinerator == 'INCINERATOR NOMER 2')
                                                                @if ($formSntChecklistPerawatanIncinerator123Bulanan->group == 'MECHANICAL LIFTER')
                                                                    <div class="row">
                                                                        <span
                                                                            class="col-12 d-flex justify-content-center fw-bolder">Kondisi</span>
                                            ...
                                            <div class="card">
                                                ...
                                                <div id="collapseInce8" class="collapse" aria-labelledby="1"
                                                    ...
                                                    <div class="card-body">
                                                        ...
                                                        @foreach ($formSntChecklistPerawatanIncinerator123Bulanans as $key => $formSntChecklistPerawatanIncinerator123Bulanan)
                                                            @if ($formSntChecklistPerawatanIncinerator123Bulanan->incinerator == 'INCINERATOR NOMER 2')
                                                                @if ($formSntChecklistPerawatanIncinerator123Bulanan->group == 'WET SCRUBBER')
                                                                    <div class="row">
                                                                        <span
                                                                            class="col-12 d-flex justify-content-center fw-bolder">Kondisi</span>
                                                                        <div
                                            ...
                                            <div class="card">
                                                ...
                                                <div id="collapseIncenerator1" class="collapse" aria-labelledby="1"
                                                    ...
                                                    <div class="card-body">
                                                        @include('components.form-message')
                                                        @foreach ($formSntChecklistPerawatanIncinerator123Bulanans as $key => $formSntChecklistPerawatanIncinerator123Bulanan)
                                                            @if ($formSntChecklistPerawatanIncinerator123Bulanan->incinerator == 'INCINERATOR NOMER 3')
                                                                @if ($formSntChecklistPerawatanIncinerator123Bulanan->group == 'BELT CONVEYOR')
                                                                    <div class="row">
                                                                        <span
                                                                            class="col-12 d-flex justify-content-center fw-bolder">Kondisi</span>
                                                                        <div
                                            ...
                                            <div class="card">
                                                ...
                                                <div id="collapseIncenerator2" class="collapse" aria-labelledby="1"
                                                    ...
                                                    <div class="card-body">
                                                        ...
                                                        @foreach ($formSntChecklistPerawatanIncinerator123Bulanans as $key => $formSntChecklistPerawatanIncinerator123Bulanan)
                                                            @if ($formSntChecklistPerawatanIncinerator123Bulanan->incinerator == 'INCINERATOR NOMER 3')
                                                                @if ($formSntChecklistPerawatanIncinerator123Bulanan->group == 'FIRST ROTARY CHAMBER')
                                                                    <div class="row">
                                                                        <span
                                                                            class="col-12 d-flex justify-content-center fw-bolder">Kondisi</span>
                                                                        <div
                                            ...
                                            <div class="card">
                                                ...
                                                <div id="collapseIncenerator3" class="collapse" aria-labelledby="1"
                                                    ...
                                                    <div class="card-body">
                                                        ...
                                                        @foreach ($formSntChecklistPerawatanIncinerator123Bulanans as $key => $formSntChecklistPerawatanIncinerator123Bulanan)
                                                            @if ($formSntChecklistPerawatanIncinerator123Bulanan->incinerator == 'INCINERATOR NOMER 3')
                                                                @if ($formSntChecklistPerawatanIncinerator123Bulanan->group == 'SECOND CHAMBER')
                                                                    <div class="row">
                                                                        <span
                                                                            class="col-12 d-flex justify-content-center fw-bolder">Kondisi</span>
                                                                        <div
