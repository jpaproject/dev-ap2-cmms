...
@section('content')
    <section class="content">
        <form method="POST"
            action="{{ route('form.snt.checklist-perawatan-incinerator-567-harian.update', $detailWorkOrderForm) }}"
                                                ...
                                                <div id="collapseInce1" class="collapse" aria-labelledby="1"
                                                    ...
                                                    <div class="card-body">
                                                        ...
                                                        @foreach ($formSntChecklistPerawatanIncinerator567Harians as $key => $formSntChecklistPerawatanIncinerator567Harian)
                                                            @if ($formSntChecklistPerawatanIncinerator567Harian->incinerator == 'INCINERATOR NOMER 5')
                                                                @if ($formSntChecklistPerawatanIncinerator567Harian->group == 'MECHANICAL LIFTER')
                                                                    <div class="row">
                                                                        <span
                                                                        ...
                                                                        <div
                                                                            ...
                                                                            <h5>
                                                                                {{ $formSntChecklistPerawatanIncinerator567Harian->nama_peralatan }}
                                                                            </h5>
                                                                        </div>
                                                                        <div class="col-6">
                                                                            <div class="form-group">
                                                                                ...
                                                                                <select
                                                                                    ...
                                                                                    <option value="BAIK"
                                                                                        {{ old('kondisi.' . $key) ?? $formSntChecklistPerawatanIncinerator567Harian->kondisi == 'BAIK' ? 'selected' : '' }}>
                                                                                        BAIK</option>
                                                                                    <option value="TROUBLE"
                                                                                        {{ old('kondisi.' . $key) ?? $formSntChecklistPerawatanIncinerator567Harian->kondisi == 'TROUBLE' ? 'selected' : '' }}>
                                                                                        TROUBLE</option>
                                                                                </select>
                                            ...
                                            <div class="card">
                                                ...
                                                <div id="collapseInce2" class="collapse" aria-labelledby="1"
                                                    ...
                                                    <div class="card-body">
                                                        ...
                                                        @foreach ($formSntChecklistPerawatanIncinerator567Harians as $key => $formSntChecklistPerawatanIncinerator567Harian)
                                                            @if ($formSntChecklistPerawatanIncinerator567Harian->incinerator == 'INCINERATOR NOMER 5')
                                                                @if ($formSntChecklistPerawatanIncinerator567Harian->group == 'RUANG BAKAR I')
                                                                    <div class="row">
                                                                        <span
                                                                            class="col-12 d-flex justify-content-center fw-bolder">Kondisi</span>
                                                                        <div
                                            ...
                                            <div class="card">
                                                ...
                                                <div id="collapseInce3" class="collapse" aria-labelledby="1"
                                                    ...
                                                    <div class="card-body">
                                                        ...
                                                        @foreach ($formSntChecklistPerawatanIncinerator567Harians as $key => $formSntChecklistPerawatanIncinerator567Harian)
                                                            @if ($formSntChecklistPerawatanIncinerator567Harian->incinerator == 'INCINERATOR NOMER 5')
                                                                @if ($formSntChecklistPerawatanIncinerator567Harian->group == 'RUANG BAKAR II')
                                                                    <div class="row">
                                                                        <span
                                                                            class="col-12 d-flex justify-content-center fw-bolder">Kondisi</span>
                                                                        <div
                                            ...
                                            <div class="card">
                                                ...
                                                <div id="collapseInce8" class="collapse" aria-labelledby="1"
                                                    ...
                                                    <div class="card-body">
                                                        ...
                                                        @foreach ($formSntChecklistPerawatanIncinerator567Harians as $key => $formSntChecklistPerawatanIncinerator567Harian)
                                                            @if ($formSntChecklistPerawatanIncinerator567Harian->incinerator == 'INCINERATOR NOMER 5')
                                                                @if ($formSntChecklistPerawatanIncinerator567Harian->group == 'WET SCRUBBER')
                                                                    <div class="row">
                                                                        <span
                                                                            class="col-12 d-flex justify-content-center fw-bolder">Kondisi</span>
                                                                        <div
                                            ...
                                            <div class="card">
                                                ...
                                                <div id="collapseInce4" class="collapse" aria-labelledby="1"
                                                    ...
                                                    <div class="card-body">
                                                        ...
                                                        @foreach ($formSntChecklistPerawatanIncinerator567Harians as $key => $formSntChecklistPerawatanIncinerator567Harian)
                                                            @if ($formSntChecklistPerawatanIncinerator567Harian->incinerator == 'INCINERATOR NOMER 5')
                                                                @if ($formSntChecklistPerawatanIncinerator567Harian->group == 'CEROBONG')
                                                                    <div class="row">
                                                                        <span
                                                                            class="col-12 d-flex justify-content-center fw-bolder">Kondisi</span>
                                                                        <div
                                            ...
                                            <div class="card">
                                                ...
                                                <div id="collapseInce5" class="collapse" aria-labelledby="1"
                                                    ...
                                                    <div class="card-body">
                                                        ...
                                                        @foreach ($formSntChecklistPerawatanIncinerator567Harians as $key => $formSntChecklistPerawatanIncinerator567Harian)
                                                            @if ($formSntChecklistPerawatanIncinerator567Harian->incinerator == 'INCINERATOR NOMER 5')
                                                                @if ($formSntChecklistPerawatanIncinerator567Harian->group == 'LAMPU PENERANGAN')
                                                                    <div class="row">
                                                                        <span
                                                                            class="col-12 d-flex justify-content-center fw-bolder">Kondisi</span>
                                                                        <div
                                            ...
                                            <div class="card">
                                                ...
                                                <div id="collapseInce6" class="collapse" aria-labelledby="1"
                                                    ...
                                                    <div class="card-body">
                                                        ...
                                                        @foreach ($formSntChecklistPerawatanIncinerator567Harians as $key => $formSntChecklistPerawatanIncinerator567Harian)
                                                            @if ($formSntChecklistPerawatanIncinerator567Harian->incinerator == 'INCINERATOR NOMER 5')
                                                                @if ($formSntChecklistPerawatanIncinerator567Harian->group == 'POMPA SOLAR')
                                                                    <div class="row">
                                                                        <span
                                                                            class="col-12 d-flex justify-content-center fw-bolder">Kondisi</span>
                                                                        <div
                                            ...
                                            <div class="card">
                                                ...
                                                <div id="collapseInce7" class="collapse" aria-labelledby="1"
                                                    ...
                                                    <div class="card-body">
                                                        ...
                                                        @foreach ($formSntChecklistPerawatanIncinerator567Harians as $key => $formSntChecklistPerawatanIncinerator567Harian)
                                                            @if ($formSntChecklistPerawatanIncinerator567Harian->incinerator == 'INCINERATOR NOMER 5')
                                                                @if ($formSntChecklistPerawatanIncinerator567Harian->group == 'PANEL KONTROL')
                                                                    <div class="row">
                                                                        <span
                                                                            class="col-12 d-flex justify-content-center fw-bolder">Kondisi</span>
                                                                        <div
                                            ...
                                            <div class="card">
                                                ...
                                                <div id="collapseIncenerator1" class="collapse" aria-labelledby="1"
                                                    ...
                                                    <div class="card-body">
                                                        @include('components.form-message')
                                                        @foreach ($formSntChecklistPerawatanIncinerator567Harians as $key => $formSntChecklistPerawatanIncinerator567Harian)
                                                            @if ($formSntChecklistPerawatanIncinerator567Harian->incinerator == 'INCINERATOR NOMER 6')
                                                                @if ($formSntChecklistPerawatanIncinerator567Harian->group == 'MECHANICAL LIFTER')
                                                                    <div class="row">
                                                                        <span
                                                                            class="col-12 d-flex justify-content-center fw-bolder">Kondisi</span>
                                            ...
                                            <div class="card">
                                                ...
                                                <div id="collapseSeat1" class="collapse" aria-labelledby="1"
                                                    ...
                                                    <div class="card-body">
                                                        @include('components.form-message')
                                                        @foreach ($formSntChecklistPerawatanIncinerator567Harians as $key => $formSntChecklistPerawatanIncinerator567Harian)
                                                            @if ($formSntChecklistPerawatanIncinerator567Harian->incinerator == 'INCINERATOR NOMER 7')
                                                                @if ($formSntChecklistPerawatanIncinerator567Harian->group == 'MECHANICAL LIFTER')
                                                                    <div class="row">
                                                                        <span
                                                                            class="col-12 d-flex justify-content-center fw-bolder">Kondisi</span>
