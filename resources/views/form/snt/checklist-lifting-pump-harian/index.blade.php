...
@section('content')
    ...
    <section class="content">
        ...
        <form method="POST"
            action="{{ route('form.snt.checklist-lifting-pump-harian.update', $detailWorkOrderForm) }}"
                                    ...
                                    <div class="card-body">
                                        @foreach ($formSntChecklistLiftingPumpHarians as $key => $formSntChecklistLiftingPumpHarian)
                                            ...
                                            <h4 style="text-align: center">
                                                {{ $formSntChecklistLiftingPumpHarian->nama_peralatan }}
                                            </h4>
                                            ...
                                            <div class="row">
                                                <div class="col-4">
                                                    <div class="form-group">
                                                        ...
                                                        <span
                                                            class="d-flex justify-content-center">{{ $formSntChecklistLiftingPumpHarian->merk }}</span>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-4">
                                                    <div class="form-group">
                                                        ...
                                                        <span
                                                            class="d-flex justify-content-center">{{ $formSntChecklistLiftingPumpHarian->tipe }}</span>
                                                    </div>
                                                </div>

                                                <div class="col-4">
                                                    <div class="form-group">
                                                        <label class="d-flex justify-content-center">LOKASI</label>

                                                        <span
                                                            class="d-flex justify-content-center">{{ $formSntChecklistLiftingPumpHarian->lokasi }}</span>
                                                    </div>
                                                </div>
                                            </div>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <select class="form-control @error('kondisi.') is-invalid @enderror"
                                                            ...
                                                            <option value="OPERASI";
                                                                {{ old('kondisi.') ?? $formSntChecklistLiftingPumpHarian->kondisi == 'OPERASI' ? 'selected' : '' }}>
                                                                OPERASI
                                                            </option>
                                                            <option value="OFF"
                                                                {{ old('kondisi.') ?? $formSntChecklistLiftingPumpHarian->kondisi == 'OFF' ? 'selected' : '' }}>
                                                                OFF
                                                            </option>
                                                        </select>
                                                    </div>
                                                ...
                                                <div class="col-12 col-lg-6">
                                                    <div class="form-group">
                                                        ...
                                                        <textarea class="form-control @error('keterangan.') is-invalid @enderror" name="keterangan[]"
                                                            value="{{ old('keterangan.') ?? $formSntChecklistLiftingPumpHarian->keterangan }}"></textarea>
                                                    </div>
                                                </div>
                                            </div>
                                            <hr class="bg-primary">
