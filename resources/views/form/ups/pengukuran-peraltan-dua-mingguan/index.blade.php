...
@section('content')
    <section class="content">
        <form method="POST" id="myForm"
            action="{{ route('form.ups.pengukuran-peralatan-dua-mingguan.update', $detailWorkOrderForm) }}"
                                ...
                                <div class="row d-flex align-items-center">
                                    <div class="col-12 col-lg-8 col-md-8">
                                        <div class="row mb-2">
                                            ...
                                            <div class="col-8">
                                                <select class="form-control select2 @error('nama_gardu') is-invalid @enderror" id="nama_gardu"
                                            name="">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-8">
                                                <select class="form-control @error('banyak') is-invalid @enderror" id="banyak"
                                            name="">
                                            <option value="">Choose Or Type Selection</option>
                                                </option>
                                                <option value="1">
            ...
            <div class="add-substation-area">
                @if ($formUpsPengukuranPeralatanDuaMingguans->isNotEmpty())
                    @foreach ($formUpsPengukuranPeralatanDuaMingguans as $key => $formUpsPengukuranPeralatanDuaMingguan)
                        <div class="container-fluid">
                                            ...
                                            <div class="col-6">
                                                <button class="btn btn-link btn-block text-left" type="button"
                                                    ...
                                                    <i class="fas {{ $loop->iteration === 1 ? 'fa-minus' : 'fa-plus' }}"
                                                        id="accordion"></i>
                                                    {{ $formUpsPengukuranPeralatanDuaMingguan->nama_gardu ?? '' }}
                                                    <input type="hidden" name="nama_gardu[]"
                                                        value="{{ $formUpsPengukuranPeralatanDuaMingguan->nama_gardu }}">
                                                </button>
                                            </div>
                                                ...
                                                <div class="col-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text"
                                                            ...
                                                            value="{{ old('merk_ups.' . $key) ?? $formUpsPengukuranPeralatanDuaMingguan->merk_ups }}">
                                                ...
                                                <div class="col-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text"
                                                            ...
                                                            id="shift" name="shift[]" 
                                                            value="{{ old('shift.' . $key) ?? $formUpsPengukuranPeralatanDuaMingguan->shift }}">
                                                ...
                                                <div class="col-12">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-4">
                                                            <div class="form-group">
                                                                ...
                                                                <input type="number"
                                                                    ...
                                                                    value="{{ old('input_v_l1_n.' . $key) ?? $formUpsPengukuranPeralatanDuaMingguan->input_v_l1_n }}">
                                                        ...
                                                        <div class="col-4">
                                                            <div class="form-group">
                                                                ...
                                                                <input type="number"
                                                                    ...
                                                                    value="{{ old('input_v_l2_n.' . $key) ?? $formUpsPengukuranPeralatanDuaMingguan->input_v_l2_n }}">
                                                        ...
                                                        <div class="col-4">
                                                            <div class="form-group">
                                                                ...
                                                                <input type="number"
                                                                    ...
                                                                    value="{{ old('input_v_l3_n.' . $key) ?? $formUpsPengukuranPeralatanDuaMingguan->input_v_l3_n }}">
                                                                ...
                                                                <div class="col-4">
                                                                    <div class="form-group">
                                                                        ...
                                                                        <input type="number"
                                                                            ...
                                                                            value="{{ old('input_i_l1.' . $key) ?? $formUpsPengukuranPeralatanDuaMingguan->input_i_l1 }}">
                                                                ...
                                                                <div class="col-4">
                                                                    <div class="form-group">
                                                                        ...
                                                                        <input type="number"
                                                                            ...
                                                                            value="{{ old('input_i_l2.' . $key) ?? $formUpsPengukuranPeralatanDuaMingguan->input_i_l2 }}">
                                                                ...
                                                                <div class="col-4">
                                                                    <div class="form-group">
                                                                        ...
                                                                        <input type="number"
                                                                            ...
                                                                            value="{{ old('input_i_l3.' . $key) ?? $formUpsPengukuranPeralatanDuaMingguan->input_i_l3 }}">
                                                        ...
                                                        <div class="col-12">
                                                            <div class="form-group">
                                                                ...
                                                                <input type="text"
                                                                    ...
                                                                    value="{{ old('freq_input.' . $key) ?? $formUpsPengukuranPeralatanDuaMingguan->freq_input }}">
                                                        ...
                                                        <div class="col-12">
                                                                ...
                                                                <div class="col-12 col-lg-2">
                                                                    <div class="form-group">
                                                                        ...
                                                                        <input type="number"
                                                                            ...
                                                                            value="{{ old('teg_floating.' . $key) ?? $formUpsPengukuranPeralatanDuaMingguan->teg_floating }}">
                                                                ...
                                                                <div class="col-12 col-lg-2">
                                                                    <div class="form-group">
                                                                        ...
                                                                        <input type="number"
                                                                            ...
                                                                            id="teg_rata2_percell"
                                                                            name="teg_rata2_percell[]"
                                                                            value="{{ old('teg_rata2_percell.' . $key) ?? $formUpsPengukuranPeralatanDuaMingguan->teg_rata2_percell }}">
                                                                ...
                                                                <div class="col-12 col-lg-2">
                                                                    <div class="form-group">
                                                                        ...
                                                                        <input type="number"
                                                                            ...
                                                                            value="{{ old('teg_tot_batt.' . $key) ?? $formUpsPengukuranPeralatanDuaMingguan->teg_tot_batt }}">
                                                                ...
                                                                <div class="col-12 col-lg-2">
                                                                    <div class="form-group">
                                                                        ...
                                                                        <input type="number"
                                                                            ...
                                                                            value="{{ old('teg_otonomi.' . $key) ?? $formUpsPengukuranPeralatanDuaMingguan->teg_otonomi }}">
                                                                ...
                                                                <div class="col-12 col-lg-2">
                                                                    <div class="form-group">
                                                                        ...
                                                                        <input type="number"
                                                                            ...
                                                                            value="{{ old('arus_discharge.' . $key) ?? $formUpsPengukuranPeralatanDuaMingguan->arus_discharge }}">
                                                                ...
                                                                <div class="col-12 col-lg-2">
                                                                    <div class="form-group">
                                                                        ...
                                                                        <input type="number"
                                                                            ...
                                                                            value="{{ old('arus_bhoscarge.' . $key) ?? $formUpsPengukuranPeralatanDuaMingguan->arus_bhoscarge }}">
                                                                    ...
                                                                    <div class="col-12 col-lg-2">
                                                                        <div class="form-group">
                                                                            ...
                                                                            <input type="number"
                                                                                ...
                                                                                value="{{ old('output_v_l1_n.' . $key) ?? $formUpsPengukuranPeralatanDuaMingguan->output_v_l1_n }}">
                                                                    ...
                                                                    <div class="col-12 col-lg-2">
                                                                        <div class="form-group">
                                                                            ...
                                                                            <input type="number"
                                                                                ...
                                                                                value="{{ old('output_v_l2_n.' . $key) ?? $formUpsPengukuranPeralatanDuaMingguan->output_v_l2_n }}">
                                                                    ...
                                                                    <div class="col-12 col-lg-2">
                                                                        <div class="form-group">
                                                                            ...
                                                                            <input type="number"
                                                                                ...
                                                                                value="{{ old('output_v_l3_n.' . $key) ?? $formUpsPengukuranPeralatanDuaMingguan->output_v_l3_n }}">
                                                                    ...
                                                                    <div class="col-12 col-lg-2">
                                                                        <div class="form-group">
                                                                            ...
                                                                            <input type="number"
                                                                                ...
                                                                                id="v_l1" name="v_l1[]"
                                                                                value="{{ old('v_l1.' . $key) ?? $formUpsPengukuranPeralatanDuaMingguan->v_l1 }}">
                                                                    ...
                                                                    <div class="col-12 col-lg-2">
                                                                        <div class="form-group">
                                                                            ...
                                                                            <input type="number"
                                                                                ...
                                                                                id="v_l2" name="v_l2[]"
                                                                                value="{{ old('v_l2.' . $key) ?? $formUpsPengukuranPeralatanDuaMingguan->v_l2 }}">
                                                                    ...
                                                                    <div class="col-12 col-lg-2">
                                                                        <div class="form-group">
                                                                            ...
                                                                            <input type="number"
                                                                                ...
                                                                                id="v_l3" name="v_l3[]"
                                                                                value="{{ old('v_l3.' . $key) ?? $formUpsPengukuranPeralatanDuaMingguan->v_l3 }}">
                                                            ...
                                                            <div class="col-12">
                                                                <div class="form-group">
                                                                    ...
                                                                    <input type="text"
                                                                        ...
                                                                        value="{{ old('freq_output.' . $key) ?? $formUpsPengukuranPeralatanDuaMingguan->freq_output }}">
                                                            ...
                                                            <div class="col-12">
                                                                ...
                                                                <div class="row">
                                                                    <div class="col-12 col-lg-2">
                                                                        <div class="form-group">
                                                                            ...
                                                                            <input type="number"
                                                                                ...
                                                                                value="{{ old('output_i_l1.' . $key) ?? $formUpsPengukuranPeralatanDuaMingguan->output_i_l1 }}">
                                                                    ...
                                                                    <div class="col-12 col-lg-2">
                                                                        <div class="form-group">
                                                                            ...
                                                                            <input type="number"
                                                                                ...
                                                                                value="{{ old('output_i_l2.' . $key) ?? $formUpsPengukuranPeralatanDuaMingguan->output_i_l2 }}">
                                                                    ...
                                                                    <div class="col-12 col-lg-2">
                                                                        <div class="form-group">
                                                                            ...
                                                                            <input type="number"
                                                                                ...
                                                                                value="{{ old('output_i_l3.' . $key) ?? $formUpsPengukuranPeralatanDuaMingguan->output_i_l3 }}">
                                                                    ...
                                                                    <div class="col-12 col-lg-2">
                                                                        <div class="form-group">
                                                                            <span
                                                                                class="d-flex justify-content-center">Load
                                                                                Persen (%)</span>
                                                                            <input type="number"
                                                                                class="form-control @error('load_persen.'. $key) is-invalid @enderror"
                                                                                id="load_persen" name="load_persen[]"
                                                                                value="{{ old('load_persen.' . $key) ?? $formUpsPengukuranPeralatanDuaMingguan->load_persen }}">
                                                                    ...
                                                                    <div class="col-12 col-lg-2">
                                                                        <div class="form-group">
                                                                            ...
                                                                            <input type="number"
                                                                                ...
                                                                                value="{{ old('load_perphase.' . $key) ?? $formUpsPengukuranPeralatanDuaMingguan->load_perphase }}">
                                                                    ...
                                                                    <div class="col-12 col-lg-2">
                                                                        <div class="form-group">
                                                                            <span
                                                                                class="d-flex justify-content-center">Total
                                                                                Load</span>
                                                                            <input type="number"
                                                                                class="form-control @error('total_load.'. $key) is-invalid @enderror"
                                                                                id="total_load" name="total_load[]"
                                                                                value="{{ old('total_load.' . $key) ?? $formUpsPengukuranPeralatanDuaMingguan->total_load }}">
                                                            ...
                                                            <div class="col-12">
                                                                <label
                                                                    class="d-flex justify-content-center">Temperatur</label>
                                                                <div class="row">
                                                                    <div class="col-4">
                                                                        <div class="form-group">
                                                                            <span class="d-flex justify-content-center">I
                                                                            ...
                                                                            <input type="number"
                                                                                ...
                                                                                value="{{ old('temp_ruang.' . $key) ?? $formUpsPengukuranPeralatanDuaMingguan->temp_ruang }}">
                                                                    ...
                                                                    <div class="col-4">
                                                                        <div class="form-group">
                                                                            <span
                                                                                class="d-flex justify-content-center">Temp
                                                                                Unit/Alat</span>
                                                                            <input type="number"
                                                                                class="form-control @error('temp_unit.'. $key) is-invalid @enderror"
                                                                                id="temp_unit" name="temp_unit[]"
                                                                                value="{{ old('temp_unit.' . $key) ?? $formUpsPengukuranPeralatanDuaMingguan->temp_unit }}">
                                                                    ...
                                                                    <div class="col-4">
                                                                        <div class="form-group">
                                                                            ...
                                                                            <input type="number"
                                                                                ...
                                                                                value="{{ old('temp_battery.' . $key) ?? $formUpsPengukuranPeralatanDuaMingguan->temp_battery }}">
