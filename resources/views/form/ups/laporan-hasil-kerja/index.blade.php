...
@section('content')
    <section class="content">
        ...
        <form method="POST" action="{{ route('form.ups.laporan-hasil-kerja.update', $detailWorkOrderForm->id) }}"
            id="form">
            @method('patch')
            @csrf
                        ...
                        <div class="col-12">
                            <div class="card card-primary">
                                <div class="card-header">
                                    <h3 class="card-title">LAPORAN HASIL KERJA OPERASIONAL PAGI SIANG</h3>
                                </div>
                                <div class="card-body">
                                    <div class="row">
                                            ...
                                            <div class="row">
                                                <div class="col-12 ">
                                                    <input type="text" class="form-control" placeholder="Nama....."
                                                        name="koordinasi"
                                                        {{ old('koordinasi') ?? $formUpsLaporanHasilKerja->koordinasi }}>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <select
                                                            ...
                                                            <option value="Normal Operasi";
                                                                {{ old('hasil_visual.') ?? $formUpsLaporanHasilKerja->hasil_visual == 'Normal Operasi' ? 'selected' : '' }}>
                                                                Normal Operasi
                                                            </option>
                                                            <option value="Tidak Normal";
                                                                {{ old('hasil_visual.') ?? $formUpsLaporanHasilKerja->hasil_visual == 'Tidak Normal' ? 'selected' : '' }}>
                                                                Tidak Normal
                                                            </option>
                                    ...
                                    <div class="col-12 col-lg-2">
                                        <div class="form-group">
                                            ...
                                            <input type="checkbox"
                                                ...
                                                {{ old('toolkit') ?? $formUpsLaporanHasilKerja->toolkit ? 'checked' : '' }}>
                                    ...
                                    <div class="col-12 col-lg-2">
                                        <div class="form-group">
                                            ...
                                            <input type="checkbox"
                                                ...
                                                {{ old('avometer') ?? $formUpsLaporanHasilKerja->avometer ? 'checked' : '' }}>
                                    ...
                                    <div class="col-12 col-lg-4">
                                        <div class="form-group">
                                            ...
                                            <input type="checkbox"
                                                ...
                                                {{ old('kendaraan') ?? $formUpsLaporanHasilKerja->kendaraan ? 'checked' : '' }}>
                                    ...
                                    <div class="col-12 col-lg-2">
                                        <div class="form-group">
                                            ...
                                            <input type="checkbox"
                                                ...
                                                name="apd" value="1"
                                                {{ old('apd') ?? $formUpsLaporanHasilKerja->apd ? 'checked' : '' }}>
                                                {{-- seharusnya apd --}}
                                    ...
                                    <div class="col-12 col-lg-2">
                                        <div class="form-group">
                                            ...
                                            <input type="checkbox"
                                                ...
                                                name="reytex" value="1"
                                                {{ old('reytex') ?? $formUpsLaporanHasilKerja->reytex ? 'checked' : '' }}>
                                    ...
                                    <div class="col-12 col-lg-2">
                                        <div class="form-group">
                                            ...
                                            <input type="checkbox"
                                                ...
                                                {{ old('alat_cleaning') ?? $formUpsLaporanHasilKerja->alat_cleaning ? 'checked' : '' }}>
                                ...
                                <hr class="my-2">
                                    <div class="col-12">
                                            ...
                                            <input type="checkbox"
                                                ...
                                                {{ old('pengukuran') ?? $formUpsLaporanHasilKerja->pengukuran ? 'checked' : '' }}>
                                    ...
                                    <div class="col-12">
                                            ...
                                            <input type="checkbox"
                                                ...
                                                {{ old('temperatur') ?? $formUpsLaporanHasilKerja->temperatur ? 'checked' : '' }}>
                                    ...
                                    <div class="col-12">
                                            ...
                                            <input type="checkbox"
                                                ...
                                                {{ old('membersihkan') ?? $formUpsLaporanHasilKerja->membersihkan ? 'checked' : '' }}>
                                    ...
                                    <div class="col-12">
                                            ...
                                            <input type="checkbox"
                                                ...
                                                {{ old('dokumentasi') ?? $formUpsLaporanHasilKerja->dokumentasi ? 'checked' : '' }}>
                                    ...
                                    <hr class="my-2">
                                    <div class="col-12">
                                            <label for="inputPassword" class="col-9">Serah terima tugas dengan petugas dinas malam (M)</label>
                                            <input type="checkbox"
                                                class="flat largerCheckbox @error('serahterima') is-invalid @enderror"
                                                name="serahterima" value="1"
                                                {{ old('serahterima') ?? $formUpsLaporanHasilKerja->serahterima ? 'checked' : '' }}>
                            ...
                            <div class="card-body">
                                <div class="form-group row">
                                    ...
                                    <div class="col-12 col-lg-9">
                                        ...
                                        <textarea name="catatan" class="form-control" id="catatan" placeholder="Deskripsi">{!! $formUpsLaporanHasilKerja->catatan !!}</textarea>
                                    </div>
                                </div>
                            </div>
                        </div>
