...
@section('content')
    <section class="content">
        <form method="POST" action="{{ route('form.ps1.genset-mobile.update', $detailWorkOrderForm->id)  }}" enctype="multipart/form-data"
            id="form">
            @method('patch')
            @csrf
                    ...
                    <div class="card card-primary">
                        ...
                        <div class="card-body">
                            ...
                            {{-- <div class="form-group row">
                                <label class="col-lg-9 col-9 hidden-lg hidden-md hidden-sm hidden-xs">Genset</label>
        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-lg-12">
                    <div class="card card-primary">
                        <div class="card-header">
                            <h3 class="card-title" style="text-align: right;">Mobilisasi Genset dari Lokasi Pekerjaan ke MPS</h3>
                        </div>
                        <div class="card-body">
                            ...
                            <div class="form-group row col-12 col-lg-6">
                                ...
                                <label class="col-lg-9 col-9">1. Koordinasi dengan unit terkait</label>
                                <div class="col-lg-3 col-3">
                                    <input type="checkbox" class="flat largerCheckbox" name="q1b" {{  old('q1b') ?? $formPs1GensetMobile->q1b == 'on' ? 'checked' : ''  }}>
                                </div>


                                <label class="col-lg-9 col-9">2. Siapkan peralatan kerja dan k3</label>
                                <div class="col-lg-3 col-3">
                                    <input type="checkbox" class="flat largerCheckbox" name="q2b" {{  old('q2b') ?? $formPs1GensetMobile->q2b == 'on' ? 'checked' : ''  }}>
                                </div>


                                <label class="col-lg-9 col-9">3. Melepas terminasi kabel power dari panel junction / MCCB outgoing genset ke panel beban</label>
                                <div class="col-lg-3 col-3">
                                    <input type="checkbox" class="flat largerCheckbox" name="q3b" {{  old('q3b') ?? $formPs1GensetMobile->q3b == 'on' ? 'checked' : ''  }}>
                                </div>
                            ...
                            <div class="form-group row col-12 col-lg-6">
                                ...
                                <label class="col-lg-9 col-9">4. Merapihkan / menggulung kabel power</label>
                                <div class="col-lg-3 col-3">
                                    <input type="checkbox" class="flat largerCheckbox" name="q4b" {{  old('q4b') ?? $formPs1GensetMobile->q4b == 'on' ? 'checked' : ''  }}>
                                </div>


                                <label class="col-lg-9 col-9">5. Mobilisasi genset meuju gedung MPS </label>
                                <div class="col-lg-3 col-3">
                                    <input type="checkbox" class="flat largerCheckbox" name="q5b" {{  old('q5b') ?? $formPs1GensetMobile->q5b == 'on' ? 'checked' : ''  }}>
                                </div>


                                <label class="col-9 col-lg-9">6. Kegiatan selesai</label>
                                <div class="col-lg-3 col-3">
                                    <input type="checkbox" class="flat largerCheckbox" name="q6b" {{  old('q6b') ?? $formPs1GensetMobile->q6b == 'on' ? 'checked' : ''  }}>
                                </div>
