...
@section('content')
    <section class="content">
        <form method="POST" action="{{ route('form.ps1.panel-tr-aux-dua-mingguan.update', $detailWorkOrderForm->id) }}"
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <select
                                                                    ...
                                                                    @foreach ($panelADanB['satuan'] as $satuan)
                                                                        <option value="{{ $satuan }}"
                                                                            {{ ($formPs1PanelTrAuxDuaMingguanPanelADanBs[$keyADanB][$columnPanelADanB['name']] ?? old('panel_a_dan_b_' . $columnPanelADanB['name'] . '.' . $keyADanB)) == $satuan ? 'selected' : '' }}>
                                                                            {{ $satuan }}</option>
                                                                    @endforeach
                                                                </select>
                                                        ...
                                                        <div class="col-4 col-lg-4 col-md-4">
                                                            <div class="form-group">
                                                                ...
                                                                <input type="text"
                                                                    ...
                                                                    name="{{ 'panel_a_dan_b_' . $columnPanelADanB['name'] }}[]" 
                                                                    value="{{ $formPs1PanelTrAuxDuaMingguanPanelADanBs[$keyADanB][$columnPanelADanB['name']] ?? old('panel_a_dan_b_' . $columnPanelADanB['name'] . '.' . $keyADanB) }}"
                                                ...
                                                <div class="col-12">
                                                    <div class="form-group">
                                                        ...
                                                        <textarea name="panel_a_dan_b_keterangan[]"
                                                            ...
                                                            placeholder="Deskripsi">{!! $formPs1PanelTrAuxDuaMingguanPanelADanBs[$keyADanB]['keterangan'] ??old('panel_a_dan_b_keterangan.' . $keyADanB) !!}</textarea>
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <select
                                                                    ...
                                                                    @foreach ($panelSdp['satuan'] as $satuan)
                                                                        <option value="{{ $satuan }}"
                                                                            {{ ($formPs1PanelTrAuxDuaMingguanPanelSdps[$keySdp][$columnPanelSdp['name']] ?? old('panel_sdp_' . $columnPanelSdp['name'] . '.' . $keySdp)) == $satuan ? 'selected' : '' }}>
                                                                            {{ $satuan }}</option>
                                                                    @endforeach
                                                                </select>
                                                        ...
                                                        <div class="col-4 col-lg-4 col-md-4">
                                                            <div class="form-group">
                                                                ...
                                                                <input type="text"
                                                                    ...
                                                                    name="{{ 'panel_sdp_' . $columnPanelSdp['name'] }}[]"
                                                                    value="{{ $formPs1PanelTrAuxDuaMingguanPanelSdps[$keySdp][$columnPanelSdp['name']] ?? old('panel_sdp_' . $columnPanelSdp['name'] . '.' . $keySdp) }}"
                                                ...
                                                <div class="col-12">
                                                    <div class="form-group">
                                                        ...
                                                        <textarea name="panel_sdp_keterangan[]"
                                                            ...
                                                            placeholder="Deskripsi">{!! $formPs1PanelTrAuxDuaMingguanPanelSdps[$keySdp]->keterangan ?? old('panel_sdp_keterangan.' . $keySdp) !!}</textarea>
