...
@section('content')
    <section class="content">
        <form method="POST" action="{{ route('form.ps1.genset-mobile-tiga-bulanan.update', $detailWorkOrderForm->id)  }}" enctype="multipart/form-data"
            id="form">
            @method('patch')
            @csrf
        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-lg-12">
                    <div class="card card-primary">
                        <div class="card-header">
                            <h3 class="card-title" style="text-align: right;">Data teknis perawatan 3 Bulanan</h3>
                        </div>
                        <div class="card-body">
                            <div class="row">
                            ...
                            <div class="col-lg-2 col-8">
                                ...
                                <select
                                    ...
                                    <option value="8"
                                        {{ old('tipe.' . 0) ?? $formPs1GensetMobileTigaBulanans[0]->tipe == '8' ? 'selected' : '' }}>
                                        8</option>
                                    <option value="60"
                                        {{ old('tipe.' . 0) ?? $formPs1GensetMobileTigaBulanans[0]->tipe == '60' ? 'selected' : '' }}>
                                        60</option>
                                    <option value="100"
                                        {{ old('tipe.' . 0) ?? $formPs1GensetMobileTigaBulanans[0]->tipe == '100' ? 'selected' : '' }}>
                                        100</option>
                                    <option value="430"
                                        {{ old('tipe.' . 0) ?? $formPs1GensetMobileTigaBulanans[0]->tipe == '430' ? 'selected' : '' }}>
                                        430</option>
                                    <option value="500"
                                        {{ old('tipe.' . 0) ?? $formPs1GensetMobileTigaBulanans[0]->tipe == '500' ? 'selected' : '' }}>
                                        500</option>
                                    <option value="1000"
                                        {{ old('tipe.' . 0) ?? $formPs1GensetMobileTigaBulanans[0]->tipe == '1000' ? 'selected' : '' }}>
                                        1000</option>
                                    @if ($formPs1GensetMobileTigaBulanans[0]->tipe != 'NORMAL' && $formPs1GensetMobileTigaBulanans[0]->tipe != null)
                                        <option
                                            value="{{ $formPs1GensetMobileTigaBulanans[0]->tipe }}"
                                            selected>
                                            {{ $formPs1GensetMobileTigaBulanans[0]->tipe }}
                                        </option>
                                    @endif
                                </select>
                                {{-- <input type="text" class="" name="tipe" {{  old('tipe') ?? $formPs1GensetMobileTigaBulanans[0]->tipe  }}> --}}
                            </div>
                            ...
                            <br>
                            <div class="row">
                                @foreach ( $formPs1GensetMobileTigaBulanans as $key => $item)
                                <?php $count = $key + 1; ?>
                                <div class="form-group row col-12 col-lg-4 col-md-6">
                                    <label class="col-lg-6 col-6">{{$count}}. {{$item->pertanyaan}} @if($item->satuan != '') <span class="text-muted"> ({{$item->satuan}}) </span> @endif </label>
