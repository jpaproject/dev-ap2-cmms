...
@section('content')
    <section class="content">
        <form method="POST" action="{{ route('form.ps1.panel-tr-enam-bulanan.update', $detailWorkOrderForm->id) }}"
                                                                ...
                                                                <div class="form-group">
                                                                    ...
                                                                    <select
                                                                        ...
                                                                        @foreach ($panelNp0['satuan'] as $satuan)
                                                                            <option value="{{ $satuan }}"
                                                                                {{ (old('panel_np0_' . $column['name'] . '.' . $keyNp0) ?? $formPs1PanelTrEnamBulananNp0s[$keyNp0][$column['name']]) == $satuan ? 'selected' : '' }}>
                                                                                {{ $satuan }}</option>
                                                                        @endforeach
                                                                    </select>
                                                            ...
                                                            <div class="col-4 col-lg-4 col-md-4">
                                                                <div class="form-group">
                                                                    ...
                                                                    <input type="text"
                                                                        ...
                                                                        name="{{ 'panel_np0_' . $column['name'] }}[]"
                                                                        value="{{ old('panel_np0_' . $column['name'] . '.' . $keyNp0) ?? $formPs1PanelTrEnamBulananNp0s[$keyNp0][$column['name']] }}"
                                                        ...
                                                        <div class="col-12">
                                                            <div class="form-group">
                                                                ...
                                                                <select
                                                                    ...
                                                                    @foreach ($panelNp0['satuan'] as $satuan)
                                                                        <option value="{{ $satuan }}"
                                                                            {{ (old('panel_np0_q4' . '.' . $keyNp0) ?? $formPs1PanelTrEnamBulananNp0s[$keyNp0]['q4']) == $satuan ? 'selected' : '' }}>
                                                                            {{ $satuan }}</option>
                                                                    @endforeach
                                                                </select>
                                                        ...
                                                        <div class="col-12">
                                                            <div class="form-group">
                                                                ...
                                                                <input type="text"
                                                                    ...
                                                                    id="{{ 'panel_np0_q4' }}[]"
                                                                    name="{{ 'panel_np0_q4' }}[]"
                                                                    value="{{ old('panel_np0_q4' . '.' . $keyNp0) ?? $formPs1PanelTrEnamBulananNp0s[$keyNp0]['q4'] }}"
                                                ...
                                                <div class="col-12">
                                                    <div class="form-group">
                                                        ...
                                                        <textarea name="panel_np0_keterangan[]"
                                                            ...
                                                            placeholder="Deskripsi">{!! old('panel_np0_keterangan.' . $keyNp0) ?? $formPs1PanelTrEnamBulananNp0s[$keyNp0]['keterangan'] !!}</textarea>
                                                                ...
                                                                <div class="form-group">
                                                                    ...
                                                                    <select
                                                                        ...
                                                                        @foreach ($panelT0['satuan'] as $satuan)
                                                                            <option value="{{ $satuan }}"
                                                                                {{ (old('panel_t0_' . $column['name'] . '.' . $keyT0) ?? $formPs1PanelTrEnamBulananT0s[$keyT0][$column['name']]) == $satuan ? 'selected' : '' }}>
                                                                                {{ $satuan }}</option>
                                                                        @endforeach
                                                                    </select>
                                                            ...
                                                            <div class="col-4 col-lg-4 col-md-4">
                                                                <div class="form-group">
                                                                    ...
                                                                    <input type="text"
                                                                        ...
                                                                        name="{{ 'panel_t0_' . $column['name'] }}[]"
                                                                        value="{{ old('panel_t0_' . $column['name'] . '.' . $keyT0) ?? $formPs1PanelTrEnamBulananT0s[$keyT0][$column['name']] }}"
                                                                        placeholder="{{ $column['title'] }}">
                                                        ...
                                                        <div class="col-12">
                                                            <div class="form-group">
                                                                ...
                                                                <select
                                                                    ...
                                                                    @foreach ($panelT0['satuan'] as $satuan)
                                                                        <option value="{{ $satuan }}"
                                                                            {{ (old('panel_t0_q4' . '.' . $keyT0) ?? $formPs1PanelTrEnamBulananT0s[$keyT0]['q4']) == $satuan ? 'selected' : '' }}>
                                                                            {{ $satuan }}</option>
                                                                    @endforeach
                                                                </select>
                                                        ...
                                                        <div class="col-12">
                                                            <div class="form-group">
                                                                ...
                                                                <input type="text"
                                                                    ...
                                                                    id="{{ 'panel_t0_q4' }}[]"
                                                                    name="{{ 'panel_t0_q4' }}[]"
                                                                    value="{{ old('panel_t0_q4' . '.' . $keyT0) ?? $formPs1PanelTrEnamBulananT0s[$keyT0]['q4'] }}"
                                                ...
                                                <div class="col-12">
                                                    <div class="form-group">
                                                        ...
                                                        <textarea name="panel_t0_keterangan[]"
                                                            ...
                                                            placeholder="Deskripsi">{!! old('panel_t0_keterangan.' . $keyT0) ?? $formPs1PanelTrEnamBulananT0s[$keyT0]->keterangan !!}</textarea>
