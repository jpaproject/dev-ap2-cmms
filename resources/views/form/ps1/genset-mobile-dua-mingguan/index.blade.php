...
@section('content')
    <section class="content">
        <form method="POST" action="{{ route('form.ps1.genset-mobile-dua-mingguan.update', $detailWorkOrderForm->id)  }}" enctype="multipart/form-data"
            id="form">
            @method('patch')
            @csrf
                        ...
                        <div class="card-body">
                            ...
                            <div class="col-lg-2 col-8">
                                ...
                                <select
                                    ...
                                    <option value="8"
                                        {{ old('tipe.' . 0) ?? $formPs1GensetMobileDuaMingguans[0]->tipe == '8' ? 'selected' : '' }}>
                                        8</option>
                                    <option value="60"
                                        {{ old('tipe.' . 0) ?? $formPs1GensetMobileDuaMingguans[0]->tipe == '60' ? 'selected' : '' }}>
                                        60</option>
                                    <option value="100"
                                        {{ old('tipe.' . 0) ?? $formPs1GensetMobileDuaMingguans[0]->tipe == '100' ? 'selected' : '' }}>
                                        100</option>
                                    <option value="430"
                                        {{ old('tipe.' . 0) ?? $formPs1GensetMobileDuaMingguans[0]->tipe == '430' ? 'selected' : '' }}>
                                        430</option>
                                    <option value="500"
                                        {{ old('tipe.' . 0) ?? $formPs1GensetMobileDuaMingguans[0]->tipe == '500' ? 'selected' : '' }}>
                                        500</option>
                                    <option value="1000"
                                        {{ old('tipe.' . 0) ?? $formPs1GensetMobileDuaMingguans[0]->tipe == '1000' ? 'selected' : '' }}>
                                        1000</option>
                                    @if ($formPs1GensetMobileDuaMingguans[0]->tipe != 'NORMAL' && $formPs1GensetMobileDuaMingguans[0]->tipe != null)
                                        <option
                                            value="{{ $formPs1GensetMobileDuaMingguans[0]->tipe }}"
                                            selected>
                                            {{ $formPs1GensetMobileDuaMingguans[0]->tipe }}
                                        </option>
                                    @endif
                                </select>
                                {{-- <input type="text" class="" name="tipe" {{  old('tipe') ?? $formPs1GensetMobileDuaMingguans[0]->tipe  }}> --}}
                            </div>
                            ...
                            <br>
                            <div class="row">
                                @foreach ( $formPs1GensetMobileDuaMingguans as $key => $item)
                                <?php $count = $key + 1; ?>
