            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="card card-primary">
                        ...
                        <form method="POST"
                            action="{{ route('form.sva.perbaikan-gangguan.update', $detailWorkOrderForm->id) }}"
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-6 col-10">
                                        <input type="date" class="form-control @error('tanggal') is-invalid @enderror"
                                            ...
                                            value="{{ $formSvaSuratPerbaikanGangguan->tanggal ?? (date('Y-m-d', strtotime($workOrder->date_generate)) ?? '') }}"
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-6 col-10">
                                        <input type="text"
                                            ...
                                            value="{{ old('nama_petugas_atc') ?? $formSvaSuratPerbaikanGangguan->nama_petugas_atc }}"
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-6 col-10">
                                        <input type="time" class="form-control @error('jam_masuk') is-invalid @enderror"
                                            ...
                                            value="{{ old('jam_masuk') ?? $formSvaSuratPerbaikanGangguan->jam_masuk }}"
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-6 col-10">
                                        <input type="time" class="form-control @error('jam_keluar') is-invalid @enderror"
                                            ...
                                            value="{{ old('jam_keluar') ?? $formSvaSuratPerbaikanGangguan->jam_keluar }}"
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-6 col-10">
                                        <select class="form-control select2 @error('kendaraan') is-invalid @enderror"
                                            ...
                                            @if (
                                                $formSvaSuratPerbaikanGangguan->kendaraan == 'PICK UP' ||
                                                    $formSvaSuratPerbaikanGangguan->kendaraan ==
                                                        'U
                                                                                                                                    U' ||
                                                    $formSvaSuratPerbaikanGangguan->kendaraan == 'ST. WAGON/MINIBUS' ||
                                                    $formSvaSuratPerbaikanGangguan->kendaraan == null)
                                                <option value="PICK UP"
                                                    {{ old('kendaraan') ?? $formSvaSuratPerbaikanGangguan->kendaraan == 'PICK UP' ? 'selected' : '' }}>
                                                    PICK UP
                                                </option>
                                                <option value="TRUCK"
                                                    {{ old('kendaraan') ?? $formSvaSuratPerbaikanGangguan->kendaraan == 'TRUCK' ? 'selected' : '' }}>
                                                    TRUCK
                                                </option>
                                                <option value="ST. WAGON/MINIBUS"
                                                    {{ old('kendaraan') ?? $formSvaSuratPerbaikanGangguan->kendaraan == 'ST. WAGON/MINIBUS' ? 'selected' : '' }}>
                                                    ST. WAGON/MINIBUS
                                                </option>
                                            @else
                                                <option value="{{ $formSvaSuratPerbaikanGangguan->kendaraan }}" selected>
                                                    {{ $formSvaSuratPerbaikanGangguan->kendaraan }}
                                                </option>
                                                <option value="PICK UP">
                                                    PICK UP
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-6 col-10">
                                        <input type="text"
                                            ...
                                            value="{{ old('nomor_polisi') ?? $formSvaSuratPerbaikanGangguan->nomor_polisi }}"
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-6 col-10">
                                        <input type="text"
                                            class="form-control @error('jumlah_personil') is-invalid @enderror"
                                            id="jumlah_personil" name="jumlah_personil"
                                            value="{{ count($userTechnicals) }}" placeholder="Enter Nama Petugas Atc"
                                            disabled>
                                        <table>
                                            <tr>
                                                <th>NAMA TEKNISI</th>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-6 col-10">
                                        <input type="text"
                                            ...
                                            value="{{ old('tujuan_keperluan') ?? $formSvaSuratPerbaikanGangguan->tujuan_keperluan }}"
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-6 col-10">
                                        <input type="text"
                                            ...
                                            value="{{ $formSvaSuratPerbaikanGangguan->lokasi_pekerjaan ?? ($workOrder->asset->location->name ?? '') }}"
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-12">
                                        <textarea name="catatan" class="form-control @error('catatan') is-invalid @enderror" id="catatan" cols="30"
                                            rows="3" placeholder="Enter Catatan">{!! old('catatan') ?? $formSvaSuratPerbaikanGangguan->catatan !!}</textarea>
                                    </div>
                                </div>
                            </div>
                            <div class="container-fluid">
