            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="card card-primary">
                        ...
                        <form method="POST" action="{{ route('form.sva.pemeriksaan-rutin.update', $detailWorkOrderForm->id) }}" enctype="multipart/form-data"
                            id="form">
                            @method('patch')
                            @csrf
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-6 col-10">
                                        <input type="date" class="form-control @error('tanggal') is-invalid @enderror"
                                            id="tanggal" name="tanggal" value="{{ $formSvaSuratPemeriksaanRutin->tanggal ?? (date('Y-m-d', strtotime($workOrder->date_generate)) ?? '') }}"
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-6 col-10">
                                        <input type="text" class="form-control @error('nama_petugas_atc') is-invalid @enderror"
                                            id="nama_petugas_atc" name="nama_petugas_atc" value="{{ old('nama_petugas_atc') ?? $formSvaSuratPemeriksaanRutin->nama_petugas_atc }}"
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-6 col-10">
                                        <input type="time" class="form-control @error('jam_masuk') is-invalid @enderror"
                                            id="jam_masuk" name="jam_masuk" value="{{ old('jam_masuk') ?? $formSvaSuratPemeriksaanRutin->jam_masuk }}"
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-6 col-10">
                                        <input type="time" class="form-control @error('jam_keluar') is-invalid @enderror"
                                            id="jam_keluar" name="jam_keluar" value="{{ old('jam_keluar') ?? $formSvaSuratPemeriksaanRutin->jam_keluar }}"
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-6 col-10">
                                        <select class="form-control select2 @error('kendaraan') is-invalid @enderror"
                                            ...
                                            @if (
                                                $formSvaSuratPemeriksaanRutin->kendaraan == 'PICK UP' ||
                                                    $formSvaSuratPemeriksaanRutin->kendaraan ==
                                                        'U
                                                                                        U' ||
                                                    $formSvaSuratPemeriksaanRutin->kendaraan == 'ST. WAGON/MINIBUS' ||
                                                    $formSvaSuratPemeriksaanRutin->kendaraan == null)
                                                <option value="PICK UP"
                                                    {{ old('kendaraan') ?? $formSvaSuratPemeriksaanRutin->kendaraan == 'PICK UP' ? 'selected' : '' }}>
                                                    PICK UP
                                                </option>
                                                <option value="TRUCK"
                                                    {{ old('kendaraan') ?? $formSvaSuratPemeriksaanRutin->kendaraan == 'TRUCK' ? 'selected' : '' }}>
                                                    TRUCK
                                                </option>
                                                <option value="ST. WAGON/MINIBUS"
                                                    {{ old('kendaraan') ?? $formSvaSuratPemeriksaanRutin->kendaraan == 'ST. WAGON/MINIBUS' ? 'selected' : '' }}>
                                                    ST. WAGON/MINIBUS
                                                </option>
                                            @else
                                                <option value="{{ $formSvaSuratPemeriksaanRutin->kendaraan }}"
                                                    selected>
                                                    {{ $formSvaSuratPemeriksaanRutin->kendaraan }}
                                                </option>
                                                <option value="PICK UP">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-6 col-10">
                                        <input type="text" class="form-control @error('nomor_polisi') is-invalid @enderror"
                                            id="nomor_polisi" name="nomor_polisi" value="{{ old('nomor_polisi') ?? $formSvaSuratPemeriksaanRutin->nomor_polisi }}"
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-6 col-10">
                                        <input type="text" class="form-control @error('tujuan_keperluan') is-invalid @enderror"
                                            id="tujuan_keperluan" name="tujuan_keperluan" value="{{ old('tujuan_keperluan') ?? $formSvaSuratPemeriksaanRutin->tujuan_keperluan }}"
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-6 col-10">
                                        <input type="text" class="form-control @error('lokasi_pekerjaan') is-invalid @enderror"
                                            id="lokasi_pekerjaan" name="lokasi_pekerjaan" value="{{ $formSvaSuratPemeriksaanRutin->lokasi_pekerjaan ?? ($workOrder->asset->location->name ?? '') }}"
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-12">
                                        <textarea name="catatan" class="form-control @error('catatan') is-invalid @enderror" id="catatan" cols="30"
                                            rows="3" placeholder="Enter Catatan">{!! old('catatan') ?? $formSvaSuratPemeriksaanRutin->catatan !!}</textarea>
                                    </div>
                                </div>
                            </div>
                            <div class="container-fluid">
