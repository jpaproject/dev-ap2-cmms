...
@section('content')
    <section class="content">
        ...
        <form method="POST" action="{{ route('form.apm.elektrikal-vehicle-exterior-vv-tiga-bulanan.update', $detailWorkOrderForm) }}"
                            ...
                            <div id="collapseSeat1" class="show collapse"  aria-labelledby="1" data-parent="#accordionSeat1">
                                <div class="card-body">
                                    ...
                                    @foreach ($formApmElektrikalVehicleExteriorVVTigaBulanans as $key => $formApmElektrikalVehicleExteriorVVTigaBulanan)
                                        @if ($formApmElektrikalVehicleExteriorVVTigaBulanan->pemeriksaan_vv_group == 'VVVF INVERTER')
                                            <div class="row">
                                                <div
                                                    class="col-12 col-lg-3 d-flex justify-content-center align-items-center">
                                                    @if ($formApmElektrikalVehicleExteriorVVTigaBulanan->pemeriksaan_vv == 'a. Kondisi Line Switch (LS 1)' || $formApmElektrikalVehicleExteriorVVTigaBulanan->pemeriksaan_vv == 'a. Kondisi Line Switch (LS 2)' || $formApmElektrikalVehicleExteriorVVTigaBulanan->pemeriksaan_vv == 'a. Kondisi Line Switch (LS 3)')
                                                        <h5>{{ "8. " }}
                                                        {{ $formApmElektrikalVehicleExteriorVVTigaBulanan->pemeriksaan_vv }}</h5>
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-12">
                                                            <div class="form-group">
                                                                    ...
                                                                    <option value="ok"
                                                                        {{ old('hasil_mc1.' . $key) ?? $formApmElektrikalVehicleExteriorVVTigaBulanan->hasil_mc1 == 'ok' ? 'selected' : '' }}>
                                                                        Ok</option>
                                                                    <option value="nok"
                                                                        {{ old('hasil_mc1.' . $key) ?? $formApmElektrikalVehicleExteriorVVTigaBulanan->hasil_mc1 == 'nok' ? 'selected' : '' }}>
                                                                        Nok</option>
                                                                </select>
                                                        ...
                                                        {{-- <div class="col-6">
                                                            <div class="form-group">
                                                                <label class="d-flex justify-content-center">SIV
                                                                    ...
                                                                    <option selected value="">Choose Selection</option>
                                                                    <option value="ok"
                                                                        {{ old('hasil_mc2.' . $key) ?? $formApmElektrikalVehicleExteriorVVTigaBulanan->hasil_mc2 == 'ok' ? 'selected' : '' }}>
                                                                        Ok</option>
                                                                    <option value="nok"
                                                                        {{ old('hasil_mc2.' . $key) ?? $formApmElektrikalVehicleExteriorVVTigaBulanan->hasil_mc2 == 'nok' ? 'selected' : '' }}>
                                                                        Nok</option>
                                                                </select>
                                                    ...
                                                    <div class="form-group row">
                                                        <label class="d-flex justify-content-center">Referensi</label>
                                                            <textarea name="referensi[]" class="form-control @error('referensi.'.$key) is-invalid @enderror"
                                                                id="referensi" placeholder="Referensi">{!! $formApmElektrikalVehicleExteriorVVTigaBulanan->referensi !!}</textarea>
                                                    </div>
                                                </div>
                                            </div>
                                        @endif
