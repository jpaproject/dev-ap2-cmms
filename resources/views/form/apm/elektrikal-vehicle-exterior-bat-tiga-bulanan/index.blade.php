...
@endphp
    <section class="content">
        ...
        <form method="POST" action="{{ route('form.apm.elektrikal-vehicle-exterior-bat-tiga-bulanan.update', $detailWorkOrderForm) }}"
                            ...
                            <div id="collapseSeat1" class="collapse" aria-labelledby="1" data-parent="#accordionSeat1">
                                <div class="card-body">
                                    ...
                                    @foreach ($formApmElektrikalVehicleExteriorBATTigaBulanans as $key => $formApmElektrikalVehicleExteriorBATTigaBulanan)
                                        @if ($formApmElektrikalVehicleExteriorBATTigaBulanan->pemeriksaan_bat_group == 'BATTERY BOX')
                                            <div class="row">
                                                <div
                                                    class="col-12 col-lg-3 d-flex justify-content-center align-items-center">
                                                    <h5>{{ $loop->iteration }}.
                                                        {{ $formApmElektrikalVehicleExteriorBATTigaBulanan->pemeriksaan_bat }}</h5>
                                                </div>
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-12">
                                                            <div class="form-group">
                                                                    ...
                                                                    <option value="ok"
                                                                        {{ old('hasil_mc1.' . $key) ?? $formApmElektrikalVehicleExteriorBATTigaBulanan->hasil_mc1 == 'ok' ? 'selected' : '' }}>
                                                                        Ok</option>
                                                                    <option value="nok"
                                                                        {{ old('hasil_mc1.' . $key) ?? $formApmElektrikalVehicleExteriorBATTigaBulanan->hasil_mc1 == 'nok' ? 'selected' : '' }}>
                                                                        Nok</option>
                                                                </select>
                                                    ...
                                                    <div class="form-group row">
                                                        <label class="d-flex justify-content-center">Referensi</label>
                                                            <textarea readonly name="referensi[]" class="form-control @error('referensi.'.$key) is-invalid @enderror"
                                                                id="referensi" placeholder="Referensi">{!! $formApmElektrikalVehicleExteriorBATTigaBulanan->referensi !!}</textarea>
                                                    </div>
                                                </div>
                                            </div>
                                        @endif
                        ...
                        <div class="card">
                            ...
                            <div id="collapseSeat2" class="collapse" aria-labelledby="1" data-parent="#accordionSeat2">
                                <div class="card-body">
                                    @include('components.form-message')
                                    @foreach ($formApmElektrikalVehicleExteriorBATTigaBulanans as $key => $formApmElektrikalVehicleExteriorBATTigaBulanan)
                                        @if ($formApmElektrikalVehicleExteriorBATTigaBulanan->pemeriksaan_bat_group == 'BATTERY')
                                            <div class="row">
                                                <div
                                                    class="col-12 col-lg-3 d-flex justify-content-center align-items-center">
                                                    <h5>{{ $loop->iteration-4 }}.
                            ...
                            <div id="collapseSeat3" class="collapse" aria-labelledby="1" data-parent="#accordionSeat3">
                                <div class="card-body">
                                    ...
                                    @foreach ($formApmElektrikalVehicleExteriorBAThasilTigaBulanans as $key => $formApmElektrikalVehicleExteriorBAThasilTigaBulanan)
                                        @if ($formApmElektrikalVehicleExteriorBAThasilTigaBulanan->pemeriksaan_bat_group == 'NILAI BATTERY')
                                            <div class="row">
                                                <span class="col-12" style="text-align: center">@if ($formApmElektrikalVehicleExteriorBAThasilTigaBulanan->pemeriksaan_bat == 'batt 1')
                                                        <h2 style="text-align: center">{{ "RAK " }}{{ $number }} </h2>
                                                        <span></span>
                                                    @endif</span>
                                                    <hr>
                                                <div
                                                ...
                                                <div class="col-12 col-lg-9">
                                                    <div class="row">
                                                        ...
                                                        <div class="col-12">
                                                            <div class="form-group">
                                                                    <input type="number" class="form-control"  name="hasil_pengukuran[]"  placeholder="Masukan Hasil Pengukuran"></input>

                                                                @error('hasil_pengukuran[].' . $key)
                                                                    <span class="invalid-feedback" role="alert">
                                                                        <strong>{{ $message }}</strong>
                                                                    </span>
                                                                @enderror
                                                    ...
                                                    <div class="form-group row">
                                                        <label class="d-flex justify-content-center">Referensi</label>
                                                            <textarea readonly name="referensi[]" class="form-control @error('referensi.'.$key) is-invalid @enderror"
                                                                id="referensi" placeholder="Referensi">{!! $formApmElektrikalVehicleExteriorBAThasilTigaBulanan->referensi !!}</textarea>
                                                    </div>
                                                </div>
                                            </div>
                                            @if ($formApmElektrikalVehicleExteriorBAThasilTigaBulanan->pemeriksaan_bat == 'batt 7')
                                                    @php
                                                        $number++;
                                                        $numberow = 1;
                                                    @endphp
