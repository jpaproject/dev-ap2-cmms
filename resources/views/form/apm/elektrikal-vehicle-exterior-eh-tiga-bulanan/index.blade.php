...
@section('content')
    <section class="content">
        ...
        <form method="POST" action="{{ route('form.apm.elektrikal-vehicle-exterior-eh-tiga-bulanan.update', $detailWorkOrderForm) }}"
                        ...
                        <div class="card">
                            ...
                            <div id="collapseSeat1" class="show collapse"  aria-labelledby="1" data-parent="#accordionSeat1">
                                <div class="card-body">
                                    ...
                                    @foreach ($formApmElektrikalVehicleExteriorEHTigaBulanans as $key => $formApmElektrikalVehicleExteriorEHTigaBulanan)
                                        @if ($formApmElektrikalVehicleExteriorEHTigaBulanan->pemeriksaan_eh_group == 'ELECTRIC HORN MC 1')
                                        @if ($formApmElektrikalVehicleExteriorEHTigaBulanan->pemeriksaan_eh == 'Lakukan pengukuran tegangan input')
                                            <div class="row">
                                                <div
                                                    ...
                                                    <h5>{{ $loop->iteration }}
                                                        {{ $formApmElektrikalVehicleExteriorEHTigaBulanan->pemeriksaan_eh }}</h5>
                                                </div>
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-6">
                                                            <div class="form-group">
                                                                <label class="d-flex justify-content-center">HORN
                                                                    (R)</label>
                                                        ...
                                                        <div class="col-6">
                                                            <div class="form-group">
                                                                <label class="d-flex justify-content-center">HORN
                                                                    (L)</label>
                                                                    <textarea type="text" name="hasil_mc2[]" class="container-fluid" placeholder="Masukan Hasil Pengukuran"></textarea>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="form-group row">
                                                        <label class="d-flex justify-content-center">Referensi</label>
                                                            <textarea name="referensi[]" class="form-control @error('referensi.'.$key) is-invalid @enderror"
                                                                id="referensi" placeholder="Referensi">{!! $formApmElektrikalVehicleExteriorEHTigaBulanan->referensi !!}</textarea>
                                                    </div>
                                        @else
                                            <div class="row">
                                                <div
                                                        ...
                                                        <div class="col-6">
                                                            <div class="form-group">
                                                                <label class="d-flex justify-content-center">HORN
                                                                    ...
                                                                    <option value="ok"
                                                                        {{ old('hasil_mc1.' . $key) ?? $formApmElektrikalVehicleExteriorEHTigaBulanan->hasil_mc1 == 'ok' ? 'selected' : '' }}>
                                                                        Ok</option>
                                                                    <option value="nok"
                                                                        {{ old('hasil_mc1.' . $key) ?? $formApmElektrikalVehicleExteriorEHTigaBulanan->hasil_mc1 == 'nok' ? 'selected' : '' }}>
                                                                        Nok</option>
                                                                </select>
                                                        ...
                                                        <div class="col-6">
                                                            <div class="form-group">
                                                                <label class="d-flex justify-content-center">HORN
                                                                    ...
                                                                    <option selected value="">Choose Selection</option>
                                                                    <option value="ok"
                                                                        {{ old('hasil_mc2.' . $key) ?? $formApmElektrikalVehicleExteriorEHTigaBulanan->hasil_mc2 == 'ok' ? 'selected' : '' }}>
                                                                        Ok</option>
                                                                    <option value="nok"
                                                                        {{ old('hasil_mc2.' . $key) ?? $formApmElektrikalVehicleExteriorEHTigaBulanan->hasil_mc2 == 'nok' ? 'selected' : '' }}>
                                                                        Nok</option>
                                                                </select>
                        ...
                        <div class="card">
                            ...
                            <div id="collapseSeat2" class=" collapse"  aria-labelledby="1" data-parent="#accordionSeat2">
                                <div class="card-body">
                                    @include('components.form-message')
                                    @foreach ($formApmElektrikalVehicleExteriorEHTigaBulanans as $key => $formApmElektrikalVehicleExteriorEHTigaBulanan)
                                        @if ($formApmElektrikalVehicleExteriorEHTigaBulanan->pemeriksaan_eh_group == 'ELECTRIC HORN MC 2')
                                        @if ($formApmElektrikalVehicleExteriorEHTigaBulanan->pemeriksaan_eh == 'Lakukan pengukuran tegangan input')
                                            <div class="row">
                                                <div
                                                    class="col-12 col-lg-3 d-flex justify-content-center align-items-center">
