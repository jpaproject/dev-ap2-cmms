...
@section('content')
    <section class="content">
        ...
        <form method="POST" action="{{ route('form.apm.vehicle-mingguan.update', $detailWorkOrderForm) }}"
                                    ...
                                    @foreach ($formApmMekanikalVehicleMingguans as $key => $formApmMekanikalVehicleMingguan)
                                            <div class="row">
                                                <div
                                                    ...
                                                    <h5>
                                                        {{ $formApmMekanikalVehicleMingguan->pemeriksaan_mingguan }}
                                                    {{ $loop->iteration }}</h5>
                                                </div>
                                                        ...
                                                        <div class="col-6">
                                                            <div class="form-group">
                                                                <label class="d-flex justify-content-center">MC
                                                                    ...
                                                                    <option value="ok"
                                                                        {{ old('hasil_mc1.' . $key) ?? $formApmMekanikalVehicleMingguan->hasil_mc1 == 'ok' ? 'selected' : '' }}>
                                                                        Ok</option>
                                                                    <option value="nok"
                                                                        {{ old('hasil_mc1.' . $key) ?? $formApmMekanikalVehicleMingguan->hasil_mc1 == 'nok' ? 'selected' : '' }}>
                                                                        Nok</option>
                                                                </select>
                                                        ...
                                                        <div class="col-6">
                                                            <div class="form-group">
                                                                <label class="d-flex justify-content-center">MC
                                                                    ...
                                                                    <option selected value="">Choose Selection</option>
                                                                    <option value="ok"
                                                                        {{ old('hasil_mc2.' . $key) ?? $formApmMekanikalVehicleMingguan->hasil_mc2 == 'ok' ? 'selected' : '' }}>
                                                                        Ok</option>
                                                                    <option value="nok"
                                                                        {{ old('hasil_mc2.' . $key) ?? $formApmMekanikalVehicleMingguan->hasil_mc2 == 'nok' ? 'selected' : '' }}>
                                                                        Nok</option>
                                                                </select>
                                                    ...
                                                    <div class="form-group row">
                                                        <label class="d-flex justify-content-center">Referensi</label>
                                                            <textarea name="referensi[]" class="form-control @error('referensi.'.$key) is-invalid @enderror"
                                                                id="referensi" placeholder="Referensi">{!! $formApmMekanikalVehicleMingguan->referensi !!}</textarea>
                                                    </div>
                                                </div>
                                            </div>
                                            @if(!$loop->last)
