...
@section('content')
    <section class="content">
        <form method="POST" action="{{ route('form.apm.vehicle-carbody-harian.update', $detailWorkOrderForm) }}"
            ...
            @if ($formApmVehicleCarBodyHarians->isNotEmpty())
                        ...
                        <div class="card">
                            ...
                            <div id="collapseSeat1" class="collapse" aria-labelledby="1" data-parent="#accordionSeat1">
                                <div class="card-body">
                                    ...
                                    @foreach ($formApmVehicleCarBodyHarians as $key => $formApmVehicleCarBodyHarian)
                                        @if ($formApmVehicleCarBodyHarian->pemeriksaan_carbody_group == 'Kursi / Seat')
                                            <div class="row">
                                                <div
                                                    class="col-12 col-lg-3 d-flex justify-content-center align-items-center">
                                                    <h5>{{ $formApmVehicleCarBodyHarian->pemeriksaan_carbody }}</h5>
                                                </div>
                                                        ...
                                                        <div class="col-6">
                                                            <div class="form-group">
                                                                <label class="d-flex justify-content-center">MC
                                                                    ...
                                                                    <option value="ok"
                                                                        {{ old('hasil_mc1.' . $key) ?? $formApmVehicleCarBodyHarian->hasil_mc1 == 'ok' ? 'selected' : '' }}>
                                                                        Ok</option>
                                                                    <option value="nok"
                                                                        {{ old('hasil_mc1.' . $key) ?? $formApmVehicleCarBodyHarian->hasil_mc1 == 'nok' ? 'selected' : '' }}>
                                                                        Nok</option>
                                                                </select>
                                                        ...
                                                        <div class="col-6">
                                                            <div class="form-group">
                                                                <label class="d-flex justify-content-center">MC
                                                                    ...
                                                                    <option selected value="">Choose Selection</option>
                                                                    <option value="ok"
                                                                        {{ old('hasil_mc2.' . $key) ?? $formApmVehicleCarBodyHarian->hasil_mc2 == 'ok' ? 'selected' : '' }}>
                                                                        Ok</option>
                                                                    <option value="nok"
                                                                        {{ old('hasil_mc2.' . $key) ?? $formApmVehicleCarBodyHarian->hasil_mc2 == 'nok' ? 'selected' : '' }}>
                                                                        Nok</option>
                                                                </select>
                                                    ...
                                                    <div class="form-group row">
                                                        <label class="d-flex justify-content-center">Referensi</label>
                                                            <textarea readonly name="referensi[]" class="form-control @error('referensi.'.$key) is-invalid @enderror"
                                                                id="referensi" placeholder="Referensi">{!! $formApmVehicleCarBodyHarian->referensi !!}</textarea>
                                                    </div>
                                                </div>
                                            </div>
                                        @endif
                ...
                {{-- Gangways --}}
                <div class="container-fluid">
                    <div class="accordion" id="accordionGangway1">
                        <div class="card">
                            <div class="card-header" id="1">
                                <h2 class="mb-0">
                                    <button class="btn btn-link btn-block text-left" type="button" data-toggle="collapse"
                                        data-target="#collapseGangway1" aria-expanded="true" aria-controls="collapseGangway1"
                                        onclick="showHide(this)">
                                        <i class="fas fa-chevron-up d-flex justify-content-end" id="accordion"></i>
                                        Gangway
                                    </button>
                            ...
                            <div id="collapseGangway1" class="collapse" aria-labelledby="1" data-parent="#accordionGangway1">
                                <div class="card-body">
                                    @include('components.form-message')
                                    @foreach ($formApmVehicleCarBodyHarians as $key => $formApmVehicleCarBodyHarian)
                                        @if ($formApmVehicleCarBodyHarian->pemeriksaan_carbody_group == 'Gangway')
                                            <div class="row">
                                                <div
                                                    class="col-12 col-lg-3 d-flex justify-content-center align-items-center">
                                                    <h5>
                                                        {{ $formApmVehicleCarBodyHarian->pemeriksaan_carbody }}</h5>
                                                </div>
                                                <div class="col-12 col-lg-9">
                                                    <div class="row">
                                                        <span
