...
@section('content')
    <section class="content">
        ...
        <form method="POST" action="{{ route('form.apm.vehicle-air-brake-system-harian.update', $detailWorkOrderForm) }}"
                ...
                <div class="container-fluid">
                    <div class="accordion" id="accordionAir1">
                        <div class="card">
                            ...
                            <div id="collapseAir1" class="show collapse" aria-labelledby="1" data-parent="#accordionAir1">
                                <div class="card-body">
                                    @include('components.form-message')
                                    @foreach ($formApmVehicleAirBrakeSystemHarians as $key => $formApmVehicleAirBrakeSystemHarian)
                                        @if ($formApmVehicleAirBrakeSystemHarian->pemeriksaan_air_brake_system_group == 'AIR COMPRESSOR')
                                        <input type="hidden" name="hasil_mc2[]" value="">
                                            <div class="row">
                                                <div
                                                    class="col-12 col-lg-3 d-flex justify-content-center align-items-center">
                                                    <h5>
                                                        {{ $formApmVehicleAirBrakeSystemHarian->pemeriksaan_air_brake_system }}</h5>
                                                </div>
                                                <div class="col-12 col-lg-9">
                                                        ...
                                                        <div class="col-12">
                                                            <div class="form-group">
                                                                <label class="d-flex justify-content-center">MC
                                                                    ...
                                                                    <option value="ok"
                                                                        {{ old('hasil_mc1.' . $key) ?? $formApmVehicleAirBrakeSystemHarian->hasil_mc1 == 'ok' ? 'selected' : '' }}>
                                                                        Ok</option>
                                                                    <option value="nok"
                                                                        {{ old('hasil_mc1.' . $key) ?? $formApmVehicleAirBrakeSystemHarian->hasil_mc1 == 'nok' ? 'selected' : '' }}>
                                                                        Nok</option>
                                                                </select>
                                                    ...
                                                    <div class="form-group row">
                                                        <label class="d-flex justify-content-center">Referensi</label>
                                                            <textarea readonly name="referensi[]" class="form-control @error('referensi.'.$key) is-invalid @enderror"
                                                                id="referensi" placeholder="Referensi">{!! $formApmVehicleAirBrakeSystemHarian->referensi !!}</textarea>
                                                    </div>
                                                </div>
                                            </div>
                                        @endif
                ...
                <div class="container-fluid">
                    <div class="accordion" id="accordionAir3">
                        <div class="card">
                            ...
                            <div id="collapseAir3" class="show collapse" aria-labelledby="1" data-parent="#accordionAir3">
                                <div class="card-body">
                                    @include('components.form-message')
                                    @foreach ($formApmVehicleAirBrakeSystemHarians as $key => $formApmVehicleAirBrakeSystemHarian)
                                        @if ($formApmVehicleAirBrakeSystemHarian->pemeriksaan_air_brake_system_group == 'TWIN TOWER AIR DRYER')
                                            <div class="row">
                                                <div
                                                    class="col-12 col-lg-3 d-flex justify-content-center align-items-center">
                                                    <h5>
                                                        ...
                                                        <div class="col-6">
                                                            <div class="form-group">
                                                                <label class="d-flex justify-content-center">MC
                                                                    ...
                                                                    <option selected value="">Choose Selection</option>
                                                                    <option value="ok"
                                                                        {{ old('hasil_mc2.' . $key) ?? $formApmVehicleAirBrakeSystemHarian->hasil_mc2 == 'ok' ? 'selected' : '' }}>
                                                                        Ok</option>
                                                                    <option value="nok"
                                                                        {{ old('hasil_mc2.' . $key) ?? $formApmVehicleAirBrakeSystemHarian->hasil_mc2 == 'nok' ? 'selected' : '' }}>
                                                                        Nok</option>
                                                                </select>
                ...
                <div class="container-fluid">
                    <div class="accordion" id="accordionAir4">
                        <div class="card">
                            ...
                            <div id="collapseAir4" class="show collapse" aria-labelledby="1" data-parent="#accordionAir4">
                                <div class="card-body">
                                    @include('components.form-message')
                                    @foreach ($formApmVehicleAirBrakeSystemHarians as $key => $formApmVehicleAirBrakeSystemHarian)
                                        @if ($formApmVehicleAirBrakeSystemHarian->pemeriksaan_air_brake_system_group == 'MIKRO_FILTER')
                                            <div class="row">
                                                <div
                                                    class="col-12 col-lg-3 d-flex justify-content-center align-items-center">
                                                    <h5>
                ...
                <div class="container-fluid">
                    <div class="accordion" id="accordionAir7">
                        <div class="card">
                            ...
                            <div id="collapseAir7" class="show collapse" aria-labelledby="1" data-parent="#accordionAir7">
                                <div class="card-body">
                                    @include('components.form-message')
                                    @foreach ($formApmVehicleAirBrakeSystemHarians as $key => $formApmVehicleAirBrakeSystemHarian)
                                        @if ($formApmVehicleAirBrakeSystemHarian->pemeriksaan_air_brake_system_group == 'PRESSURE_SWITCH')
                                            <div class="row">
                                                <div
                ...
                <div class="container-fluid">
                    <div class="accordion" id="accordionAir5">
                        <div class="card">
                            ...
                            <div id="collapseAir5" class="show collapse" aria-labelledby="1" data-parent="#accordionAir5">
                                <div class="card-body">
                                    @include('components.form-message')
                                    @foreach ($formApmVehicleAirBrakeSystemHarians as $key => $formApmVehicleAirBrakeSystemHarian)
                                        @if ($formApmVehicleAirBrakeSystemHarian->pemeriksaan_air_brake_system_group == 'AIR_FILTER')
                                            <div class="row">
                                                <div
                                                    class="col-12 col-lg-3 d-flex justify-content-center align-items-center">
                                                    <h5>
                ...
                <div class="container-fluid">
                    <div class="accordion" id="accordionAir2">
                        <div class="card">
                            ...
                            <div id="collapseAir2" class="show collapse" aria-labelledby="1" data-parent="#accordionAir2">
                                <div class="card-body">
                                    @include('components.form-message')
                                    @foreach ($formApmVehicleAirBrakeSystemHarians as $key => $formApmVehicleAirBrakeSystemHarian)
                                        @if ($formApmVehicleAirBrakeSystemHarian->pemeriksaan_air_brake_system_group == 'EP_BRAKE_VALVE')
                                            <div class="row">
                                                <div
                                                    class="col-12 col-lg-3 d-flex justify-content-center align-items-center">
                                                    <h5>
