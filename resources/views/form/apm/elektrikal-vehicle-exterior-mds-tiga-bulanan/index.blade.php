...
@section('content')
    <section class="content">
        ...
        <form method="POST" action="{{ route('form.apm.elektrikal-vehicle-exterior-mds-tiga-bulanan.update', $detailWorkOrderForm) }}"
                        ...
                        <div class="card">
                            ...
                            <div id="collapseSeat1" class="show collapse"  aria-labelledby="1" data-parent="#accordionSeat1">
                                <div class="card-body">
                                    ...
                                    @foreach ($formApmElektrikalVehicleExteriorMDSTigaBulanans as $key => $formApmElektrikalVehicleExteriorMDSTigaBulanan)
                                        @if ($formApmElektrikalVehicleExteriorMDSTigaBulanan->pemeriksaan_mds_group == 'MDS BOX')
                                        <input type="hidden" name="hasil_mc2[]" value="">    
                                        <div class="row">
                                                <div
                                                    class="col-12 col-lg-3 d-flex justify-content-center align-items-center">
                                                    @if ($formApmElektrikalVehicleExteriorMDSTigaBulanan->pemeriksaan_mds == 'a. MS (Main Switch)' || $formApmElektrikalVehicleExteriorMDSTigaBulanan->pemeriksaan_mds == 'b. DS ( Disconecting Switch )' || $formApmElektrikalVehicleExteriorMDSTigaBulanan->pemeriksaan_mds == 'c. GS ( Grounding Switch )')
                                                    <h5>{{ "5. " }}
                                                        {{ $formApmElektrikalVehicleExteriorMDSTigaBulanan->pemeriksaan_mds }}</h5>
                                                        
                                                    @elseif($loop->iteration == 8)
                                                    <h5>{{ $loop->iteration - 2 }}
                                                        {{ $formApmElektrikalVehicleExteriorMDSTigaBulanan->pemeriksaan_mds }}</h5>
                                                    @else <h5>{{ $loop->iteration }}
                                                        {{ $formApmElektrikalVehicleExteriorMDSTigaBulanan->pemeriksaan_mds }}</h5>
                                                    @endif
                                                </div>
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-12">
                                                            <div class="form-group">
                                                                    ...
                                                                    <option value="ok"
                                                                        {{ old('hasil_mc1.' . $key) ?? $formApmElektrikalVehicleExteriorMDSTigaBulanan->hasil_mc1 == 'ok' ? 'selected' : '' }}>
                                                                        Ok</option>
                                                                    <option value="nok"
                                                                        {{ old('hasil_mc1.' . $key) ?? $formApmElektrikalVehicleExteriorMDSTigaBulanan->hasil_mc1 == 'nok' ? 'selected' : '' }}>
                                                                        Nok</option>
                                                                </select>
                                                        ...
                                                        {{-- <div class="col-6">
                                                            <div class="form-group">
                                                                <label class="d-flex justify-content-center">VAC
                                                                    2</label>
                                                                    <select class="form-control  @error('hasil_mc2.' . $key) is-invalid @enderror"
                                                                    name="hasil_mc2[]">
                                                                    <option selected value="">Choose Selection</option>
                                                                    <option value="ok"
                                                                        {{ old('hasil_mc2.' . $key) ?? $formApmElektrikalVehicleExteriorMDSTigaBulanan->hasil_mc2 == 'ok' ? 'selected' : '' }}>
                                                                        Ok</option>
                                                                    <option value="nok"
                                                                        {{ old('hasil_mc2.' . $key) ?? $formApmElektrikalVehicleExteriorMDSTigaBulanan->hasil_mc2 == 'nok' ? 'selected' : '' }}>
                                                                        Nok</option>
                                                                </select>
                                                    ...
                                                    <div class="form-group row">
                                                        <label class="d-flex justify-content-center">Referensi</label>
                                                            <textarea name="referensi[]" class="form-control @error('referensi.'.$key) is-invalid @enderror"
                                                                id="referensi" placeholder="Referensi">{!! $formApmElektrikalVehicleExteriorMDSTigaBulanan->referensi !!}</textarea>
                                                    </div>
                                                </div>
                                            </div>
                                        @endif
                        ...
                        <div class="card">
                            ...
                            <div id="collapseSeat2" class=" collapse"  aria-labelledby="1" data-parent="#accordionSeat2">
                                <div class="card-body">
                                    @include('components.form-message')
                                    @foreach ($formApmElektrikalVehicleExteriorMDSTigaBulanans as $key => $formApmElektrikalVehicleExteriorMDSTigaBulanan)
                                        @if ($formApmElektrikalVehicleExteriorMDSTigaBulanan->pemeriksaan_mds_group == 'FUSE BOX')
                                            <div class="row">
                                                <div
                                                    class="col-12 col-lg-3 d-flex justify-content-center align-items-center">
                                                    <h5>{{ $loop->iteration - 8 }}
