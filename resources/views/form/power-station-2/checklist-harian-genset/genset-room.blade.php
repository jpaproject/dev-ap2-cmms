...
@section('content')
    <section class="content">
        ...
        <form method="POST"
            action="{{ route('form.ps2.checklist-harian-genset-ps2.genset-room.update', $detailWorkOrderForm->id) }}"
            id="form">
            @method('patch')
            @csrf
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-12 col-lg-9">
                                        ...
                                        <textarea name="catatan" class="form-control @error('remote-orders-rcms') is-invalid @enderror" id="catatan"
                                            placeholder="Deskripsi">{!! $checklistHarianGensetPs2GensetRooms[0]->catatan ?? '' !!}</textarea>
                                    </div>
                                </div>
                            </div>
                        </div>
