...
@section('content')
    <form method="POST" action="{{ route('form.ps3.genset-dua-mingguan.update', $detailWorkOrderForm->id) }}"
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-12 col-md-4 col-lg-4 form-group">
                                            ...
                                            <select class="form-control @error('level_oli_mesin.'.$key) is-invalid @enderror"
                                                ...
                                                <option value="low"
                                                    {{ (old('level_oli_mesin.'.$key) ?? $formPs3GensetDuaMingguan->level_oli_mesin) == 'low' ? 'selected' : '' }}>
                                                    Low</option>
                                                <option value="med"
                                                    {{ (old('level_oli_mesin.'.$key) ?? $formPs3GensetDuaMingguan->level_oli_mesin) == 'med' ? 'selected' : '' }}>
                                                    Med</option>
                                                <option value="max"
                                                    {{ (old('level_oli_mesin..'.$key) ?? $formPs3GensetDuaMingguan->level_oli_mesin) == 'max' ? 'selected' : '' }}>
                                                    Max</option>
                                            </select>
                                        ...
                                        <div class="col-sm-12 col-md-4 col-lg-4 form-group">
                                            ...
                                            <select class="form-control @error('level_air_radiator.'.$key) is-invalid @enderror"
                                                ...
                                                <option value="" selected>Choose Selection</option>
                                                <option value="low"
                                                    {{ (old('level_air_radiator.'.$key) ?? $formPs3GensetDuaMingguan->level_air_radiator) == 'low' ? 'selected' : '' }}>
                                                    Low</option>
                                                <option value="med"
                                                    {{ (old('level_air_radiator.'.$key) ?? $formPs3GensetDuaMingguan->level_air_radiator) == 'med' ? 'selected' : '' }}>
                                                    Med</option>
                                                <option value="max"
                                                    {{ (old('level_air_radiator.'.$key) ?? $formPs3GensetDuaMingguan->level_air_radiator) == 'max' ? 'selected' : '' }}>
                                                    Max</option>
                                            </select>
                                        ...
                                        <div class="col-sm-12 col-md-4 col-lg-4 form-group">
                                            ...
                                            <select class="form-control @error('level_air_battery.'.$key) is-invalid @enderror"
                                                ...
                                                <option value="" selected>Choose Selection</option>
                                                <option value="low"
                                                    {{ (old('level_air_battery.'.$key) ?? $formPs3GensetDuaMingguan->level_air_battery) == 'low' ? 'selected' : '' }}>
                                                    Low</option>
                                                <option value="med"
                                                    {{ (old('level_air_battery.'.$key) ?? $formPs3GensetDuaMingguan->level_air_battery) == 'med' ? 'selected' : '' }}>
                                                    Med</option>
                                                <option value="max"
                                                    {{ (old('level_air_battery.'.$key) ?? $formPs3GensetDuaMingguan->level_air_battery) == 'max' ? 'selected' : '' }}>
                                                    Max</option>
                                            </select>
                                        ...
                                        <div class="col-sm-11 col-md-4 col-lg-4 form-group">
                                            ...
                                            <input type="text"
                                                ...
                                                value="{{ old('level_bahan_bakar.'.$key) ?? $formPs3GensetDuaMingguan->level_bahan_bakar }}"
                                                placeholder="">
                                        ...
                                        <div class="col-sm-11 col-md-4 col-lg-4 form-group">
                                            ...
                                            <input type="text"
                                                ...
                                                value="{{ old('tegangan_battery_starter.'.$key) ?? $formPs3GensetDuaMingguan->tegangan_battery_starter }}"
                                                placeholder="">
                                        ...
                                        <div class="col-sm-11 col-md-4 col-lg-4 form-group">
                                            ...
                                            <input type="text"
                                                ...
                                                value="{{ old('coolant_temperature.'.$key) ?? $formPs3GensetDuaMingguan->coolant_temperature }}"
                                                placeholder="">
                                        ...
                                        <div class="col-sm-11 col-md-4 col-lg-4 form-group">
                                            ...
                                            <input type="text"
                                                ...
                                                value="{{ old('hour_meter.'.$key) ?? $formPs3GensetDuaMingguan->hour_meter }}"
                                                placeholder="">
                                        ...
                                        <div class="col-sm-11 col-md-4 col-lg-4 form-group">
                                            ...
                                            <input type="text"
                                                ...
                                                value="{{ old('alternator_heater.'.$key) ?? $formPs3GensetDuaMingguan->alternator_heater }}"
                                                placeholder="">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-12 col-lg-9">
                                        ...
                                        <textarea name="catatan" class="form-control @error('catatan') is-invalid @enderror" id="catatan"
                                            placeholder="Deskripsi">{!! $formPs3GensetDuaMingguans[0]->catatan ??
