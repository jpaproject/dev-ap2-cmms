...
@section('content')
    <form method="POST" action="{{ route('form.ps3.trafo-tiga-bulanan.update', $detailWorkOrderForm->id) }}"
                            ...
                            <div class="card-body">
                                ...
                                @foreach ($formPs3TrafoTigaBulanans as $key => $formPs3TrafoTigaBulanan)
                                    <div class="col-12 d-flex justify-content-center align-items-center">
                                        <h5>TRAFO {{ $formPs3TrafoTigaBulanan->type }} </h5>
                                    </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-12 col-lg-10 d-flex justify-content-center align-items-center">
                                                <input type="text"
                                                    ...
                                                    value="{{ old('phase_a.' . $key) ?? $formPs3TrafoTigaBulanan->phase_a }}"
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-12 col-lg-10 d-flex justify-content-center align-items-center">
                                                <input type="text"
                                                    ...
                                                    value="{{ old('phase_b.' . $key) ?? $formPs3TrafoTigaBulanan->phase_b }}"
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-12 col-lg-10 d-flex justify-content-center align-items-center">
                                                <input type="text"
                                                    ...
                                                    value="{{ old('phase_c.' . $key) ?? $formPs3TrafoTigaBulanan->phase_c }}"
