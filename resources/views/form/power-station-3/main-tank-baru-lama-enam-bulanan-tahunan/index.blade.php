...
@section('content')
    <form method="POST" action="{{ route('form.ps3.main-tank-baru-lama-enam-bulanan-tahunan.update', $detailWorkOrderForm->id) }}"
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-10 col-lg-7 d-flex justify-content-center align-items-center">
                                            <input type="text"
                                                ...
                                                value="{{ old('main_tank1') ?? $formPs3MainTankBaruLamaEnamBulananTahunan->main_tank1 }}"
                                                placeholder="">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-10 col-lg-7 d-flex justify-content-center align-items-center">
                                            <input type="text"
                                                ...
                                                value="{{ old('main_tank2') ?? $formPs3MainTankBaruLamaEnamBulananTahunan->main_tank2 }}"
                                                placeholder="">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-10 col-lg-7 d-flex justify-content-center align-items-center">
                                            <input type="text"
                                                ...
                                                value="{{ old('main_tank3') ?? $formPs3MainTankBaruLamaEnamBulananTahunan->main_tank3 }}"
                                                placeholder="">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-12 col-lg-9">
                                            ...
                                            <textarea name="catatan" class="form-control @error('catatan') is-invalid @enderror" id="catatan"
                                                placeholder="Deskripsi">{!! $formPs3MainTankBaruLamaEnamBulananTahunan->catatan ??
