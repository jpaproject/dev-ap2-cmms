...
@section('content')
    <form method="POST" action="{{ route('form.ps3.sump-tank-baru-enam-bulanan-tahunan.update', $detailWorkOrderForm->id) }}"
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-10 col-lg-7 d-flex justify-content-center align-items-center">
                                            <input type="text"
                                                ...
                                                value="{{ old('sump_tank1') ?? $formPs3SumpTankBaruEnamBulananTahunan->sump_tank1 }}"
                                                placeholder="">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-12 col-lg-9">
                                            ...
                                            <textarea name="catatan" class="form-control @error('catatan') is-invalid @enderror" id="catatan"
                                                placeholder="Deskripsi">{!! $formPs3SumpTankBaruEnamBulananTahunan->catatan ??
