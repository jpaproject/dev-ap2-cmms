            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="card card-primary">
                        ...
                        <form method="POST"
                            action="{{ route('form.ele.surat-izin-pelaksanaan-pekerjaan.update', $detailWorkOrderForm->id) }}"
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-6 col-10">
                                        <input type="date" class="form-control @error('tanggal') is-invalid @enderror"
                                            ...
                                            value="{{ $formEleSuratIzinPelaksanaanPekerjaan->tanggal ?? (date('Y-m-d', strtotime($workOrder->date_generate)) ?? '') }}"
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-6 col-10">
                                        <input type="text"
                                            class="form-control @error('nama_petugas_atc') is-invalid @enderror"
                                            id="nama_petugas_atc" name="nama_petugas_atc"
                                            value="{{ old('nama_petugas_atc') ?? $formEleSuratIzinPelaksanaanPekerjaan->nama_petugas_atc }}"
                                            placeholder="Enter Nama Petugas Atc">

                                        @error('nama_petugas_atc')
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                                            </span>
                                        @enderror
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-6 col-10">
                                        <input type="time" class="form-control @error('jam_masuk') is-invalid @enderror"
                                            ...
                                            value="{{ old('jam_masuk') ?? $formEleSuratIzinPelaksanaanPekerjaan->jam_masuk }}"
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-6 col-10">
                                        <input type="time" class="form-control @error('jam_keluar') is-invalid @enderror"
                                            ...
                                            value="{{ old('jam_keluar') ?? $formEleSuratIzinPelaksanaanPekerjaan->jam_keluar }}"
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-6 col-10">
                                        <select class="form-control select2 @error('kendaraan') is-invalid @enderror"
                                            ...
                                            @if (
                                                $formEleSuratIzinPelaksanaanPekerjaan->kendaraan == 'PICK UP' ||
                                                    $formEleSuratIzinPelaksanaanPekerjaan->kendaraan ==
                                                        'U
                                                                                        U' ||
                                                    $formEleSuratIzinPelaksanaanPekerjaan->kendaraan == 'ST. WAGON/MINIBUS' ||
                                                    $formEleSuratIzinPelaksanaanPekerjaan->kendaraan == null)
                                                <option value="PICK UP"
                                                    {{ old('kendaraan') ?? $formEleSuratIzinPelaksanaanPekerjaan->kendaraan == 'PICK UP' ? 'selected' : '' }}>
                                                    PICK UP
                                                </option>
                                                <option value="TRUCK"
                                                    {{ old('kendaraan') ?? $formEleSuratIzinPelaksanaanPekerjaan->kendaraan == 'TRUCK' ? 'selected' : '' }}>
                                                    TRUCK
                                                </option>
                                                <option value="ST. WAGON/MINIBUS"
                                                    {{ old('kendaraan') ?? $formEleSuratIzinPelaksanaanPekerjaan->kendaraan == 'ST. WAGON/MINIBUS' ? 'selected' : '' }}>
                                                    ST. WAGON/MINIBUS
                                                </option>
                                            @else
                                                <option value="{{ $formEleSuratIzinPelaksanaanPekerjaan->kendaraan }}"
                                                    selected>
                                                    {{ $formEleSuratIzinPelaksanaanPekerjaan->kendaraan }}
                                                </option>
                                                <option value="PICK UP">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-6 col-10">
                                        <input type="text"
                                            ...
                                            value="{{ old('nomor_polisi') ?? $formEleSuratIzinPelaksanaanPekerjaan->nomor_polisi }}"
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-6 col-10">
                                        <input type="text"
                                            class="form-control @error('jumlah_personil') is-invalid @enderror mb-2 mt-2"
                                            id="jumlah_personil" name="jumlah_personil"
                                            value="{{ count($userTechnicals)}}"
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-6 col-10">
                                        <input type="text"
                                            class="form-control @error('tujuan_keperluan') is-invalid @enderror"
                                            id="tujuan_keperluan" name="tujuan_keperluan"
                                            value="{{ old('tujuan_keperluan') ?? $formEleSuratIzinPelaksanaanPekerjaan->tujuan_keperluan }}"
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-6 col-10">
                                        <input type="text"
                                            ...
                                            value="{{ $formEleSuratIzinPelaksanaanPekerjaan->lokasi_pekerjaan ?? ($workOrder->asset->location->name ?? '') }}"
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-12">
                                        <textarea name="catatan" class="form-control @error('catatan') is-invalid @enderror" id="catatan" cols="30"
                                            rows="3" placeholder="Enter Catatan">{!! old('catatan') ?? $formEleSuratIzinPelaksanaanPekerjaan->catatan !!}</textarea>
                                    </div>
                                </div>
                            </div>
                            <div class="container-fluid">
