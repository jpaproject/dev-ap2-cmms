...
@section('content')
    <section class="content">
        <form method="POST" action="{{ route('form.ele.checklist2.update', $detailWorkOrderForm->id) }}" enctype="multipart/form-data"
            id="form">
            @method('patch')
            @csrf
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-3 col-10">
                                        <input type="date" class="w-100" name="tanggal" value="{{$formEleChecklist2HarianSelatans[0]->tanggal}}">
                                    </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-3 col-10">
                                        <input type="time" class="w-100" name="jam" value="{{$formEleChecklist2HarianSelatans[0]->jam}}">
                                    </div>
                    ...
                    <div class="card card-primary">
                        <div class="card-header">
                            ...
                            <div class="card-body">
                                ...
                                @include('components.form-message')
                                    @foreach ($formEleChecklist2HarianUtaras as $key => $utara)

                                <div class="form-group row">
                                    <label class="col-12 col-lg-4">{{$loop->iteration}}. {{$utara['pertanyaan']}}</label>
                                    <div class="col-lg-4 col-12">
                                                <label for="">Hasil</label>
                                        <select class="form-control" aria-label="Default select example" name="hasil_utara[]">
                                            <option value="" selected>Open this select menu</option>
                                            <option value="baik"
                                                {{ (old('hasil.' . $key) ?? $utara->hasil) == 'baik' ? 'selected' : '' }}
                                            >BAIK</option>
                                            <option value="rusak"
                                                {{ (old('hasil.' . $key) ?? $utara->hasil) == 'rusak' ? 'selected' : '' }}
                                            >RUSAK</option>
                                        </select>
                                    </div>
                                    <div class="col-lg-4 col-12">
                                        ...
                                        <input type="text"
                                            ...
                                            id="keterangan" name="keterangan_utara[]"
                                            value="{{ $utara->keterangan ?? '' }}"
                                            placeholder="Enter..">
                                    </div>
                                    <label class="col-2 col-lg-3"></label>
                                </div>
                    ...
                    <div class="card card-primary">
                        <div class="card-header">
                            ...
                            <div class="card-body">
                                ...
                                @include('components.form-message')
                                    @foreach ($formEleChecklist2HarianSelatans as $key => $selatan)

                                <div class="form-group row">
                                    <label class="col-12 col-lg-4">{{$loop->iteration}}. {{$selatan['pertanyaan']}}</label>
                                    <div class="col-lg-4 col-12">
                                                <label for="">Hasil</label>
                                        <select class="form-control" aria-label="Default select example" name="hasil_selatan[]">
                                            <option value="" selected>Open this select menu</option>
                                            <option value="baik"
                                                {{ (old('hasil.' . $key) ?? $selatan->hasil) == 'baik' ? 'selected' : '' }}
                                            >BAIK</option>
                                            <option value="rusak"
                                                {{ (old('hasil.' . $key) ?? $selatan->hasil) == 'rusak' ? 'selected' : '' }}
                                            >RUSAK</option>
                                        </select>
                                    </div>
                                    <div class="col-lg-4 col-12">
                                        ...
                                        <input type="text"
                                            class="form-control @error('keterangan.' . $key) is-invalid @enderror"
                                            id="keterangan" name="keterangan_selatan[]"
                                            value="{{ $utara->keterangan ?? '' }}"
                                            placeholder="Enter..">
                                    </div>
