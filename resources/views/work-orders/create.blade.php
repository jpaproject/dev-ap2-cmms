                                        ...
                                        <div class="row">
                                                    ...
                                                    <select
                                                        ...
                                                        @foreach ($schedule_maintenances as $schedule_maintenance)
                                                            <option value="{{ $schedule_maintenance->id }}"
                                                                {{ old('schedule_maintenance_id') == $schedule_maintenance->id ? 'selected' : '' }}>
                                            ...
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    ...
                                                    <select
                                                        class="form-control select2 @error('asset_id') is-invalid @enderror"
                                                        name="asset_id">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <textarea name="completion_notes" class="form-control @error('completion_notes') is-invalid @enderror"
                                                id="completion_notes" cols="30" rows="3" placeholder="Enter Completion Notes">{{ old('completion_notes') }}</textarea>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <table id="assetFormTable" class="table-bordered table">
                                                <thead>
                                                    <tr>
                                                        <th>Form Name</th>
                                                    </tr>
                                    ...
                                    <div class="row col-12">
                                        <div class="col-md-7">
                                            <div class="form-group col-lg-12">
                                                ...
                                                <table id="userTechnicalTable" class="table-bordered table">
                                                    <thead>
                                                        <tr>
                                            ...
                                            <div class="form-group col-lg-12">
                                                ...
                                                <table id="userTechnicalGroupTable" class="table-bordered table">
                                                    <thead>
                                                        <tr>
                                                            <th>Name</th>
                                                            <th>User</th>
                                        ...
                                        <div class="col-md-5">
                                            ...
                                            <table id="referenceDocumentTable" class="table-bordered table">
                                                <thead>
                                                    <tr>
                                                        <th>Filename</th>
                                                    </tr>
                ...
                old_user_technical.forEach(id => {
                    $.ajax({
                        ...
                        error: function(data) {
                            ...
                            const map = Object.entries(errors).map(([key, value]) =>
                                `<span class="d-block my-2 text-danger m-3">${value}</span>`
                            );
                            $.alert(map.join(''));
                        }
                    });
