...
class CreateFormUpsPengukuranPeralatanDuaMingguansTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('form_ups_pengukuran_peralatan_dua_mingguans', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('form_ups_pengukuran_peralatan_dua_mingguans');
    }
}
