...
class CreateFormHmvPowerTigaBulanansTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('form_hmv_power_tiga_bulanans', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('form_hmv_power_tiga_bulanans');
    }
}