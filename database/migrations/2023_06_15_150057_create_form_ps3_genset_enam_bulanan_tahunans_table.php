...
class CreateFormPs3GensetEnamBulananTahunansTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('form_ps3_genset_enam_bulanan_tahunans', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('form_ps3_genset_enam_bulanan_tahunans');
    }
}
