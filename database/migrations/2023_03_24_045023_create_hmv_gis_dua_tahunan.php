...
class CreateHmvGisDuaTahunan extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('form_hmv_gis_dua_tahunan', function (Blueprint $table) {
            $table->id();
            ...
            $table->string('q22_awal')->nullable();
            $table->string('q22_akhir')->nullable();
            $table->string('q22_remarks')->nullable();

            $table->string('q23_awal')->nullable();
            $table->string('q23_akhir')->nullable();
            $table->string('q23_remarks')->nullable();

            $table->string('q24_awal')->nullable();
            $table->string('q24_akhir')->nullable();
            $table->string('q24_remarks')->nullable();

            $table->string('q25_awal')->nullable();
            $table->string('q25_akhir')->nullable();
            $table->string('q25_remarks')->nullable();

            $table->string('q26_awal')->nullable();
            $table->string('q26_akhir')->nullable();
            $table->string('q26_remarks')->nullable();

            $table->string('q27_awal')->nullable();
            $table->string('q27_akhir')->nullable();
            $table->string('q27_remarks')->nullable();

            $table->string('q28_awal')->nullable();
            $table->string('q28_akhir')->nullable();
            $table->string('q28_remarks')->nullable();
    ...
    {
        Schema::dropIfExists('hmv_gis_dua_tahunan');
    }
}