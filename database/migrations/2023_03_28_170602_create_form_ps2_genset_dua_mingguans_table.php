...
class CreateFormPs2GensetDuaMingguansTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('form_ps2_genset_dua_mingguans', function (Blueprint $table) {
            $table->id();
            ...
            $table->float('hour_meter')->nullable();
    ...
    {
        Schema::dropIfExists('form_ps2_genset_dua_mingguans');
    }
}