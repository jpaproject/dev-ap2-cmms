...
class CreateFormPs1PanelHariansTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('form_ps1_panel_harians', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('form_ps1_panel_harians');
    }
}
