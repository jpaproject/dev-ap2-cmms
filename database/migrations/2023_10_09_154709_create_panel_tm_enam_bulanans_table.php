...
class CreatePanelTmEnamBulanansTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('panel_tm_enam_bulanans', function (Blueprint $table) {
            $table->id();
            ...
            $table->string("setting_setting_short")->nullable();
    ...
    {
        Schema::dropIfExists('panel_tm_enam_bulanans');
    }
}
