...
class CreateChecklistHarianGensetPs2ControlRoomsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('checklist_harian_genset_ps2_control_rooms', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('checklist_harian_genset_ps2_control_rooms');
    }
}
