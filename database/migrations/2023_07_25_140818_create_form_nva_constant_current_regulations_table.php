...
class CreateFormNvaConstantCurrentRegulationsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('form_nva_constant_current_regulations', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('form_nva_constant_current_regulations');
    }
}
