...
class CreateFormSntChecklistDelacerationHariansTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('form_snt_checklist_delaceration_harians', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('form_snt_checklist_delaceration_harians');
    }
}
