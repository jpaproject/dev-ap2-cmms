...
class CreateFromPs3PanelHariansTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('from_ps3_panel_harians', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('from_ps3_panel_harians');
    }
}