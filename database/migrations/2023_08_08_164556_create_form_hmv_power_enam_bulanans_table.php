...
class CreateFormHmvPowerEnamBulanansTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('form_hmv_power_enam_bulanans', function (Blueprint $table) {
            $table->id();
            ...
            $table->string('number_of_cable')->nullable();
            $table->string('number_of_circuits')->nullable();
    ...
    {
        Schema::dropIfExists('form_hmv_power_enam_bulanans');
    }
}