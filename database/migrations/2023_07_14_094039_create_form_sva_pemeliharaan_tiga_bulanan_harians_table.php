...
class CreateFormSvaPemeliharaanTigaBulananHariansTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('form_sva_pemeliharaan_tiga_bulanan_harians', function (Blueprint $table) {
            $table->id();
            ...
            $table->string('c1_c2')->nullable();
            $table->string('c1_g')->nullable();
            $table->string('c2_g')->nullable();
    ...
    {
        Schema::dropIfExists('form_sva_pemeliharaan_tiga_bulanan_harians');
    }
}
