...
class CreateFormPs3GensetRoomHariansTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('form_ps3_genset_room_harians', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('form_ps3_genset_room_harians');
    }
}
