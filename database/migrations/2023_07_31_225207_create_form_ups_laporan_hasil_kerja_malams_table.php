...
class CreateFormUpsLaporanHasilKerjaMalamsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('form_ups_laporan_hasil_kerja_malams', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('form_ups_laporan_hasil_kerja_malams');
    }
}
