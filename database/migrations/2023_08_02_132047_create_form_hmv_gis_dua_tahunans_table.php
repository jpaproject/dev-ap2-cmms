...
class CreateFormHmvGisDuaTahunansTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('form_hmv_gis_dua_tahunans', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('form_hmv_gis_dua_tahunans');
    }
}
