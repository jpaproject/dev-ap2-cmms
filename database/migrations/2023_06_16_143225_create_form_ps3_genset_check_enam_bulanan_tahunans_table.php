...
class CreateFormPs3GensetCheckEnamBulananTahunansTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('form_ps3_genset_check_enam_bulanan_tahunans', function (Blueprint $table) {
            ...
            $table->string('motor_radiator_isolasi_l1_g_5m')->nullable();
            $table->string('motor_radiator_isolasi_l1_g_10m')->nullable();

            $table->string('motor_radiator_isolasi_l2_g_5m')->nullable();
            $table->string('motor_radiator_isolasi_l2_g_10m')->nullable();

            $table->string('motor_radiator_isolasi_l3_g_5m')->nullable();
            $table->string('motor_radiator_isolasi_l3_g_10m')->nullable();

            $table->string('motor_radiator_isolasi_l1_l2_5m')->nullable();
            $table->string('motor_radiator_isolasi_l1_l2_10m')->nullable();

            $table->string('motor_radiator_isolasi_l1_l3_5m')->nullable();
            $table->string('motor_radiator_isolasi_l1_l3_10m')->nullable();

            $table->string('motor_radiator_isolasi_l2_l3_5m')->nullable();
            $table->string('motor_radiator_isolasi_l2_l3_10m')->nullable();
            

            // PEMERIKSAAN TAHANAN ISOLASI
            $table->string('alternator_isolasi_l1_g_5m')->nullable();
            $table->string('alternator_isolasi_l1_g_10m')->nullable();

            $table->string('alternator_isolasi_l2_g_5m')->nullable();
            $table->string('alternator_isolasi_l2_g_10m')->nullable();

            $table->string('alternator_isolasi_l3_g_5m')->nullable();
            $table->string('alternator_isolasi_l3_g_10m')->nullable();

            $table->string('alternator_isolasi_l1_l2_l3_g_5m')->nullable();
