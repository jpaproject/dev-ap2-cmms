...
class CreateRevision1FormSvaHFCPapiHariansTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('form_sva_h_f_c_papi_harians', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('revision1_form_sva_h_f_c_papi_harians');
    }
}
