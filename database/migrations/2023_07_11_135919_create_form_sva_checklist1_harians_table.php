...
class CreateFormSvaChecklist1HariansTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('form_sva_checklist1_harians', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('form_sva_checklist1_harians');
    }
}