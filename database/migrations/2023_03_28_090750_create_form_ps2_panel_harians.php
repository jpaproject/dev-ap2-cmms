...
class CreateFormPs2PanelHarians extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('form_ps2_panel_harians', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('form_ps2_panel_harians');
    }
}