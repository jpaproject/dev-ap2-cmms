...
class CreateFormHmvPowerBulanansTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('form_hmv_power_bulanans', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('form_hmv_power_bulanans');
    }
}