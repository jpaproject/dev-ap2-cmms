...
class CreateFormPs1GensetMobilesTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('form_ps1_genset_mobiles', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('form_ps1_genset_mobiles');
    }
}